...
// Generated from example definition: 2026-08-01-preview/DatabaseRecommendedActionListExpand.json
func ExampleDatabaseAdvisorsClient_ListByDatabase_listOfDatabaseRecommendedActionsForAllAdvisors() {
	...
	res, err := clientFactory.NewDatabaseAdvisorsClient().ListByDatabase(ctx, "workloadinsight-demos", "misosisvr", "IndexAdvisor_test_3", &armsql.DatabaseAdvisorsClientListByDatabaseOptions{
	...
	// 				LastChecked: to.Ptr(time.Date(2017, time.June, 20, 16, 39, 16, 0, time.UTC)),
	...
	// 				LastChecked: to.Ptr(time.Date(2017, time.June, 20, 18, 50, 21, 0, time.UTC)),
