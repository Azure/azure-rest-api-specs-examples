...
// Generated from example definition: 2025-09-01-preview/ApiManagementListTemplates.json
func ExampleEmailTemplateClient_NewListByServicePager() {
	...
	pager := clientFactory.NewEmailTemplateClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.EmailTemplateClientListByServiceResponse{
		// 	EmailTemplateCollection: armapimanagement.EmailTemplateCollection{
