...
// Generated from example definition: 2024-04-01/invoicesDownloadDocumentsByBillingAccount.json
func ExampleInvoicesClient_BeginDownloadDocumentsByBillingAccount() {
	...
	// res = armbilling.InvoicesClientDownloadDocumentsByBillingAccountResponse{
