...
// Generated from example definition: 2019-08-01/IoTSecuritySolutionsAnalytics/GetIoTSecuritySolutionsSecurityAnalyticsList.json
func ExampleIotSecuritySolutionAnalyticsClient_List() {
	...
	// res = armsecurity.IotSecuritySolutionAnalyticsClientListResponse{
	// 	IoTSecuritySolutionAnalyticsModelList: armsecurity.IoTSecuritySolutionAnalyticsModelList{
