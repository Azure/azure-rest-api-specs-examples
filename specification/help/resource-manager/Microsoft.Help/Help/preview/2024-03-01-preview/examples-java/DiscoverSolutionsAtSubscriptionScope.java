...
public final class Main {
    ...
    public static void
        ...
        manager.discoverySolutionNlps().discoverSolutionsBySubscriptionWithResponse(
            "0d0fcd2e-c4fd-4349-8497-200edb3923c6",
            new DiscoveryNlpRequest().withIssueSummary("how to retrieve certs from deleted keyvault.").withResourceId(
