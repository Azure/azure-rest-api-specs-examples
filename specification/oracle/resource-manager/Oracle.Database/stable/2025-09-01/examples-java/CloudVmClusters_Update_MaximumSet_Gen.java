...
public final class Main {
    ...
    public static void patchVMClusterGeneratedByMaximumSetRule(
        ...
        CloudVmCluster resource = manager.cloudVmClusters()
            ...
            .getValue();
        resource.update().withTags(mapOf("key4668", "fakeTokenPlaceholder"))
            .withProperties(new CloudVmClusterUpdateProperties().withStorageSizeInGbs(17)
                ...
                .withDataStorageSizeInTbs(29.0D).withDbNodeStorageSizeInGbs(24).withMemorySizeInGbs(9)
                .withCpuCoreCount(18).withOcpuCount(7.0D).withSshPublicKeys(Arrays.asList("hazhcc"))
                ...
                .withDisplayName("hvdyewkjqjxwzinkqnnsqxbmccteohzumz").withComputeNodes(
