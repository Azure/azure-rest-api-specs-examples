...
public final class Main {
    ...
    public static void
        ...
        manager.eventSources().createOrUpdateWithResponse("rg1", "env1", "es1",
            new EventHubEventSourceCreateOrUpdateParameters().withLocation("West US")
                .withSharedAccessKey("fakeTokenPlaceholder").withServiceBusNamespace("sbn").withEventHubName("ehn")
                .withConsumerGroupName("cgn").withKeyName("fakeTokenPlaceholder")
                .withEventSourceResourceId("somePathInArm").withTimestampPropertyName("someTimestampProperty")
                .withLocalTimestampPropertiesLocalTimestamp(
                    new LocalTimestamp().withFormat(LocalTimestampFormat.fromString("TimeSpan")).withTimeZoneOffset(
