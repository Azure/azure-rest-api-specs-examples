...
func ExampleWhatIfResultsAtManagementGroupClient_BeginCreateOrUpdate() {
	...
	// res = armdeploymentstacks.WhatIfResultsAtManagementGroupClientCreateOrUpdateResponse{
