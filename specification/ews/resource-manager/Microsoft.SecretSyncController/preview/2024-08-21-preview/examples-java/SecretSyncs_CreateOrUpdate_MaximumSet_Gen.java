...
public final class Main {
    ...
    public static void secretSyncsCreateOrUpdate(
        ...
        manager.secretSyncs().define("secretsync-ssc-example").withRegion("eastus")
            ...
            .withProperties(new SecretSyncProperties().withSecretProviderClassName("fakeTokenPlaceholder")
                .withServiceAccountName("example-k8s-sa-name").withKubernetesSecretType(KubernetesSecretType.OPAQUE)
                .withObjectSecretMapping(Arrays.asList(new KubernetesSecretObjectMapping()
                    .withSourcePath("kv-secret-name/0").withTargetKey("fakeTokenPlaceholder"))))
