...
// Generated from example definition: 2022-06-15/WebTestCreateStandard.json
func ExampleWebTestsClient_CreateOrUpdate_webTestCreateStandard() {
	...
	// res = armapplicationinsights.WebTestsClientCreateOrUpdateResponse{
	// 	WebTest: armapplicationinsights.WebTest{
