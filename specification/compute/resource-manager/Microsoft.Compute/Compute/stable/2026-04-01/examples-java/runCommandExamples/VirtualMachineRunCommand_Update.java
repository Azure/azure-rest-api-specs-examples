...
public final class Main {
    /*
     * x-ms-original-file: 2026-04-01/runCommandExamples/VirtualMachineRunCommand_Update.json
     */
    /**
     ...
     */
    public static void updateARunCommand(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getVirtualMachineRunCommands().update("myResourceGroup", "myVM", "myRunCommand",
