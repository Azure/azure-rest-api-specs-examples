...
func ExampleWhatIfResultsAtSubscriptionClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewWhatIfResultsAtSubscriptionClient().BeginCreateOrUpdate(ctx, "simpleDeploymentStackWhatIfResult", armdeploymentstacks.WhatIfResult{
