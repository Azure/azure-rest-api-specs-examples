...
# USAGE
    python avs_assessed_machines_operations_get_maximum_set_gen.py
...
def main():
    ...
    response = client.avs_assessed_machines_operations.get(
        resource_group_name="ayagrawrg",
        project_name="app18700project",
        group_name="kuchatur-test",
        assessment_name="asm2",
        avs_assessed_machine_name="b6d6fc6f-796f-4c16-96af-a6d22e0f12f7",
    )
    print(response)
