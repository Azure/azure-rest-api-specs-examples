...
public final class Main {
    /*
     * x-ms-original-file: 2026-08-01-preview/InstanceFailoverGroupCreateOrUpdate.json
     */
    /**
    ...
    public static void createFailoverGroup(com.azure.resourcemanager.sql.SqlServerManager manager) {
        manager.serviceClient().getInstanceFailoverGroups().createOrUpdate("Default", "Japan East",
