...
public final class Main {
    /*
     * x-ms-original-file: 2026-01-01/NetworkWatcherAzureReachabilityReportGet.json
     */
    /**
    ...
    public static void getAzureReachabilityReport(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getNetworkWatchers().getAzureReachabilityReport("rg1", "nw1",
