...
public final class Main {
     ...
     */
    public static void connectivityConfigurationsPut(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getConnectivityConfigurations().createOrUpdateWithResponse("myResourceGroup",
            "testNetworkManager", "myTestConnectivityConfig",
