...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateDocumentation.json
func ExampleDocumentationClient_Update() {
	...
	res, err := clientFactory.NewDocumentationClient().Update(ctx, "rg1", "apimService1", "57d1f7558aa04f15146d9d8a", "*", armapimanagement.DocumentationUpdateContract{
	...
	// res = armapimanagement.DocumentationClientUpdateResponse{
