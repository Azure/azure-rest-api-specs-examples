...
public final class Main {
     ...
     * serviceunit_createorupdate_noartifactsource.json
     */
    /**
     ...
     */
    public static void
        createServiceUnitUsingSASURIs(com.azure.resourcemanager.deploymentmanager.DeploymentManager manager) {
        manager.serviceUnits().define("myServiceUnit").withRegion("centralus")
            ...
            .withTags(mapOf())
            .withArtifacts(new ServiceUnitArtifacts().withTemplateUri(
