...
public final class Main {
    ...
    public static void
        ...
        manager.activeDirectoryConfigs().define("adconfig1").withRegion("eastus").withExistingResourceGroup("myRG")
            .withTags(mapOf("ac-tag1", "activeDirectoryConfig1"))
            .withProperties(new ActiveDirectoryConfigProperties().withUserName("admin1")
                .withDns(Arrays.asList("10.10.10.4", "10.10.10.5")).withSmbServerName("smbServer")
                .withOrganizationalUnit("OU=Computers,DC=corp,DC=contoso,DC=com").withSite("Default-First-Site-Name")
                .withBackupOperators(Arrays.asList("backupOp1")).withAdministrators(Arrays.asList("admin1"))
                .withSecurityOperators(Arrays.asList("secOp1")).withDomain("example.net")
                .withSecretPassword(new SecretPassword()
                    .withKeyVaultProperties(new SecretPasswordKeyVaultProperties()
                        .withKeyVaultUri("fakeTokenPlaceholder").withSecretName("fakeTokenPlaceholder"))
