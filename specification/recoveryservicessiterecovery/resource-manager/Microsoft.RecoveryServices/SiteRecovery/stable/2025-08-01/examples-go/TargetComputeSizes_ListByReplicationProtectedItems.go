...
// Generated from example definition: 2025-08-01/TargetComputeSizes_ListByReplicationProtectedItems.json
func ExampleTargetComputeSizesClient_NewListByReplicationProtectedItemsPager() {
	...
	clientFactory, err := armrecoveryservicessiterecovery.NewClientFactory("6808dbbc-98c7-431f-a1b1-9580902423b7", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.TargetComputeSizesClientListByReplicationProtectedItemsResponse{
		// 	TargetComputeSizeCollection: armrecoveryservicessiterecovery.TargetComputeSizeCollection{
