...
public final class Main {
     ...
     */
    public static void createManagedInstanceWithAllProperties(com.azure.resourcemanager.sql.SqlServerManager manager) {
        manager.serviceClient().getManagedInstances().createOrUpdate("testrg", "testinstance",
            new ManagedInstanceInner().withLocation("Japan East").withTags(mapOf("tagKey1", "fakeTokenPlaceholder"))
                ...
                .withAuthenticationMetadata(AuthMetadataLookupModes.AZURE_AD)
                .withDatabaseFormat(ManagedInstanceDatabaseFormat.ALWAYS_UP_TO_DATE)
                .withRequestedLogicalAvailabilityZone(AvailabilityZoneType.ONE),
