...
public final class Main {
    ...
    public static void consumerGroupCreate(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.eventHubs().manager().serviceClient().getConsumerGroups().createOrUpdateWithResponse("ArunMonocle",
            "sdk-Namespace-2661", "sdk-EventHub-6681", "sdk-ConsumerGroup-5563",
            new ConsumerGroupInner().withUserMetadata("New consumergroup"), com.azure.core.util.Context.NONE);
    }
}
