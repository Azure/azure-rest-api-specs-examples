...
public final class Main {
    ...
    public static void
        ...
        manager
            .ispCacheNodesOperations().define(
                "cabakm")
            .withRegion("westus").withExistingIspCustomer("rgConnectedCache",
            ...
            .withProperties(new CacheNodeProperty()
                .withCacheNode(new CacheNodeEntity().withFullyQualifiedResourceId("hskxkpbiqbrbjiwdzrxndru")
                    .withCustomerName("xwyqk").withIpAddress("voctagljcwqgcpnionqdcbjk")
                    .withCustomerIndex("qtoiglqaswivmkjhzogburcxtszmek").withCacheNodeId("xjzffjftwcgsehanoxsl")
                    .withCacheNodeName("mfjxb").withCustomerAsn(4).withIsEnabled(true).withMaxAllowableEgressInMbps(29)
                    .withIsEnterpriseManaged(true).withCidrCsv(Arrays.asList("nlqlvrthafvvljuupcbcw"))
                    .withShouldMigrate(true).withCidrSelectionType(4))
                .withAdditionalCacheNodeProperties(
                    new AdditionalCacheNodeProperties().withCacheNodePropertiesDetailsIssuesList(Arrays.asList("ex"))
                        .withDriveConfiguration(Arrays.asList(new CacheNodeDriveConfiguration().withPhysicalPath("/mcc")
                            .withSizeInGb(500).withCacheNumber(1).withNginxMapping("lijygenjq")))
                        ...
                        .withProxyUrl("qhux").withOptionalProperty1("hvpmt")
                        .withOptionalProperty2("talanelmsgxvksrzoeeontqkjzbpv").withOptionalProperty3("bxkoxq")
                        .withOptionalProperty4("pqlkcekupusoc").withOptionalProperty5("nyvvmrjigqdufzjdvazdca"))
                .withStatusCode("fakeTokenPlaceholder").withStatusText("Success").withStatusDetails("djruqvptzxak")
