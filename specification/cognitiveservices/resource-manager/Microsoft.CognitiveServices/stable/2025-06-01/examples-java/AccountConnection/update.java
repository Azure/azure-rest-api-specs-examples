...
public final class Main {
    ...
    public static void
        ...
        ConnectionPropertiesV2BasicResource resource = manager.accountConnections()
            .getWithResponse("test-rg", "account-1", "connection-1", com.azure.core.util.Context.NONE).getValue();
        resource.update()
            .withProperties(new AccessKeyAuthTypeConnectionProperties().withCategory(ConnectionCategory.ADLSGEN2)
                .withExpiryTime(OffsetDateTime.parse("2020-01-01T00:00:00Z")).withMetadata(mapOf())
                .withTarget("some_string").withCredentials(new ConnectionAccessKey()
