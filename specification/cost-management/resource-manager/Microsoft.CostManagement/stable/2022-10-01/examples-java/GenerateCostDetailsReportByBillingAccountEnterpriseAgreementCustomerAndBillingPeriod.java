...
public final class Main {
    ...
    public static void generateCostDetailsReportByBillingAccountEnterpriseAgreementCustomerAndBillingPeriod(
        ...
        manager.generateCostDetailsReports().createOperation(
            "providers/Microsoft.Billing/billingAccounts/12345", new GenerateCostDetailsReportRequestDefinition()
                .withMetric(CostDetailsMetricType.ACTUAL_COST).withBillingPeriod("202205"),
