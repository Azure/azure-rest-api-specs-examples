...
public final class Main {
    ...
    public static void
        ...
        manager.storageContainers().define("49af599cddb38a473b").withRegion("uksouth")
            .withExistingResourceGroup("rgdiscovery").withTags(mapOf("key4240", "fakeTokenPlaceholder"))
            .withProperties(new StorageContainerProperties().withStorageStore(
                new AzureStorageBlobStore().withMountProtocol(BlobStorageMountProtocol.NFS).withStorageAccountId(
