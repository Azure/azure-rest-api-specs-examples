...
public final class Main {
    ...
    public static void updatesDatabaseAutomaticTuningSettingsWithMinimalProperties(
        ...
        manager.serviceClient().getDatabaseAutomaticTunings().updateWithResponse("default-sql-onebox", "testsvr11",
            "db1", new DatabaseAutomaticTuningInner().withDesiredState(AutomaticTuningMode.AUTO),
