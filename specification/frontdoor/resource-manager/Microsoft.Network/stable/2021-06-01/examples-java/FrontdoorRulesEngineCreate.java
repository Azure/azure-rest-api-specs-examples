...
public final class Main {
    ...
    public static void
        ...
        manager.rulesEngines().define("rulesEngine1").withExistingFrontDoor("rg1", "frontDoor1")
            .withRules(
                Arrays.asList(
                    new RulesEngineRule().withName("Rule1").withPriority(1)
                        .withAction(new RulesEngineAction().withRouteConfigurationOverride(new RedirectConfiguration()
                            .withRedirectType(FrontDoorRedirectType.MOVED)
                            .withRedirectProtocol(FrontDoorRedirectProtocol.HTTPS_ONLY).withCustomHost("www.bing.com")
                            .withCustomPath("/api").withCustomFragment("fragment").withCustomQueryString("a=b")))
                    ...
                    new RulesEngineRule().withName("Rule2").withPriority(2)
                        .withAction(new RulesEngineAction().withResponseHeaderActions(
                            Arrays.asList(new HeaderAction().withHeaderActionType(HeaderActionType.OVERWRITE)
                                .withHeaderName("Cache-Control").withValue("public, max-age=31536000"))))
                        .withMatchConditions(Arrays.asList(new RulesEngineMatchCondition()
                    ...
                    new RulesEngineRule().withName("Rule3").withPriority(3)
                        ...
                        .withMatchConditions(Arrays.asList(new RulesEngineMatchCondition()
                            ...
                            .withRulesEngineOperator(RulesEngineOperator.EQUAL).withNegateCondition(false)
