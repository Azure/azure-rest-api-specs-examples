...
public final class Main {
    ...
    public static void elasticSansCreateMaximumSetGen(com.azure.resourcemanager.elasticsan.ElasticSanManager manager) {
        manager.elasticSans().define("elasticsanname").withRegion("France Central")
            ...
            .withSku(new Sku().withName(SkuName.PREMIUM_LRS).withTier(SkuTier.PREMIUM)).withBaseSizeTiB(1L)
            .withExtendedCapacitySizeTiB(3L).withTags(mapOf("key9706", "fakeTokenPlaceholder"))
            .withAvailabilityZones(Arrays.asList("xoz")).withPublicNetworkAccess(PublicNetworkAccess.ENABLED)
