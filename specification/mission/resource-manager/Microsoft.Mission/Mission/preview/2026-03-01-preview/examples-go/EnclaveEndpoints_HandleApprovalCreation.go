...
func ExampleEndpointsClient_BeginHandleApprovalCreation() {
	...
	poller, err := clientFactory.NewEndpointsClient().BeginHandleApprovalCreation(ctx, "rgopenapi", "TestMyEnclave", "TestMyEnclaveEndpoint", armenclave.ApprovalCallbackRequest{
	...
	// res = armenclave.EndpointsClientHandleApprovalCreationResponse{
