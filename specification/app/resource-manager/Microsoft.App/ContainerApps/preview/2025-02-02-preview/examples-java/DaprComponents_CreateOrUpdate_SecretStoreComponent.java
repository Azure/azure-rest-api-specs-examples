...
public final class Main {
    ...
    public static void createOrUpdateDaprComponentWithSecretStoreComponent(
        ...
        manager.daprComponents().define("reddog").withExistingManagedEnvironment("examplerg", "myenvironment")
            .withComponentType("state.azure.cosmosdb").withVersion("v1").withIgnoreErrors(false).withInitTimeout("50s")
