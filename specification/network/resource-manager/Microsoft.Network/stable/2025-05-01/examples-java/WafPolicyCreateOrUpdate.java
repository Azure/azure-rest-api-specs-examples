                ...
                new WebApplicationFirewallPolicyInner()
                    ...
                    .withPolicySettings(
                        new PolicySettings()
                            ...
                            .withJsChallengeCookieExpirationInMins(100).withCaptchaCookieExpirationInMins(100))
                    .withCustomRules(Arrays.asList(
                        ...
                        new WebApplicationFirewallCustomRule().withName("RateLimitRule3").withPriority(3)
                            ...
                            .withGroupByUserSession(
                                Arrays.asList(new GroupByUserSession().withGroupByVariables(
                        ...
                        new WebApplicationFirewallCustomRule().withName("Rule5").withPriority(5)
                            ...
                            .withMatchConditions(Arrays.asList(
                                new MatchCondition()
                                    .withMatchVariables(Arrays.asList(new MatchVariable()
                                        .withVariableName(WebApplicationFirewallMatchVariable.REMOTE_ADDR)))
                                    .withOperator(WebApplicationFirewallOperator.IPMATCH).withNegationConditon(false)
                                    .withMatchValues(Arrays.asList("192.168.2.0/24")),
                                new MatchCondition()
                                    .withMatchVariables(Arrays.asList(new MatchVariable()
                                        .withVariableName(WebApplicationFirewallMatchVariable.REQUEST_HEADERS)
                                        .withSelector("UserAgent")))
                                    .withOperator(WebApplicationFirewallOperator.CONTAINS).withNegationConditon(false)
                                    .withMatchValues(Arrays.asList("Bot"))))
