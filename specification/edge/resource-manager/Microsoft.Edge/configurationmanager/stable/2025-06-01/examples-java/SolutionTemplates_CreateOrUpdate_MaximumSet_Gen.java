...
public final class Main {
    ...
    public static void solutionTemplatesCreateOrUpdateMaximumSet(
        ...
        manager.solutionTemplates().define("testname").withRegion("zheaaqvadewftnctxzpinrgeproqs")
            .withExistingResourceGroup("rgconfigurationmanager").withTags(mapOf("key5091", "fakeTokenPlaceholder"))
            .withProperties(new SolutionTemplateProperties().withDescription("psrftehgzngcdlccivhjmwsmiz")
                .withCapabilities(Arrays.asList("dfoyxbbknrhvlunhmuyyt")).withState(ResourceState.ACTIVE)
