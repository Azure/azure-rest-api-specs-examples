...
# USAGE
    python list_workspace_managed_sql_server_blob_auditing_settings.py
...
def main():
    ...
    response = client.workspace_managed_sql_server_blob_auditing_policies.list_by_workspace(
