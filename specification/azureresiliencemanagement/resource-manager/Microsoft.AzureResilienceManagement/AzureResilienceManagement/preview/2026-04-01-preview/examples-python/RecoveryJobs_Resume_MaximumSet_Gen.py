...
# USAGE
    python recovery_jobs_resume_maximum_set_gen.py
...
def main():
    ...
    response = client.recovery_jobs.begin_resume(
        ...
        body={"description": "Resuming the recovery job after user verification"},
        operation_id="str",
    ).result()
    print(response)
