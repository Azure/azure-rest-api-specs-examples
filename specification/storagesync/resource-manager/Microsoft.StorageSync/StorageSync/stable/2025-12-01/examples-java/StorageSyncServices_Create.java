...
public final class Main {
    ...
    public static void storageSyncServicesCreate(com.azure.resourcemanager.storagesync.StorageSyncManager manager) {
        manager.storageSyncServices().define("SampleStorageSyncService_1").withRegion("WestUS")
            .withExistingResourceGroup("SampleResourceGroup_1").withTags(mapOf())
            .withIdentity(new ManagedServiceIdentity()
                .withType(ManagedServiceIdentityType.fromString("SystemAssigned, UserAssigned")))
            .withIncomingTrafficPolicy(IncomingTrafficPolicy.ALLOW_ALL_TRAFFIC).create();
    }
