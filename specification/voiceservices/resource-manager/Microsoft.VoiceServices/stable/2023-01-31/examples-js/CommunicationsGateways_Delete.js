...
/**
 * This sample demonstrates how to Delete a CommunicationsGateway
 *
 ...
 */
async function deleteCommunicationsGatewayResource() {
  ...
  const result = await client.communicationsGateways.beginDeleteAndWait(
    resourceGroupName,
