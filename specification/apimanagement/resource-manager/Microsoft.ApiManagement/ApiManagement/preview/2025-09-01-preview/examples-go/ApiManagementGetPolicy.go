...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetPolicy.json
func ExamplePolicyClient_Get_apiManagementGetPolicy() {
	...
	res, err := clientFactory.NewPolicyClient().Get(ctx, "rg1", "apimService1", armapimanagement.PolicyIDNamePolicy, nil)
	if err != nil {
