...
public final class Main {
    ...
    public static void networkBootstrapDevicesCreateMaximumSetGeneratedByMaximumSetRuleGeneratedByMaximumSetRule(
        ...
        manager.networkBootstrapDevices().define("example-device").withRegion("eastuseuap")
            .withExistingResourceGroup("example-rg").withTags(mapOf())
            ...
            .withSerialNumber("Vendor;DCS-7280XXX-24;12.05;JPE2111XXXX").withNetworkDeviceSku("DeviceSku").create();
    }
