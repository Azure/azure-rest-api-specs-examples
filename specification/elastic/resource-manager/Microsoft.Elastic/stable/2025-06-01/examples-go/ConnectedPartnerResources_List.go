...
// Generated from example definition: 2025-06-01/ConnectedPartnerResources_List.json
func ExampleConnectedPartnerResourcesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armelastic.ConnectedPartnerResourcesClientListResponse{
		// 	ConnectedPartnerResourcesListResponse: armelastic.ConnectedPartnerResourcesListResponse{
