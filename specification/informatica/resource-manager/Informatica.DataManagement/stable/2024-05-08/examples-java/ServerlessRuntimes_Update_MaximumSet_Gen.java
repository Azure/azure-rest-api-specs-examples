...
public final class Main {
    ...
    public static void serverlessRuntimesUpdate(
        ...
        InformaticaServerlessRuntimeResource resource = manager.serverlessRuntimes()
            .getWithResponse("rgopenapi", "W5", "t_", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(new ServerlessRuntimePropertiesCustomUpdate()
            .withDescription("ocprslpljoikxyduackzqnkuhyzrh").withPlatform(PlatformType.AZURE)
            .withApplicationType(ApplicationType.CDI).withComputeUnits("uncwbpu").withExecutionTimeout("tjyfytuywriabt")
