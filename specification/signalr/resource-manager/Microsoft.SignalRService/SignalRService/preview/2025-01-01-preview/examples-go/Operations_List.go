...
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsignalr.OperationsClientListResponse{
		// 	OperationList: armsignalr.OperationList{
		// 		NextLink: to.Ptr("https://management.azure.com/subscriptions/subid/providers/Microsoft.SignalRService?$skipToken=opaqueString"),
