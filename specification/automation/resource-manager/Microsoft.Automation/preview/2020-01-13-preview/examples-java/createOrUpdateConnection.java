...
public final class Main {
    ...
    public static void createOrUpdateConnection(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.connections().define("mysConnection").withExistingAutomationAccount("rg", "myAutomationAccount28")
            .withName("mysConnection").withConnectionType(new ConnectionTypeAssociationProperty().withName("Azure"))
            .withDescription("my description goes here").withFieldDefinitionValues(
