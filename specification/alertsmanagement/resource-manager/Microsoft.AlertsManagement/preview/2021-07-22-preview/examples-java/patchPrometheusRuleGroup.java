...
public final class Main {
    ...
    public static void
        ...
        PrometheusRuleGroupResource resource
            = manager.prometheusRuleGroups().getByResourceGroupWithResponse("promResourceGroup",
                "myPrometheusRuleGroup", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("tag1", "value1"))
            .withProperties(new PrometheusRuleGroupResourcePatchProperties().withEnabled(false)).apply();
    }
