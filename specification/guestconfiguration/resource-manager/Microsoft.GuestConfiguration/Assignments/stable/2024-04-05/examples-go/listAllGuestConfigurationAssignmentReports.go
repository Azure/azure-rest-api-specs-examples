...
// Generated from example definition: 2024-04-05/listAllGuestConfigurationAssignmentReports.json
func ExampleAssignmentReportsClient_List() {
	...
	// res = armguestconfiguration.AssignmentReportsClientListResponse{
