...
public final class Main {
    ...
    public static void vpnGatewayPut(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVpnGateways().createOrUpdate("rg1", "gateway1", new VpnGatewayInner()
            .withLocation("westcentralus").withTags(mapOf("key1", "fakeTokenPlaceholder"))
