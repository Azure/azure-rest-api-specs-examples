...
public final class Main {
    ...
    public static void
        ...
        MyWorkbook resource = manager.myWorkbooks().getByResourceGroupWithResponse("my-resource-group",
            "deadb33f-5e0d-4064-8ebb-1a4ed0313eb2", com.azure.core.util.Context.NONE).getValue();
        resource.update().withKind(Kind.USER).withDisplayName("Blah Blah Blah").withSerializedData(
            ...
            .withVersion("ME").withCategory("workbook")
            .withSourceId(
