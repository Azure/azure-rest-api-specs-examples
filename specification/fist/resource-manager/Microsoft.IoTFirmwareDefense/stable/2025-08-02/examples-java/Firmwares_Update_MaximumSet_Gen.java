...
public final class Main {
    ...
    public static void firmwaresUpdateMaximumSetGenGeneratedByMaximumSetRule(
        ...
        Firmware resource = manager.firmwares().getWithResponse("rgiotfirmwaredefense", "exampleWorkspaceName",
            "00000000-0000-0000-0000-000000000000", com.azure.core.util.Context.NONE).getValue();
        resource.update().withFileName("FileNameThatWasUploaded.bin").withVendor("ExampleVendorName")
            .withModel("ExampleModelOfDevice").withVersion("1.0.0")
            .withDescription("User provided description of the firmware.").withFileSize(30L).withStatus(Status.PENDING)
            .withStatusMessages(Arrays.asList(new StatusMessage().withErrorCode(5L).withMessage(
