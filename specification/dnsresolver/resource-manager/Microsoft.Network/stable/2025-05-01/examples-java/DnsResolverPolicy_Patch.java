...
public final class Main {
    ...
    public static void updateDNSResolverPolicy(com.azure.resourcemanager.dnsresolver.DnsResolverManager manager) {
        DnsResolverPolicy resource = manager.dnsResolverPolicies().getByResourceGroupWithResponse("sampleResourceGroup",
            "sampleDnsResolverPolicy", com.azure.core.util.Context.NONE).getValue();
