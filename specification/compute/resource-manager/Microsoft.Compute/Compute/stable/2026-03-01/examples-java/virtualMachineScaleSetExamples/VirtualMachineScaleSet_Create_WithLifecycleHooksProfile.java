...
import com.azure.resourcemanager.compute.models.LifecycleHook;
...
public final class Main {
    /*
     * x-ms-original-file:
     * 2026-03-01/virtualMachineScaleSetExamples/VirtualMachineScaleSet_Create_WithLifecycleHooksProfile.json
     */
    /**
     * Sample code: Create a virtual machine scale set with LifecycleHooksProfile.
     * 
     * @param manager Entry point to ComputeManager.
     */
    public static void createAVirtualMachineScaleSetWithLifecycleHooksProfile(
        ...
        manager.serviceClient().getVirtualMachineScaleSets().createOrUpdate("myResourceGroup", "{vmss-name}",
            new VirtualMachineScaleSetInner().withLocation("westus")
                .withSku(new Sku().withName("Standard_D1_v2").withTier("Standard").withCapacity(4L))
                ...
                .withLifecycleHooksProfile(new LifecycleHooksProfile().withLifecycleHooks(Arrays.asList(
                    new LifecycleHook().withType(VMScaleSetLifecycleHookEventType.UPGRADE_AUTO_OSROLLING_BATCH_STARTING)
                        .withWaitDuration(Duration.parse("PT20M")).withDefaultAction(LifecycleHookAction.APPROVE)))),
