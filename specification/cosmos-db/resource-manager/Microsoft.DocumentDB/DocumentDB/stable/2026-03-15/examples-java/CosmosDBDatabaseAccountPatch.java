...
public final class Main {
    ...
    public static void cosmosDBDatabaseAccountPatch(com.azure.resourcemanager.cosmos.CosmosManager manager) {
        manager.serviceClient().getDatabaseAccounts().update("rg1", "ddb1", new DatabaseAccountUpdateParameters()
            .withTags(mapOf("dept", "finance")).withLocation("westus")
            ...
            .withEnablePerRegionPerPartitionAutoscale(true).withEnforceHierarchicalPartitionKeyIdLastLevel(false),
