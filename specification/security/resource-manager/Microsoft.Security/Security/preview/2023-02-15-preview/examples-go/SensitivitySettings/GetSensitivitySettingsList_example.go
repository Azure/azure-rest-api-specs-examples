...
// Generated from example definition: 2023-02-15-preview/SensitivitySettings/GetSensitivitySettingsList_example.json
func ExampleSensitivitySettingsClient_List() {
	...
	// res = armsecurity.SensitivitySettingsClientListResponse{
	// 	GetSensitivitySettingsListResponse: armsecurity.GetSensitivitySettingsListResponse{
	// 		Value: []*armsecurity.GetSensitivitySettingsResponse{
	// 			{
	// 				Name: to.Ptr("current"),
	// 				Type: to.Ptr("Microsoft.Security/sensitivitySettings"),
	// 				ID: to.Ptr("/providers/Microsoft.Security/sensitivitySettings/current"),
