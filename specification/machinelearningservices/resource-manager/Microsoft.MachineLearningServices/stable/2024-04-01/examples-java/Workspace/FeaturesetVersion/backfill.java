    ...
    public static void
        ...
        manager.featuresetVersions()
            .backfill("test-rg", "my-aml-workspace", "string", "string",
                new FeaturesetVersionBackfillRequest().withDisplayName("string").withDescription("string")
                    ...
                    .withDataAvailabilityStatus(Arrays.asList(DataAvailabilityStatus.NONE)).withJobId("string")
