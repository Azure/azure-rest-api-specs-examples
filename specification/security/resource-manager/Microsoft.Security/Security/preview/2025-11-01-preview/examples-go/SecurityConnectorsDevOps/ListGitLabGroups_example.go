...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListGitLabGroups_example.json
func ExampleGitLabGroupsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.GitLabGroupsClientListResponse{
