...
public final class Main {
    ...
    public static void hardwareSettingsCreateOrUpdateMaximumSet(
        ...
        manager.hardwareSettings().define("default")
            .withExistingDisconnectedOperation("rgdisconnectedOperations", "demo-resource")
            .withProperties(
                new HardwareSettingProperties().withTotalCores(200).withDiskSpaceInGb(1024).withMemoryInGb(64)
                    .withOem("Contoso").withHardwareSku("MC-760").withNodes(3).withVersionAtRegistration("2411.2")
                    .withSolutionBuilderExtension("xyz").withDeviceId("663ee8a3-4ea8-48ec-8810-b1f8b86cb270"))
            .create();
    }
}
