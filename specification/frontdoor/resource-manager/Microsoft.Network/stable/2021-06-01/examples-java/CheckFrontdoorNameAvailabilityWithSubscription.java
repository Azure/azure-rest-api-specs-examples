...
public final class Main {
     ...
     * CheckFrontdoorNameAvailabilityWithSubscription.json
     */
    /**
    ...
    public static void
        ...
        manager.frontDoorNameAvailabilityWithSubscriptions().checkWithResponse(new CheckNameAvailabilityInput()
            .withName("sampleName").withType(ResourceType.MICROSOFT_NETWORK_FRONT_DOORS_FRONTEND_ENDPOINTS),
