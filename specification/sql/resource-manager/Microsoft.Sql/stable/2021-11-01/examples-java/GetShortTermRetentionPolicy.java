...
public final class Main {
    /*
     * x-ms-original-file:
     * specification/sql/resource-manager/Microsoft.Sql/stable/2021-11-01/examples/GetShortTermRetentionPolicy.json
     */
    /**
    ...
    public static void
        ...
        azure.sqlServers().manager().serviceClient().getBackupShortTermRetentionPolicies().getWithResponse(
            "Default-SQL-SouthEastAsia", "testsvr", "testdb", ShortTermRetentionPolicyName.DEFAULT,
