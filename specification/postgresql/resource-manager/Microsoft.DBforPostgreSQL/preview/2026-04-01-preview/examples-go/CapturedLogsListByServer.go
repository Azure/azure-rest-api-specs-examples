...
// Generated from example definition: 2026-04-01-preview/CapturedLogsListByServer.json
func ExampleCapturedLogsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armpostgresqlflexibleservers.CapturedLogsClientListByServerResponse{
		// 	CapturedLogList: armpostgresqlflexibleservers.CapturedLogList{
