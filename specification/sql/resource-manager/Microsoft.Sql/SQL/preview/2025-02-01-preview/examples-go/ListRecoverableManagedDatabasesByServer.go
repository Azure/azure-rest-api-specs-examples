...
// Generated from example definition: 2025-02-01-preview/ListRecoverableManagedDatabasesByServer.json
func ExampleRecoverableManagedDatabasesClient_NewListByInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.RecoverableManagedDatabasesClientListByInstanceResponse{
		// 	RecoverableManagedDatabaseListResult: armsql.RecoverableManagedDatabaseListResult{
