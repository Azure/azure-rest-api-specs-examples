...
public final class Main {
    /*
     * x-ms-original-file: 2026-06-02-preview/SnapshotsCreate.json
     */
    /**
    ...
    public static void
        ...
        manager.serviceClient().getSnapshots().createOrUpdateWithResponse("rg1", "snapshot1", new SnapshotInner()
            .withLocation("westus").withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
