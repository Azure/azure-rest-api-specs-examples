...
// Generated from example definition: 2023-07-01-preview/GetDnsResourceReference.json
func ExampleResourceReferenceClient_GetByTargetResources() {
	...
	// res = armdns.ResourceReferenceClientGetByTargetResourcesResponse{
	// 	ResourceReferenceResult: &armdns.ResourceReferenceResult{
