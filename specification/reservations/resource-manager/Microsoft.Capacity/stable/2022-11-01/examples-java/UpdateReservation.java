...
public final class Main {
    ...
    public static void patchReservation(com.azure.resourcemanager.reservations.ReservationsManager manager) {
        manager.reservations().update(
            "276e7ae4-84d0-4da6-ab4b-d6b94f3557da", "6ef59113-3482-40da-8d79-787f823e34bc", new PatchModel()
                .withAppliedScopeType(AppliedScopeType.SHARED).withInstanceFlexibility(InstanceFlexibility.OFF),
