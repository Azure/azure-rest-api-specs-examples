...
public final class Main {
    ...
    public static void virtualHubPut(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVirtualHubs().createOrUpdate("rg1", "virtualHub2", new VirtualHubInner()
            ...
            .withAddressPrefix("10.168.0.0/24").withSku("Basic"), com.azure.core.util.Context.NONE);
    }
