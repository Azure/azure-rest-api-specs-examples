...
public final class Main {
    ...
    public static void virtualMachinesAddDataDisk(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualMachines().addDataDisk("resourceGroupName", "{labName}", "{virtualMachineName}",
            new DataDiskProperties().withAttachNewDataDiskOptions(new AttachNewDataDiskOptions().withDiskSizeGiB(127)
