...
# USAGE
    python fleet_members_create_maximum_set_gen.py
...
# x-ms-original-file: specification/containerservice/resource-manager/Microsoft.ContainerService/fleet/stable/2025-03-01/examples/FleetMembers_Create_MaximumSet_Gen.json
