...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateContentType.json
func ExampleContentTypeClient_CreateOrUpdate() {
	...
	// res = armapimanagement.ContentTypeClientCreateOrUpdateResponse{
	// 	ContentTypeContract: armapimanagement.ContentTypeContract{
	// 		Name: to.Ptr("page"),
