...
public final class Main {
     ...
     */
    public static void createFirewallPolicy(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getFirewallPolicies().createOrUpdate("rg1", "firewallPolicy", new FirewallPolicyInner()
