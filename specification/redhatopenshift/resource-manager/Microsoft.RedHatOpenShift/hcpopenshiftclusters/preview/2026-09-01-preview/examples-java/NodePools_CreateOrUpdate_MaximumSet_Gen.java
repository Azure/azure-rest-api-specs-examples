...
public final class Main {
    ...
    public static void nodePoolsCreateOrUpdate(
        ...
        manager.nodePools().define("nodePool-name").withRegion("mqewzbuvnyxnwbmir")
            ...
            .withProperties(new NodePoolProperties()
                ...
                .withPlatform(new NodePoolPlatformProfile().withSubnetId(
                    ...
                    .withVmSize("Standard_D2s_v3").withEnableEncryptionAtHost(true)
                ...
                .withReplicas(18).withAutoRepair(true).withAutoScaling(new NodePoolAutoScaling().withMin(6).withMax(29))
