...
public final class Main {
    ...
    public static void updateCapacityProperties(com.azure.resourcemanager.fabric.FabricManager manager) {
        ...
        resource.update().withTags(mapOf("testKey", "fakeTokenPlaceholder"))
            ...
            .withProperties(new FabricCapacityUpdateProperties().withOverage(new CapacityOverageProperties()
                .withState(CapacityOverageState.ENABLED).withThresholdCapacityUnitHours(4)).withAdministration(
