...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListAzureDevOpsProjects_example.json
func ExampleAzureDevOpsProjectsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AzureDevOpsProjectsClientListResponse{
		// 	AzureDevOpsProjectListResponse: armsecurity.AzureDevOpsProjectListResponse{
