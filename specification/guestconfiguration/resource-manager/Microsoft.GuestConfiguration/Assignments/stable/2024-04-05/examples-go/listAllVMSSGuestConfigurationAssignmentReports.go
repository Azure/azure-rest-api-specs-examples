...
// Generated from example definition: 2024-04-05/listAllVMSSGuestConfigurationAssignmentReports.json
func ExampleAssignmentReportsVMSSClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armguestconfiguration.AssignmentReportsVMSSClientListResponse{
