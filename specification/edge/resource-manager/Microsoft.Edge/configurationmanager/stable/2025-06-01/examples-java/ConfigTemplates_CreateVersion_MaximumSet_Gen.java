...
public final class Main {
    ...
    public static void configTemplatesCreateVersionMaximumSet(
        ...
        manager.configTemplates().createVersion("rgconfigurationmanager", "testname",
            new ConfigTemplateVersionWithUpdateTypeInner().withUpdateType(UpdateType.MAJOR).withVersion("1.0.0")
