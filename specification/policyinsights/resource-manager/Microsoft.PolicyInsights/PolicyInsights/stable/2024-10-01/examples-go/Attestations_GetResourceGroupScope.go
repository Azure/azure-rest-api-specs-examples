...
// Generated from example definition: 2024-10-01/Attestations_GetResourceGroupScope.json
func ExampleAttestationsClient_GetAtResourceGroup() {
	...
	// res = armpolicyinsights.AttestationsClientGetAtResourceGroupResponse{
