...
def main():
    ...
    response = client.provider_share_subscriptions.reinstate(
...
# x-ms-original-file: specification/datashare/resource-manager/Microsoft.DataShare/DataShare/stable/2020-09-01/examples/ProviderShareSubscriptions_Reinstate.json
