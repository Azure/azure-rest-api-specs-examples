...
func ExampleDisasterRecoveryConfigsClient_FailOver() {
	...
	res, err := clientFactory.NewDisasterRecoveryConfigsClient().FailOver(ctx, "exampleResourceGroup", "sdk-Namespace-8859", "sdk-DisasterRecovery-3814", nil)
	if err != nil {
	...
	// res = armeventhub.DisasterRecoveryConfigsClientFailOverResponse{
	// }
}
