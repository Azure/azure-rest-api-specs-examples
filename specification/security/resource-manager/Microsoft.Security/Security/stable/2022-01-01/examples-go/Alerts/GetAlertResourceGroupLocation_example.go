...
// Generated from example definition: 2022-01-01/Alerts/GetAlertResourceGroupLocation_example.json
func ExampleAlertsClient_GetResourceGroupLevel() {
	...
	// res = armsecurity.AlertsClientGetResourceGroupLevelResponse{
