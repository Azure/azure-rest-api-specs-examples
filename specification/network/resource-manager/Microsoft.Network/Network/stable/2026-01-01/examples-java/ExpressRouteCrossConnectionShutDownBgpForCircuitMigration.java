...
/**
 * Samples for ExpressRouteCrossConnections ShutDownBgpForCircuitMigration.
 */
public final class Main {
     ...
     */
    /**
     * Sample code: ShutDownBgpForExpressRouteCircuitMigration.
     * 
     * @param manager Entry point to NetworkManager.
     */
    public static void
        shutDownBgpForExpressRouteCircuitMigration(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getExpressRouteCrossConnections().shutDownBgpForCircuitMigration(
