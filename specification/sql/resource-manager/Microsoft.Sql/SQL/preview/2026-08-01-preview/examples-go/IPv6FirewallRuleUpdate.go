...
// Generated from example definition: 2026-08-01-preview/IPv6FirewallRuleUpdate.json
func ExampleIPv6FirewallRulesClient_CreateOrUpdate_updateAnIPv6FirewallRuleMaxMin() {
	...
	// res = armsql.IPv6FirewallRulesClientCreateOrUpdateResponse{
	// 	IPv6FirewallRule: armsql.IPv6FirewallRule{
