...
public final class Main {
    ...
    public static void scheduledActionCheckNameAvailabilityByScope(
        ...
        manager.scheduledActions().checkNameAvailabilityByScopeWithResponse(
            "subscriptions/00000000-0000-0000-0000-000000000000", new CheckNameAvailabilityRequest()
                .withName("testName").withType("Microsoft.CostManagement/ScheduledActions"),
