...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetWorkspaceSubscription.json
func ExampleWorkspaceSubscriptionClient_Get() {
	...
	// res = armapimanagement.WorkspaceSubscriptionClientGetResponse{
