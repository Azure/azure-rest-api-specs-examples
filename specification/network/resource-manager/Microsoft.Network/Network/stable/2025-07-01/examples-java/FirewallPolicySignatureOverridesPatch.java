...
public final class Main {
    ...
    public static void patchSignatureOverrides(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getFirewallPolicyIdpsSignaturesOverrides().patchWithResponse("rg1", "firewallPolicy",
            new SignaturesOverridesInner()
                ...
                .withName("default").withType("Microsoft.Network/firewallPolicies/signatureOverrides"),
