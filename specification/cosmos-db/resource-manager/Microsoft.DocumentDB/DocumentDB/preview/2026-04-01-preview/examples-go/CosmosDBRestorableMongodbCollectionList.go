...
// Generated from example definition: 2026-04-01-preview/CosmosDBRestorableMongodbCollectionList.json
func ExampleRestorableMongodbCollectionsClient_NewListPager() {
	...
	pager := clientFactory.NewRestorableMongodbCollectionsClient().NewListPager("WestUS", "98a570f2-63db-4117-91f0-366327b7b353", &armcosmos.RestorableMongodbCollectionsClientListOptions{
		RestorableMongodbDatabaseRid: to.Ptr("PD5DALigDgw=")})
	for pager.More() {
		...
		// page = armcosmos.RestorableMongodbCollectionsClientListResponse{
