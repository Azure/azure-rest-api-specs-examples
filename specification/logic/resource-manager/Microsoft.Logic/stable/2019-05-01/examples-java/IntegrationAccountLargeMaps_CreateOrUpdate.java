...
public final class Main {
    ...
    public static void createOrUpdateAMapLargerThan4MB(com.azure.resourcemanager.logic.LogicManager manager)
        throws IOException {
        manager.integrationAccountMaps().define("testMap").withRegion("westus")
            .withExistingIntegrationAccount("testResourceGroup", "testIntegrationAccount").withMapType(MapType.XSLT)
            .withContentType("application/xml").withMetadata(SerializerFactory
