...
public final class Main {
    ...
    public static void updateAContentKeyPolicy(com.azure.resourcemanager.mediaservices.MediaServicesManager manager) {
        ContentKeyPolicy resource = manager.contentKeyPolicies().getWithResponse("contosorg", "contosomedia",
            "PolicyWithClearKeyOptionAndTokenRestriction", com.azure.core.util.Context.NONE).getValue();
        resource.update().withDescription("Updated Policy")
