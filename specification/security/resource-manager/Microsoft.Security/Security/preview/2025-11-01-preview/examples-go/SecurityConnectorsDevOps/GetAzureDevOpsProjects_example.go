...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/GetAzureDevOpsProjects_example.json
func ExampleAzureDevOpsProjectsClient_Get() {
	...
	// res = armsecurity.AzureDevOpsProjectsClientGetResponse{
