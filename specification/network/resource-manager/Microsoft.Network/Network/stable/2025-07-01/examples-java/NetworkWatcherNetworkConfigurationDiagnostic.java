...
public final class Main {
    /*
     * x-ms-original-file: 2025-07-01/NetworkWatcherNetworkConfigurationDiagnostic.json
     */
    /**
    ...
    public static void networkConfigurationDiagnostic(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getNetworkWatchers().getNetworkConfigurationDiagnostic("rg1", "nw1",
            new NetworkConfigurationDiagnosticParameters().withTargetResourceId(
