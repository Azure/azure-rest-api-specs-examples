...
// Generated from example definition: 2026-04-01/storageTaskAssignmentsList/ListStorageTaskAssignmentsInstancesReportSummary.json
func ExampleTaskAssignmentsInstancesReportClient_NewListPager() {
	...
	pager := clientFactory.NewTaskAssignmentsInstancesReportClient().NewListPager("res4228", "sto4445", nil)
	for pager.More() {
		...
		// page = armstorage.TaskAssignmentsInstancesReportClientListResponse{
