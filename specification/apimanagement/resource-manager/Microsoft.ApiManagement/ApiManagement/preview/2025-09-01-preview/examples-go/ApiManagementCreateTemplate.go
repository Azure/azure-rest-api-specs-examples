...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateTemplate.json
func ExampleEmailTemplateClient_CreateOrUpdate() {
	...
	// res = armapimanagement.EmailTemplateClientCreateOrUpdateResponse{
	// 	EmailTemplateContract: armapimanagement.EmailTemplateContract{
