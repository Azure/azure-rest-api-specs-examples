...
public final class Main {
    ...
    public static void
        ...
        manager.serviceClient().getGalleries().createOrUpdate(
            "myResourceGroup", "myGalleryName", new GalleryInner().withLocation("West US")
                .withDescription("This is the gallery description.").withSoftDeletePolicy(new SoftDeletePolicy()
                    .withIsSoftDeleteEnabled(true).withRetentionPeriodInDays(7).withGracePeriodInDays(30)),
