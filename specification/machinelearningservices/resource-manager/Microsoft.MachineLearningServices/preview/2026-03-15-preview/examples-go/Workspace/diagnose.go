...
func ExampleWorkspacesClient_BeginDiagnose() {
	...
	poller, err := clientFactory.NewWorkspacesClient().BeginDiagnose(ctx, "workspace-1234", "testworkspace", &armmachinelearning.WorkspacesClientBeginDiagnoseOptions{
		Body: &armmachinelearning.DiagnoseWorkspaceParameters{
	...
	// res = armmachinelearning.WorkspacesClientDiagnoseResponse{
	// 	DiagnoseResponseResult: armmachinelearning.DiagnoseResponseResult{
