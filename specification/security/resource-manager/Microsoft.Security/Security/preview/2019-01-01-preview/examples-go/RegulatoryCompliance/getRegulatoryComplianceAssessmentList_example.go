...
// Generated from example definition: 2019-01-01-preview/RegulatoryCompliance/getRegulatoryComplianceAssessmentList_example.json
func ExampleRegulatoryComplianceAssessmentsClient_NewListPager() {
	...
	pager := clientFactory.NewRegulatoryComplianceAssessmentsClient().NewListPager("PCI-DSS-3.2", "1.1", nil)
	for pager.More() {
		...
		// page = armsecurity.RegulatoryComplianceAssessmentsClientListResponse{
		// 	RegulatoryComplianceAssessmentList: armsecurity.RegulatoryComplianceAssessmentList{
