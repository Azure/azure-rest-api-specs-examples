...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateNotification.json
func ExampleNotificationClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewNotificationClient().CreateOrUpdate(ctx, "rg1", "apimService1", armapimanagement.NotificationNameRequestPublisherNotificationMessage, nil)
	if err != nil {
	...
	// res = armapimanagement.NotificationClientCreateOrUpdateResponse{
