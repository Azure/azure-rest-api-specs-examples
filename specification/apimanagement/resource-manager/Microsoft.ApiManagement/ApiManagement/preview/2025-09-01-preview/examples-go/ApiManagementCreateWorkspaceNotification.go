...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateWorkspaceNotification.json
func ExampleWorkspaceNotificationClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewWorkspaceNotificationClient().CreateOrUpdate(ctx, "rg1", "apimService1", "wks1", armapimanagement.NotificationNameRequestPublisherNotificationMessage, nil)
	if err != nil {
	...
	// res = armapimanagement.WorkspaceNotificationClientCreateOrUpdateResponse{
	// 	NotificationContract: armapimanagement.NotificationContract{
