...
public final class Main {
    ...
    public static void artifactSourcesCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.artifactSources().define("{artifactSourceName}").withExistingLab("resourceGroupName", "{labName}")
            .withTags(mapOf("tagName1", "tagValue1")).withDisplayName("{displayName}").withUri("{artifactSourceUri}")
