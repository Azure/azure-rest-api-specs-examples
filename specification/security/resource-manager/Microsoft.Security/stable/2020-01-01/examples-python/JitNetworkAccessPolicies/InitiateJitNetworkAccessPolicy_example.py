...
# USAGE
    python initiate_jit_network_access_policy_example.py
...
def main():
    ...
    response = client.jit_network_access_policies.initiate(
            ...
            "virtualMachines": [
                {
                    ...
                    "ports": [{"allowedSourceAddressPrefix": "192.127.0.2", "duration": "PT1H", "number": 3389}],
                }
            ],
        },
    )
