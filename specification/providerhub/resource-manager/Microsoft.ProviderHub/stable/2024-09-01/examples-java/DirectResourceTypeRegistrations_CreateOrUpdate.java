    ...
    public static void directResourceTypeRegistrationsCreateOrUpdateJson(
        ...
        manager.resourceTypeRegistrations().define("employees").withExistingProviderRegistration("Microsoft.Contoso")
            .withProperties(new ResourceTypeRegistrationProperties().withRoutingType(RoutingType.DEFAULT)
                ...
                .withAllowEmptyRoleAssignments(false).withPolicyExecutionType(PolicyExecutionType.BYPASS_POLICIES)
                ...
                .withDstsConfiguration(new ResourceTypeRegistrationPropertiesDstsConfiguration()
                    .withServiceName("prds-shim").withServiceDnsName("prds.sparta.azure.com"))
                .withAsyncTimeoutRules(Arrays.asList(new AsyncTimeoutRule()
                    .withActionName("Microsoft.ClassicCompute/domainNames/write").withTimeout("PT12H")))
                ...
                .withLegacyName("legacyName").withLegacyNames(Arrays.asList("legacyName"))
                ...
                .withCapacityRule(new ResourceTypeRegistrationPropertiesCapacityRule()
                    .withCapacityPolicy(CapacityPolicy.RESTRICTED).withSkuAlias("incorrectAlias"))
                ...
                .withGroupingTag("groupingTag").withAddResourceListTargetLocations(true)
