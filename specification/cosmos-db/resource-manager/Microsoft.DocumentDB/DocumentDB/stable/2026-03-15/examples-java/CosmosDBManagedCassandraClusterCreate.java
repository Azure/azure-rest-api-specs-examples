...
public final class Main {
    ...
    public static void cosmosDBManagedCassandraClusterCreate(com.azure.resourcemanager.cosmos.CosmosManager manager) {
        manager.serviceClient().getCassandraClusters().createUpdate("cassandra-prod-rg", "cassandra-prod",
            new ClusterResourceInner().withProperties(new ClusterResourceProperties().withDelegatedManagementSubnetId(
                ...
                .withHoursBetweenBackups(24)).withLocation("West US").withTags(mapOf()),
