...
public final class Main {
    /*
     * x-ms-original-file:
     * 2026-03-01/virtualMachineScaleSetExamples/VirtualMachineScaleSetVM_AttachDetachDataDisks_MaximumSet_Gen.json
     */
    /**
    ...
    public static void virtualMachineScaleSetVMAttachDetachDataDisksMaximumSetGen(
        ...
        manager.serviceClient().getVirtualMachineScaleSetVMs().attachDetachDataDisks("rgcompute", "azure-vmscaleset",
            "0",
