...
// Generated from example definition: 2020-11-20/WorkbookTemplateUpdate.json
func ExampleWorkbookTemplatesClient_Update() {
	...
	res, err := clientFactory.NewWorkbookTemplatesClient().Update(ctx, "my-resource-group", "my-template-resource", armapplicationinsights.WorkbookTemplateUpdateParameters{}, nil)
	if err != nil {
	...
	// res = armapplicationinsights.WorkbookTemplatesClientUpdateResponse{
	// 	WorkbookTemplate: armapplicationinsights.WorkbookTemplate{
