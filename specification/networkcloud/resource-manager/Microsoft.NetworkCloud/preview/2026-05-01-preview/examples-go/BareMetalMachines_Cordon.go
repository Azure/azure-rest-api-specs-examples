...
func ExampleBareMetalMachinesClient_BeginCordon() {
	...
	poller, err := clientFactory.NewBareMetalMachinesClient().BeginCordon(ctx, "resourceGroupName", "bareMetalMachineName", &armnetworkcloud.BareMetalMachinesClientBeginCordonOptions{
		BareMetalMachineCordonParameters: &armnetworkcloud.BareMetalMachineCordonParameters{
