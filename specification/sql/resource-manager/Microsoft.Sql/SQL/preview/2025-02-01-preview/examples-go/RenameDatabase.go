...
func ExampleDatabasesClient_Rename() {
	...
	res, err := clientFactory.NewDatabasesClient().Rename(ctx, "Default-SQL-SouthEastAsia", "testsvr", "testdb", armsql.ResourceMoveDefinition{
	...
	// res = armsql.DatabasesClientRenameResponse{
	// }
}
