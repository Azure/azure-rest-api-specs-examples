...
// Generated from example definition: 2025-02-14/KustoClusterUpdateEnableCMK.json
func ExampleClustersClient_BeginUpdate_kustoClusterUpdateEnableCmk() {
	...
	poller, err := clientFactory.NewClustersClient().BeginUpdate(ctx, "kustoRgTest", "kustoCluster", armkusto.ClusterUpdate{
	...
	// 		ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustoRgTest/providers/Microsoft.Kusto/Clusters/kustoCluster"),
