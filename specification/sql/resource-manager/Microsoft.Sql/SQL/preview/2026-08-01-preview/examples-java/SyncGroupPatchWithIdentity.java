...
public final class Main {
    ...
    public static void
        ...
        manager.serviceClient().getSyncGroups().update("syncgroupcrud-65440", "syncgroupcrud-8475",
            ...
            new SyncGroupInner().withIdentity(new DataSyncParticipantIdentity()
                ...
                .withInterval(-1).withConflictResolutionPolicy(SyncConflictResolutionPolicy.HUB_WIN)
                .withSyncDatabaseId(
