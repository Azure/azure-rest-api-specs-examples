...
// Generated from example definition: 2026-08-01-preview/ExtendedDatabaseBlobAuditingGet.json
func ExampleExtendedDatabaseBlobAuditingPoliciesClient_Get() {
	...
	// res = armsql.ExtendedDatabaseBlobAuditingPoliciesClientGetResponse{
