...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListAvailableGitLabGroups_example.json
func ExampleGitLabGroupsClient_ListAvailable() {
	...
	// res = armsecurity.GitLabGroupsClientListAvailableResponse{
	// 	GitLabGroupListResponse: armsecurity.GitLabGroupListResponse{
