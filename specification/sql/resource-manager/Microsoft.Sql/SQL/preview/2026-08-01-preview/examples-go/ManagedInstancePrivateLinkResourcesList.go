...
// Generated from example definition: 2026-08-01-preview/ManagedInstancePrivateLinkResourcesList.json
func ExampleManagedInstancePrivateLinkResourcesClient_NewListByManagedInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.ManagedInstancePrivateLinkResourcesClientListByManagedInstanceResponse{
		// 	ManagedInstancePrivateLinkListResult: armsql.ManagedInstancePrivateLinkListResult{
