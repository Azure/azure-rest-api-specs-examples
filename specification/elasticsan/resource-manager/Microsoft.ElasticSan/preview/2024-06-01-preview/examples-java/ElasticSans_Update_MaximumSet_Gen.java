...
public final class Main {
    ...
    public static void elasticSansUpdateMaximumSetGen(com.azure.resourcemanager.elasticsan.ElasticSanManager manager) {
        ElasticSan resource = manager.elasticSans()
            ...
            .getValue();
        resource.update().withTags(mapOf("key5945", "fakeTokenPlaceholder")).withBaseSizeTiB(21L)
            .withExtendedCapacitySizeTiB(10L).withPublicNetworkAccess(PublicNetworkAccess.ENABLED)
