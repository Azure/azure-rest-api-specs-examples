...
// Generated from example definition: 2024-10-23/runbook/listTestJobStreamsByJob.json
func ExampleTestJobStreamsClient_NewListByTestJobPager() {
	...
	pager := clientFactory.NewTestJobStreamsClient().NewListByTestJobPager("mygroup", "ContoseAutomationAccount", "Get-AzureVMTutorial", nil)
	for pager.More() {
		...
		// page = armautomation.TestJobStreamsClientListByTestJobResponse{
