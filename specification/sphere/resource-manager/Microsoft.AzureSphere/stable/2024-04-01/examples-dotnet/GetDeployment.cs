...
NullableResponse<SphereDeploymentResource> response = await collection.GetIfExistsAsync(deploymentName);
SphereDeploymentResource result = response.HasValue ? response.Value : null;
