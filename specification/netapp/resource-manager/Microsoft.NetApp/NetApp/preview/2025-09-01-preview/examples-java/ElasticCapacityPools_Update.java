...
public final class Main {
    ...
    public static void elasticCapacityPoolsUpdate(com.azure.resourcemanager.netapp.NetAppFilesManager manager) {
        ElasticCapacityPool resource = manager.elasticCapacityPools()
            .getWithResponse("myRG", "account1", "pool1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(
            new ElasticCapacityPoolUpdateProperties().withSize(4398046511104L).withActiveDirectoryConfigResourceId(
