...
public final class Main {
    ...
    public static void createOrUpdateWorkspaceFeaturestoreEntityVersion(
        ...
        manager.featurestoreEntityVersions().define("string")
            ...
            .withProperties(
                new FeaturestoreEntityVersionProperties().withDescription("string").withTags(mapOf("string", "string"))
                    .withProperties(mapOf("string", "string")).withIsArchived(false).withIsAnonymous(false)
