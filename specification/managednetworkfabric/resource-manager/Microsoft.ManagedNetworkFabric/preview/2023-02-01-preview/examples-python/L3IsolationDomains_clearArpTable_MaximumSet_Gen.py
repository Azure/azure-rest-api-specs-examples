...
# USAGE
    python l3_isolation_domains_clear_arp_table_maximum_set_gen.py
...
def main():
    ...
    client.l3_isolation_domains.begin_clear_arp_table(
        resource_group_name="resourceGroupName",
        l3_isolation_domain_name="l3IsolationDomainName",
        body={
            "resourceIds": [
