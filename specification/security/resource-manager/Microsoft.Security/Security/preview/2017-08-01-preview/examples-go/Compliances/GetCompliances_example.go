...
// Generated from example definition: 2017-08-01-preview/Compliances/GetCompliances_example.json
func ExampleCompliancesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.CompliancesClientListResponse{
		// 	ComplianceList: armsecurity.ComplianceList{
