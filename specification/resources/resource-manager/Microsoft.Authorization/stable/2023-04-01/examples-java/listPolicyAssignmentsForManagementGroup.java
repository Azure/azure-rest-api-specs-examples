...
public final class Main {
    ...
    public static void
        ...
        azure.genericResources().manager().policyClient().getPolicyAssignments().listForManagementGroup(
            "TestManagementGroup", "atScope()", "LatestDefinitionVersion, EffectiveDefinitionVersion", null,
