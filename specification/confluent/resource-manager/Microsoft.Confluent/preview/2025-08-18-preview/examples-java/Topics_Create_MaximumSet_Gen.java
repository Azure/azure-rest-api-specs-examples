...
public final class Main {
    ...
    public static void topicsCreateMaximumSet(com.azure.resourcemanager.confluent.ConfluentManager manager) {
        manager.topics().define("zlqnddejetmtrl")
            ...
            .withPartitionsReassignments(new TopicsRelatedLink().withRelated("bgeg")).withPartitionsCount("fxcu")
            .withReplicationFactor("ftsyww").create();
    }
}
