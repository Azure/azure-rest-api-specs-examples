...
func ExampleRestorableGremlinGraphsClient_NewListPager() {
	...
	client, err := armcosmos.NewRestorableGremlinGraphsClient("<subscription-id>", cred, nil)
	if err != nil {
	...
	pager := client.NewListPager("<location>",
		"<instance-id>",
		&armcosmos.RestorableGremlinGraphsClientListOptions{RestorableGremlinDatabaseRid: to.Ptr("<restorable-gremlin-database-rid>"),
			StartTime: nil,
			EndTime:   nil,
		})
	for pager.More() {
