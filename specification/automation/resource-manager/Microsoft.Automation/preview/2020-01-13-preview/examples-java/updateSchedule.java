...
public final class Main {
    ...
    public static void updateASchedule(com.azure.resourcemanager.automation.AutomationManager manager) {
        Schedule resource = manager.schedules()
            .getWithResponse("rg", "myAutomationAccount33", "mySchedule", com.azure.core.util.Context.NONE).getValue();
        resource.update().withName("mySchedule").withDescription("my updated description of schedule goes here")
            .withIsEnabled(false).apply();
    }
}
