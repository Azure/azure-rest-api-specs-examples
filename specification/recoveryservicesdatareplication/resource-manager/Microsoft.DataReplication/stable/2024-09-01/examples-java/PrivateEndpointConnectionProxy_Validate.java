...
public final class Main {
    ...
    public static void validatesThePrivateEndpointConnectionProxy(
        ...
        manager.privateEndpointConnProxies().validateWithResponse("rgswagger_2024-09-01", "4", "d",
                ...
                .withProperties(new PrivateEndpointConnectionProxyProperties()
                    .withRemotePrivateEndpoint(new RemotePrivateEndpoint().withId("yipalno")
                        .withPrivateLinkServiceConnections(Arrays.asList(new PrivateLinkServiceConnection()
                            .withName("jqwntlzfsksl").withGroupIds(Arrays.asList("hvejynjktikteipnioyeja"))
                        ...
                        .withPrivateLinkServiceProxies(
                            Arrays.asList(new PrivateLinkServiceProxy().withId("nzqxevuyqeedrqnkbnlcyrrrbzxvl")
                                .withRemotePrivateLinkServiceConnectionState(new PrivateLinkServiceConnectionState()
                                    .withStatus(PrivateEndpointConnectionStatus.APPROVED).withDescription("y")
                                ...
                                .withGroupConnectivityInformation(Arrays.asList(new GroupConnectivityInformation()
                                    .withGroupId("per").withMemberName("ybptuypgdqoxkuwqx")
                                    .withCustomerVisibleFqdns(Arrays.asList("vedcg"))
                                    .withInternalFqdn("maqavwhxwzzhbzjbryyquvitmup").withRedirectMapId("pezncxcq")
                        ...
                        .withConnectionDetails(Arrays.asList(new ConnectionDetails().withId("lenqkogzkes")
                            .withPrivateIpAddress("cyiacdzzyqmxjpijjbwgasegehtqe").withLinkIdentifier("ravfufhkdowufd")
                            .withGroupId("pjrlygpadir").withMemberName("ybuysjrlfupewxe")))))
