...
// get the collection of this MachineLearningOutboundRuleBasicResource
...
await foreach (MachineLearningOutboundRuleBasicResource item in collection.GetAllAsync())
{
    // the variable item is a resource, you could call other operations on this instance as well
    // but just for demo, we get its data from this resource instance
    MachineLearningOutboundRuleBasicData resourceData = item.Data;
