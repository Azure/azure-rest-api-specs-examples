...
public final class Main {
    ...
    public static void tenantPolicy(com.azure.resourcemanager.subscription.SubscriptionManager manager) {
        manager.subscriptionPolicies()
            .addUpdatePolicyForTenantWithResponse(new PutTenantPolicyRequestProperties()
                .withBlockSubscriptionsLeavingTenant(true).withBlockSubscriptionsIntoTenant(true)
