...
// Generated from example definition: 2026-08-01-preview/ManagedDatabaseRestoreDetails.json
func ExampleManagedDatabaseRestoreDetailsClient_Get() {
	...
	// res = armsql.ManagedDatabaseRestoreDetailsClientGetResponse{
	// 	ManagedDatabaseRestoreDetailsResult: armsql.ManagedDatabaseRestoreDetailsResult{
	// 		Name: to.Ptr("current"),
	...
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 20, 21, 366745400, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 19, 40, 545509200, time.UTC)),
	...
	// 					NumberOfStripes: to.Ptr[int32](3),
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 18, 41, 378508900, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 15, 40, 314326300, time.UTC)),
	// 					Status: to.Ptr("Restored"),
	// 				},
	// 			},
	// 			LastRestoredFileName: to.Ptr("RestoreDetailsFullBlownExampleLog9_1.bak"),
	// 			LastRestoredFileTime: to.Ptr(time.Date(2022, time.May, 9, 12, 27, 20, 493630500, time.UTC)),
	// 			LastUploadedFileName: to.Ptr("RestoreDetailsFullBlownExampleLog11.bak"),
	// 			LastUploadedFileTime: to.Ptr(time.Date(2022, time.March, 1, 7, 54, 21, 0, time.UTC)),
	...
	// 					NumberOfStripes: to.Ptr[int32](1),
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 21, 54, 755785100, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 21, 1, 771745300, time.UTC)),
	// 					Status: to.Ptr("Restored"),
	// 				},
	// 				{
	// 					BackupSizeMB: to.Ptr[int32](3),
	...
	// 					NumberOfStripes: to.Ptr[int32](1),
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 23, 3, 709407000, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 22, 41, 878406200, time.UTC)),
	// 					Status: to.Ptr("Restored"),
	// 				},
	// 				{
	...
	// 					NumberOfStripes: to.Ptr[int32](1),
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 23, 52, 927404700, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 23, 36, 626406600, time.UTC)),
	// 					Status: to.Ptr("Restored"),
	// 				},
	// 				{
	// 					BackupSizeMB: to.Ptr[int32](3),
	...
	// 					NumberOfStripes: to.Ptr[int32](1),
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 24, 37, 995406300, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 24, 25, 899407000, time.UTC)),
	// 					Status: to.Ptr("Restored"),
	// 				},
	// 				{
	// 					BackupSizeMB: to.Ptr[int32](4),
	...
	// 					RestoreFinishedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 25, 27, 808409000, time.UTC)),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 25, 10, 880406500, time.UTC)),
	// 					Status: to.Ptr("Restored"),
	// 				},
	// 				{
	...
	// 					NumberOfStripes: to.Ptr[int32](1),
	// 					RestoreStartedTimestampUTC: to.Ptr(time.Date(2022, time.May, 9, 12, 26, 0, 781310300, time.UTC)),
