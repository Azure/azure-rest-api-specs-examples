...
public final class Main {
    ...
    public static void createOrUpdateACertificate(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.certificates().define("testCert").withExistingAutomationAccount("rg", "myAutomationAccount18")
            .withName("testCert").withBase64Value("base 64 value of cert").withDescription("Sample Cert")
            .withThumbprint("thumbprint of cert").withIsExportable(false).create();
    }
}
