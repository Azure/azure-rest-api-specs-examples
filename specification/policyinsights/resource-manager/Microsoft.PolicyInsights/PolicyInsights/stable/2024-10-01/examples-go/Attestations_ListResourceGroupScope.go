...
// Generated from example definition: 2024-10-01/Attestations_ListResourceGroupScope.json
func ExampleAttestationsClient_NewListForResourceGroupPager_listAttestationsAtResourceGroupScope() {
	...
	pager := clientFactory.NewAttestationsClient().NewListForResourceGroupPager("myRg", nil)
	for pager.More() {
