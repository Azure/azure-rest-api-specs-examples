...
public final class Main {
     ...
     */
    public static void configurationServicesValidateResource(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.springServices().manager().serviceClient().getConfigurationServices()
            .validateResource("myResourceGroup", "myservice", "default", new ConfigurationServiceResourceInner()
