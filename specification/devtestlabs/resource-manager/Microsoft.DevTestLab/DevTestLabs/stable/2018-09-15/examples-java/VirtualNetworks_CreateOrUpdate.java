...
public final class Main {
    ...
    public static void virtualNetworksCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualNetworks().define("{virtualNetworkName}").withExistingLab("resourceGroupName", "{labName}")
            .withRegion("{location}").withTags(mapOf("tagName1", "tagValue1"))
            .withAllowedSubnets(Arrays.asList(new Subnet().withResourceId(
                ...
                .withLabSubnetName("{virtualNetworkName}Subnet").withAllowPublicIp(UsagePermissionType.ALLOW)))
            .create();
    }
