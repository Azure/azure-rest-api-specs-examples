...
// Generated from example definition: 2024-10-01/PolicyEvents_QueryResourceGroupScopeNextLink.json
func ExamplePolicyEventsClient_NewListQueryResultsForResourceGroupPager_queryAtResourceGroupScopeWithNextLink() {
	...
	pager := clientFactory.NewPolicyEventsClient().NewListQueryResultsForResourceGroupPager(armpolicyinsights.PolicyEventsResourceTypeDefault, "fffedd8f-ffff-fffd-fffd-fffed2f84852", "myResourceGroup", &armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupOptions{
	...
	for pager.More() {
		...
		// page = armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupResponse{
