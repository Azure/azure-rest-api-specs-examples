...
public final class Main {
    ...
    public static void executeTestFailoverForCluster(
        ...
        manager.replicationProtectionClusters().testFailover("resourceGroupPS1", "vault1", "fabric-pri-eastus",
            "pri-cloud-eastus", "testcluster",
            new ClusterTestFailoverInput().withProperties(new ClusterTestFailoverInputProperties()
                .withFailoverDirection(FailoverDirection.PRIMARY_TO_RECOVERY).withNetworkType("VmNetworkAsInput")
                .withNetworkId(
