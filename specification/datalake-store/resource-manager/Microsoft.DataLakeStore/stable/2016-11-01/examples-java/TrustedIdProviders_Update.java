...
public final class Main {
    ...
    public static void updatesTheSpecifiedTrustedIdentityProvider(
        ...
        TrustedIdProvider resource = manager.trustedIdProviders().getWithResponse("contosorg", "contosoadla",
            "test_trusted_id_provider_name", com.azure.core.util.Context.NONE).getValue();
