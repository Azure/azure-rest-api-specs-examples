...
public final class Main {
    ...
    public static void
        ...
        manager.connectorMappings().define("testMapping12491")
            .withExistingConnector("TestHubRG", "sdkTestHub", "testConnector8858")
            .withEntityType(EntityTypes.INTERACTION).withEntityTypeName("TestInteractionType2967")
            .withDisplayName("testMapping12491").withDescription("Test mapping")
            .withMappingProperties(new ConnectorMappingProperties().withFolderPath("http://sample.dne/file")
                .withFileFilter("unknown").withHasHeader(false)
                .withErrorManagement(new ConnectorMappingErrorManagement()
                    .withErrorManagementType(ErrorManagementTypes.STOP_IMPORT).withErrorLimit(10))
                ...
                .withStructure(Arrays.asList(
                    new ConnectorMappingStructure().withPropertyName("unknwon1").withColumnName("unknown1")
                        .withIsEncrypted(false),
                    new ConnectorMappingStructure().withPropertyName("unknwon2").withColumnName("unknown2")
