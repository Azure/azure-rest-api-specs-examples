...
public final class Main {
    ...
    public static void createOrUpdateACustomAIModel(
        ...
        manager.customAIModels().define("custom-model1").withExistingAiManager("rg1", "aimanager1").withProperties(
            new CustomAIModelProperties().withModelId("Qwen/Qwen36-27B-private").withBaseModel(new BaseModelReference()
                .withId("Qwen/Qwen3.6-27B").withTotalWeightSizeBytes(64700000000L)
                .withConfig(mapOf("architectures",
                    ...
                    "language_model_only", BinaryData.fromBytes("false".getBytes(StandardCharsets.UTF_8)), "model_type",
                    BinaryData.fromBytes("qwen3_5".getBytes(StandardCharsets.UTF_8)), "text_config",
                    ...
                    "video_token_id", BinaryData.fromBytes("248057".getBytes(StandardCharsets.UTF_8)), "vision_config",
                    BinaryData.fromBytes(
