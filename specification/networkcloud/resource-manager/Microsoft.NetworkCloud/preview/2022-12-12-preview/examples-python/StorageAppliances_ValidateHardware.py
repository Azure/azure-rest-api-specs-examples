...
# USAGE
    python storage_appliances_validate_hardware.py
...
def main():
    ...
    response = client.storage_appliances.begin_validate_hardware(
        resource_group_name="resourceGroupName",
        storage_appliance_name="storageApplianceName",
        storage_appliance_validate_hardware_parameters={"validationCategory": "BasicValidation"},
    ).result()
    print(response)
