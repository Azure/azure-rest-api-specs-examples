...
public final class Main {
    ...
    public static void createAMediaServicesAccountManagedIdentity(
        ...
        manager.mediaservices().define("contososports").withRegion("South Central US")
            .withExistingResourceGroup("contosorg")
            .withTags(mapOf("key1", "fakeTokenPlaceholder", "key2", "fakeTokenPlaceholder"))
            .withIdentity(new MediaServiceIdentity().withType("UserAssigned").withUserAssignedIdentities(mapOf(
