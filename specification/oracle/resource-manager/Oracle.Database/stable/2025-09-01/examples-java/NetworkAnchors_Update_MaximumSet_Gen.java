...
public final class Main {
    ...
    public static void
        ...
        NetworkAnchor resource = manager.networkAnchors()
            .getByResourceGroupWithResponse("rgopenapi", "networkanchor1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key8038", "fakeTokenPlaceholder")).withZones(Arrays.asList("zone1"))
