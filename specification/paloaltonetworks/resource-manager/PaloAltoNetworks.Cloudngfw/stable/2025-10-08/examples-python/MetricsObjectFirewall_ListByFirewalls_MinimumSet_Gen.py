...
# USAGE
    python metrics_object_firewall_list_by_firewalls_minimum_set_gen.py
...
def main():
    client = PaloAltoNetworksNgfwMgmtClient(
        ...
        subscription_id="aaaaaaaaaaaaaaaaaaaaaaaaa",
    )

    response = client.metrics_object_firewall.list_by_firewalls(
