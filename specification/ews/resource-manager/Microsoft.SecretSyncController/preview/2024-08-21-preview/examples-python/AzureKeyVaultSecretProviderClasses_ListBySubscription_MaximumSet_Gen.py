...
# USAGE
    python azure_key_vault_secret_provider_classes_list_by_subscription_maximum_set_gen.py
...
def main():
    ...
    response = client.azure_key_vault_secret_provider_classes.list_by_subscription()
