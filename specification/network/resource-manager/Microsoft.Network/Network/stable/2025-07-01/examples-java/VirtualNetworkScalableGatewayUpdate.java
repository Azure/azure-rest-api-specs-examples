...
public final class Main {
     ...
     */
    public static void updateVirtualNetworkScalableGateway(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVirtualNetworkGateways().createOrUpdate("rg1", "ergw",
