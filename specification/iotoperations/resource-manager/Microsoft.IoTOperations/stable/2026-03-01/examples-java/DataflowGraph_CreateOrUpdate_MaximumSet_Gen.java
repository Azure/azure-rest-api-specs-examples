...
public final class Main {
    ...
    public static void
        ...
        manager.dataflowGraphs().define("resource-123")
            ...
            .withProperties(new DataflowGraphProperties().withMode(OperationalMode.ENABLED)
                ...
                .withNodes(Arrays.asList(
                    new DataflowGraphSourceNode().withName("temperature")
                    ...
                    new DataflowGraphGraphNode().withName("my-graph")
                        .withGraphSettings(new DataflowGraphNodeGraphSettings()
                            .withRegistryEndpointRef("my-registry-endpoint").withArtifact("my-wasm-module:1.4.3")
                    ...
                    new DataflowGraphDestinationNode().withName("alert")
                        .withDestinationSettings(new DataflowGraphDestinationNodeSettings().withEndpointRef("default")
                            .withDataDestination("telemetry/temperature/alert")),
                    new DataflowGraphDestinationNode().withName("fabric")
                        .withDestinationSettings(new DataflowGraphDestinationNodeSettings().withEndpointRef("fabric")
                            .withDataDestination("my-table"))))
                .withNodeConnections(Arrays.asList(
                    new DataflowGraphNodeConnection().withFrom(
                        new DataflowGraphConnectionInput()
                            .withName("temperature").withSchema(
                    ...
                    new DataflowGraphNodeConnection()
                        .withFrom(new DataflowGraphConnectionInput().withName("my-graph.alert-output")
