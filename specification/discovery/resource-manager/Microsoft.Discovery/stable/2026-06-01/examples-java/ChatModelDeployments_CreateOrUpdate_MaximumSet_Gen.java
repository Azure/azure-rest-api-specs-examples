...
public final class Main {
    ...
    public static void
        ...
        manager.chatModelDeployments().define("2143036f84d477b367").withRegion("uksouth")
            .withExistingWorkspace("rgdiscovery", "f3ed10c1c617387d5d")
            .withTags(mapOf("key984", "fakeTokenPlaceholder"))
            .withProperties(new ChatModelDeploymentProperties().withModelFormat("zo").withModelName("ijzwlirrkr")
                .withModelVersion("seiduxog").withSkuName("dymgademiauwwacz").withCapacity(8))
            .create();
    }
