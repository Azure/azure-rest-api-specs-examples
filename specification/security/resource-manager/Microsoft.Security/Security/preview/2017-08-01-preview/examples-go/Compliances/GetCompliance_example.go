...
// Generated from example definition: 2017-08-01-preview/Compliances/GetCompliance_example.json
func ExampleCompliancesClient_Get() {
	...
	// res = armsecurity.CompliancesClientGetResponse{
	// 	Compliance: armsecurity.Compliance{
