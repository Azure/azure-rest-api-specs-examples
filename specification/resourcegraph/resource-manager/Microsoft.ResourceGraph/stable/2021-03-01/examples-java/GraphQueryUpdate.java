...
public final class Main {
    ...
    public static void updateGraphQuery(com.azure.resourcemanager.resourcegraph.ResourceGraphManager manager) {
        GraphQueryResource resource
            = manager.graphQueries().getByResourceGroupWithResponse("024e2271-06fa-46b6-9079-f1ed3c7b070e",
                "my-resource-group", "MyDockerVMs", com.azure.core.util.Context.NONE).getValue();
        resource.update().withEtag("b0809832-ca62-4133-8f13-0c46580f9db1").withDescription("Modified description")
            .withQuery("where isnotnull(tags['Prod']) and properties.extensions[0].Name == 'docker'").apply();
    }
}
