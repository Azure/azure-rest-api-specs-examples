...
# USAGE
    python sync_identity_providers_create_or_update.py
...
def main():
    ...
    response = client.sync_identity_providers.create_or_update(
...
# x-ms-original-file: specification/redhatopenshift/resource-manager/Microsoft.RedHatOpenShift/stable/2023-09-04/examples/SyncIdentityProviders_CreateOrUpdate.json
