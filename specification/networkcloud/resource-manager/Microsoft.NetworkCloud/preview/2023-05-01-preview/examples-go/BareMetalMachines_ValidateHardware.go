...
func ExampleBareMetalMachinesClient_BeginValidateHardware() {
	...
	poller, err := clientFactory.NewBareMetalMachinesClient().BeginValidateHardware(ctx, "resourceGroupName", "bareMetalMachineName", armnetworkcloud.BareMetalMachineValidateHardwareParameters{
		ValidationCategory: to.Ptr(armnetworkcloud.BareMetalMachineHardwareValidationCategoryBasicValidation),
	}, nil)
	if err != nil {
