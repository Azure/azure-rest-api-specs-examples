...
func ExamplePrivateLinkScopesClient_NewListByResourceGroupPager() {
	...
	clientFactory, err := armhybridcompute.NewClientFactory("86dc51d3-92ed-4d7e-947a-775ea79b4919", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armhybridcompute.PrivateLinkScopesClientListByResourceGroupResponse{
		// 	PrivateLinkScopeListResult: armhybridcompute.PrivateLinkScopeListResult{
		...
		// 					ServiceExtensions: []*armhybridcompute.ServiceExtension{
		// 						{
		// 							ServiceExtensionPublicNetworkAccess: to.Ptr(armhybridcompute.ServiceExtensionPublicNetworkAccessEnabled),
		// 							ServiceExtensionType: to.Ptr("SQL"),
		// 						},
		// 					},
		// 				},
