...
// Generated from example definition: 2026-03-15/CosmosDBRestorableSqlDatabaseList.json
func ExampleRestorableSQLDatabasesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armcosmos.RestorableSQLDatabasesClientListResponse{
		// 	RestorableSQLDatabasesListResult: armcosmos.RestorableSQLDatabasesListResult{
