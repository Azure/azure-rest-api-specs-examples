...
public final class Main {
    ...
    public static void deidServicesUpdateGeneratedByMaximumSetRuleGeneratedByMaximumSetRule(
        ...
        DeidService resource = manager.deidServices()
            .getByResourceGroupWithResponse("rgopenapi", "deidTest", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf())
            ...
            .withProperties(new DeidPropertiesUpdate().withPublicNetworkAccess(PublicNetworkAccess.ENABLED)).apply();
    }
