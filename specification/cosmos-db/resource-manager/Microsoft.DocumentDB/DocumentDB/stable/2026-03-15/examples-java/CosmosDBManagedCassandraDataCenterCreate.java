...
public final class Main {
     ...
     */
    public static void
        cosmosDBManagedCassandraDataCenterCreate(com.azure.resourcemanager.cosmos.CosmosManager manager) {
        manager.serviceClient().getCassandraDataCenters().createUpdate("cassandra-prod-rg", "cassandra-prod", "dc1",
