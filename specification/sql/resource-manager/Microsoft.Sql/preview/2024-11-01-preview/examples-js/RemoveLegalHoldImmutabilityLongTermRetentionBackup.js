 ...
 * x-ms-original-file: specification/sql/resource-manager/Microsoft.Sql/preview/2024-11-01-preview/examples/RemoveLegalHoldImmutabilityLongTermRetentionBackup.json
 */
async function removeLegalHoldImmutabilityOfTheLongTermRetentionBackup() {
  ...
  const result = await client.longTermRetentionBackups.beginRemoveLegalHoldImmutabilityAndWait(
    locationName,
