...
// Generated from example definition: 2025-09-01-preview/ApiManagementListTenantSettings.json
func ExampleTenantSettingsClient_NewListByServicePager() {
	...
	pager := clientFactory.NewTenantSettingsClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.TenantSettingsClientListByServiceResponse{
		// 	TenantSettingsCollection: armapimanagement.TenantSettingsCollection{
		// 		NextLink: to.Ptr(""),
