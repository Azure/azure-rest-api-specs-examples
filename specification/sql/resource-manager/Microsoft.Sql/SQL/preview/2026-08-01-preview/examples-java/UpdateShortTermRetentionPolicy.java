...
public final class Main {
    ...
    public static void
        ...
        manager.serviceClient().getBackupShortTermRetentionPolicies().update("resourceGroup", "testsvr", "testdb",
            ShortTermRetentionPolicyName.DEFAULT,
            new BackupShortTermRetentionPolicyInner().withRetentionDays(7)
                .withDiffBackupIntervalInHours(DiffBackupIntervalInHours.TWO_FOUR).withLockImmutability(false),
