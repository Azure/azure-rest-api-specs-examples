...
public final class Main {
    ...
    public static void toolsUpdateMaximumSet(com.azure.resourcemanager.discovery.DiscoveryManager manager) {
        Tool resource = manager.tools()
            ...
            .getValue();
        resource.update().withTags(mapOf("key1372", "fakeTokenPlaceholder")).withProperties(new ToolProperties()
            .withVersion("jtpp").withEnvironmentVariables(mapOf("key8857", "fakeTokenPlaceholder"))
