...
func ExampleEndpointsClient_BeginHandleApprovalDeletion() {
	...
	poller, err := clientFactory.NewEndpointsClient().BeginHandleApprovalDeletion(ctx, "rgopenapi", "TestMyEnclave", "TestMyEnclaveEndpoint", armenclave.ApprovalDeletionCallbackRequest{
	...
	// res = armenclave.EndpointsClientHandleApprovalDeletionResponse{
