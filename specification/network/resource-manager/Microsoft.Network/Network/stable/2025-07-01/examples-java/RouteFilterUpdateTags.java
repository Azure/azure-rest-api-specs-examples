...
public final class Main {
     ...
     */
    public static void updateRouteFilterTags(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getRouteFilters().updateTagsWithResponse("rg1", "filterName",
