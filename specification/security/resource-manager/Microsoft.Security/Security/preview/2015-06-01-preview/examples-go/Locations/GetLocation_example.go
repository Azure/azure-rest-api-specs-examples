...
// Generated from example definition: 2015-06-01-preview/Locations/GetLocation_example.json
func ExampleLocationsClient_Get() {
	...
	// res = armsecurity.LocationsClientGetResponse{
	// 	AscLocation: armsecurity.AscLocation{
