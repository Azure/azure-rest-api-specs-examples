...
public final class Main {
    ...
    public static void createOrUpdateKubernetesOnlineDeployment(
        ...
        manager.onlineDeployments().define("testDeploymentName").withRegion("string")
            ...
            .withProperties(
                new KubernetesOnlineDeployment().withDescription("string").withProperties(mapOf("string", "string"))
                    ...
                    .withLivenessProbe(new ProbeSettings()
                        .withFailureThreshold(1).withSuccessThreshold(1).withTimeout(Duration.parse("PT5M"))
                        .withPeriod(Duration.parse("PT5M")).withInitialDelay(Duration.parse("PT5M")))
