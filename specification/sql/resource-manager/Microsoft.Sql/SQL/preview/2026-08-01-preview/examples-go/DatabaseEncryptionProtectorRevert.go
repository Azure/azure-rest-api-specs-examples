...
// Generated from example definition: 2026-08-01-preview/DatabaseEncryptionProtectorRevert.json
func ExampleDatabaseEncryptionProtectorsClient_BeginRevert() {
	...
	// res = armsql.DatabaseEncryptionProtectorsClientRevertResponse{
	// }
}
