...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListAzureDevOpsRepos_example.json
func ExampleAzureDevOpsReposClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AzureDevOpsReposClientListResponse{
		// 	AzureDevOpsRepositoryListResponse: armsecurity.AzureDevOpsRepositoryListResponse{
