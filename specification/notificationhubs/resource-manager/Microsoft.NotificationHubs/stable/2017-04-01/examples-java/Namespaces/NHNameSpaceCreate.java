...
public final class Main {
    ...
    public static void nameSpaceCreate(com.azure.resourcemanager.notificationhubs.NotificationHubsManager manager) {
        manager.namespaces().define("nh-sdk-ns").withLocation("South Central US").withExistingResourceGroup("5ktrial")
            .withTags(mapOf("tag1", "value1", "tag2", "value2"))
            .withSku(new Sku().withName(SkuName.STANDARD).withTier("Standard")).create();
    }
