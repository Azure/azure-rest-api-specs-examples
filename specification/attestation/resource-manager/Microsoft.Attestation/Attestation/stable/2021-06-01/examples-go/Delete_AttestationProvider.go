...
// Generated from example definition: 2021-06-01/Delete_AttestationProvider.json
func ExampleProvidersClient_Delete() {
	...
	res, err := clientFactory.NewProvidersClient().Delete(ctx, "sample-resource-group", "myattestationprovider", nil)
	if err != nil {
	...
	// res = armattestation.ProvidersClientDeleteResponse{
	// }
}
