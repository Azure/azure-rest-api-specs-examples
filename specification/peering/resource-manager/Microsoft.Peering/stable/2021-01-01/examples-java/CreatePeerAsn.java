...
public final class Main {
    ...
    public static void createAPeerASN(com.azure.resourcemanager.peering.PeeringManager manager) {
        manager.peerAsns().define("peerAsnName").withPeerAsn(65000).withPeerContactDetail(Arrays.asList(
            ...
            new ContactDetail().withRole(Role.TECHNICAL).withEmail("xyz@contoso.com").withPhone("+1 (234) 567-8900")))
            .withPeerName("Contoso").create();
    }
}
