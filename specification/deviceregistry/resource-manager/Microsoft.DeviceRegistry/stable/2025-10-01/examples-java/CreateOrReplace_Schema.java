...
public final class Main {
    ...
    public static void createOrReplaceSchema(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
        manager.schemas().define("my-schema").withExistingSchemaRegistry("myResourceGroup", "my-schema-registry")
            .withProperties(new SchemaProperties().withDisplayName("My Schema")
                .withDescription("This is a sample Schema").withFormat(Format.JSON_SCHEMA_DRAFT7)
                .withSchemaType(SchemaType.MESSAGE_SCHEMA).withTags(mapOf("sampleKey", "fakeTokenPlaceholder")))
            .create();
    }
