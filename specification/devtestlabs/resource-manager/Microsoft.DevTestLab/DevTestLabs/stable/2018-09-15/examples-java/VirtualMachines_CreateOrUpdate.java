...
public final class Main {
    ...
    public static void virtualMachinesCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.virtualMachines().define("{vmName}").withExistingLab("resourceGroupName", "{labName}")
            .withRegion("{location}").withTags(mapOf("tagName1", "tagValue1")).withSize("Standard_A2_v2")
            .withUsername("{userName}").withPassword("{userPassword}").withLabSubnetName("{virtualNetworkName}Subnet")
