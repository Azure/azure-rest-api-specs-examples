...
func ExampleDisasterRecoveryConfigsClient_Delete() {
	...
	res, err := clientFactory.NewDisasterRecoveryConfigsClient().Delete(ctx, "exampleResourceGroup", "sdk-Namespace-5849", "sdk-DisasterRecovery-3814", nil)
	if err != nil {
	...
	// res = armeventhub.DisasterRecoveryConfigsClientDeleteResponse{
	// }
}
