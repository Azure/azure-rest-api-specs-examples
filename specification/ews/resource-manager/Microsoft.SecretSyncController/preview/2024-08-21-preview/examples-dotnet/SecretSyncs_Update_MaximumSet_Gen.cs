...
// this example is just showing the usage of "SecretSync_Update" operation, for the dependent resources, they will have to be created separately.
...
SecretSyncPatch patch = new SecretSyncPatch
{
    Tags =
    {
