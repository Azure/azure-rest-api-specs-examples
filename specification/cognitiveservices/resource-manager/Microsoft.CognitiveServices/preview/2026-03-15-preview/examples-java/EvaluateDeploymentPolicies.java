...
public final class Main {
    ...
    public static void
        ...
        manager.accounts().evaluateDeploymentPoliciesWithResponse("resourceGroupName", "accountName",
            new EvaluateDeploymentPoliciesRequest().withDeployments(Arrays.asList(
                ...
                new EvaluateDeploymentPoliciesDeployment().withName("ada-embedding")
                    .withProperties(new EvaluateDeploymentPoliciesDeploymentProperties().withModel(new DeploymentModel()
                        .withFormat("OpenAI").withName("text-embedding-ada-002").withVersion("2"))))),
