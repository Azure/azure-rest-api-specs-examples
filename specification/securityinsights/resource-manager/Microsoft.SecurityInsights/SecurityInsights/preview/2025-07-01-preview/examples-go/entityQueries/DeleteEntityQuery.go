...
func ExampleEntityQueriesClient_Delete() {
	...
	res, err := clientFactory.NewEntityQueriesClient().Delete(ctx, "myRg", "myWorkspace", "07da3cc8-c8ad-4710-a44e-334cdcb7882b", nil)
	if err != nil {
	...
	// res = armsecurityinsights.EntityQueriesClientDeleteResponse{
	// }
}
