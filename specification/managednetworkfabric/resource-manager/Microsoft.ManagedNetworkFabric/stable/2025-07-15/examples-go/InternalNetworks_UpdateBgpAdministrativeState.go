...
func ExampleInternalNetworksClient_BeginUpdateBgpAdministrativeState() {
	...
	poller, err := clientFactory.NewInternalNetworksClient().BeginUpdateBgpAdministrativeState(ctx, "example-rg", "example-l3isd", "example-internalnetwork", armmanagednetworkfabric.InternalNetworkUpdateBgpAdministrativeStateRequest{
