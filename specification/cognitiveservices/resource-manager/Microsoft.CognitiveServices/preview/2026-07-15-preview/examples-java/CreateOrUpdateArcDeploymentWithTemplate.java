...
public final class Main {
    ...
    public static void createOrUpdateArcDeploymentWithTemplate(
        ...
        manager.arcDeployments().define("qwen-template-arc").withExistingAccount("resourceGroupName", "accountName")
            .withProperties(new ArcDeploymentProperties()
                ...
                .withRuntime(ArcDeploymentRuntime.VLLM).withCompute(ArcDeploymentComputeType.GPU)
