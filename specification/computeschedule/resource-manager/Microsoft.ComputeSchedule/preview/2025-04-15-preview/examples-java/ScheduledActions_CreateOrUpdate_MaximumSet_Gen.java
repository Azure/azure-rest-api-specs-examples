...
public final class Main {
    ...
    public static void scheduledActionsCreateOrUpdateMaximumSet(
        ...
        manager.scheduledActions().define("myScheduledAction").withRegion("vmuhgdgipeypkcv")
            .withExistingResourceGroup("rgcomputeschedule").withTags(mapOf("key2102", "fakeTokenPlaceholder"))
            .withProperties(new ScheduledActionProperties().withResourceType(ResourceType.VIRTUAL_MACHINE)
                ...
                .withSchedule(new ScheduledActionsSchedule().withScheduledTime("19:00:00").withTimeZone("g")
                    .withRequestedWeekDays(Arrays.asList(WeekDay.MONDAY))
                    .withRequestedMonths(Arrays.asList(Month.JANUARY)).withRequestedDaysOfTheMonth(Arrays.asList(15))
