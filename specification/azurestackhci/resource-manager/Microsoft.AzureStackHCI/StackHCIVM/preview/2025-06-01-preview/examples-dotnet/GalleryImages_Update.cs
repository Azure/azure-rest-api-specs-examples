...
HciVmGalleryImagePatch patch = new HciVmGalleryImagePatch
{
    Tags =
    {
...
ArmOperation<HciVmGalleryImageResource> lro = await hciVmGalleryImage.UpdateAsync(WaitUntil.Completed, patch);
