...
public final class Main {
     ...
     */
    public static void updateVirtualNetworkGatewayTags(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVirtualNetworkGateways().updateTags("rg1", "vpngw",
