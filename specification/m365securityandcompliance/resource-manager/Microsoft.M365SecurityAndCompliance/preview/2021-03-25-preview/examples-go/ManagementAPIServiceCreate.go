...
func ExamplePrivateLinkServicesForO365ManagementActivityAPIClient_BeginCreateOrUpdate_createOrUpdateAServiceWithAllParameters() {
	...
	poller, err := clientFactory.NewPrivateLinkServicesForO365ManagementActivityAPIClient().BeginCreateOrUpdate(ctx, "rg1", "service1", armm365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIDescription{
