...
public final class Main {
    ...
    public static void getARequestHistory(com.azure.resourcemanager.logic.LogicManager manager) {
        manager.workflowRunActionRequestHistories().getWithResponse("test-resource-group", "test-workflow",
            "08586776228332053161046300351", "HTTP_Webhook", "08586611142732800686", com.azure.core.util.Context.NONE);
    }
}
