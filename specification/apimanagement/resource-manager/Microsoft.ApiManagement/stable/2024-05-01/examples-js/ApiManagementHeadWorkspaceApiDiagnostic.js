 ...
 * x-ms-original-file: specification/apimanagement/resource-manager/Microsoft.ApiManagement/stable/2024-05-01/examples/ApiManagementHeadWorkspaceApiDiagnostic.json
 */
async function apiManagementHeadWorkspaceApiDiagnostic() {
  ...
  const result = await client.workspaceApiDiagnostic.getEntityTag(
    resourceGroupName,
    serviceName,
    workspaceId,
    apiId,
