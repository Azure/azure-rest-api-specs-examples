...
// Generated from example definition: 2024-10-01/Attestations_ListSubscriptionScope.json
func ExampleAttestationsClient_NewListForSubscriptionPager_listAttestationsAtSubscriptionScope() {
	...
	pager := clientFactory.NewAttestationsClient().NewListForSubscriptionPager(nil)
	for pager.More() {
