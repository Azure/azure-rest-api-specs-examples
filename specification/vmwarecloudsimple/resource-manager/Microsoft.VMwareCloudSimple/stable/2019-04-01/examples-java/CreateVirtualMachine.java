...
public final class Main {
    ...
    public static void
        ...
        manager.virtualMachines().define("myVirtualMachine").withRegion("westus2")
            .withExistingResourceGroup("myResourceGroup").withAmountOfRam(4096)
            .withDisks(Arrays
                .asList(new VirtualDisk().withControllerId("1000").withIndependenceMode(DiskIndependenceMode.PERSISTENT)
                    .withTotalSize(10485760).withVirtualDiskId("2000")))
            .withNics(Arrays.asList(new VirtualNicInner().withNetwork(new VirtualNetworkInner().withId(
                ...
                .withNicType(NicType.E1000).withPowerOnBoot(true).withVirtualNicId("4000")))
            .withNumberOfCores(2)
            .withPrivateCloudId(
