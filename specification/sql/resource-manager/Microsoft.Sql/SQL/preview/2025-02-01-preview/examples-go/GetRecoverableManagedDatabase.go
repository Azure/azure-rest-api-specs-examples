...
// Generated from example definition: 2025-02-01-preview/GetRecoverableManagedDatabase.json
func ExampleRecoverableManagedDatabasesClient_Get() {
	...
	// res = armsql.RecoverableManagedDatabasesClientGetResponse{
	// 	RecoverableManagedDatabase: armsql.RecoverableManagedDatabase{
	// 		Name: to.Ptr("testdb"),
