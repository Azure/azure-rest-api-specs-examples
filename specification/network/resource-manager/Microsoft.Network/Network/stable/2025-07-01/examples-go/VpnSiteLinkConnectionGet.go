...
// Generated from example definition: 2025-07-01/VpnSiteLinkConnectionGet.json
func ExampleVPNSiteLinkConnectionsClient_Get() {
	...
	// res = armnetwork.VPNSiteLinkConnectionsClientGetResponse{
	// 	VPNSiteLinkConnection: armnetwork.VPNSiteLinkConnection{
