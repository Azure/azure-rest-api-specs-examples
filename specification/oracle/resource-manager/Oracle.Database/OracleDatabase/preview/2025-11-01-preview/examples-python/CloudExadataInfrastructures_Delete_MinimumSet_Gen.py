...
# USAGE
    python cloud_exadata_infrastructures_delete_minimum_set_gen.py
...
# x-ms-original-file: 2025-11-01-preview/CloudExadataInfrastructures_Delete_MinimumSet_Gen.json
