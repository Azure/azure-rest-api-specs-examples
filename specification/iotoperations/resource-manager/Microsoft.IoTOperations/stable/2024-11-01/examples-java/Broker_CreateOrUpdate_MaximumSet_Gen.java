    ...
    public static void brokerCreateOrUpdate(com.azure.resourcemanager.iotoperations.IoTOperationsManager manager) {
        manager
            ...
            .withExtendedLocation(new ExtendedLocation().withName(
                "qmbrfwcpwwhggszhrdjv").withType(
                    ExtendedLocationType.CUSTOM_LOCATION))
            .withProperties(
                new BrokerProperties()
                    .withAdvanced(new AdvancedSettings()
                        .withClients(new ClientConfig().withMaxSessionExpirySeconds(3859)
                            .withMaxMessageExpirySeconds(3263).withMaxPacketSizeBytes(3029)
                            .withSubscriberQueueLimit(new SubscriberQueueLimit()
                                .withLength(6L).withStrategy(SubscriberMessageDropStrategy.NONE))
                            .withMaxReceiveMaximum(2365).withMaxKeepAliveSeconds(3744))
                    ...
                    .withCardinality(new Cardinality().withBackendChain(
                        new BackendChain().withPartitions(11).withRedundancyFactor(5).withWorkers(15))
                        .withFrontend(new Frontend().withReplicas(2).withWorkers(6)))
                    .withDiagnostics(new BrokerDiagnostics().withLogs(
                        new DiagnosticsLogs().withLevel("rnmwokumdmebpmfxxxzvvjfdywotav"))
                        .withMetrics(new Metrics().withPrometheusPort(7581))
                        .withSelfCheck(new SelfCheck().withMode(OperationalMode.ENABLED).withIntervalSeconds(158)
                            .withTimeoutSeconds(14))
                        .withTraces(new Traces().withMode(OperationalMode.ENABLED).withCacheSizeMegabytes(28)
                            .withSelfTracing(new SelfTracing()
                                .withMode(OperationalMode.ENABLED).withIntervalSeconds(22))
                    ...
                    .withDiskBackedMessageBuffer(new DiskBackedMessageBuffer().withMaxSize("500M")
                        .withEphemeralVolumeClaimSpec(
                            new VolumeClaimSpec().withVolumeName("c").withVolumeMode("rxvpksjuuugqnqzeiprocknbn")
                                ...
                                .withDataSource(new LocalKubernetesReference().withApiGroup("npqapyksvvpkohujx")
                                    .withKind("wazgyb").withName("cwhsgxxcxsyppoefm"))
                                .withDataSourceRef(new KubernetesReference()
                                    .withApiGroup("mnfnykznjjsoqpfsgdqioupt").withKind("odynqzekfzsnawrctaxg")
                                    .withName("envszivbbmixbyddzg").withNamespace("etcfzvxqd"))
                                ...
                                .withSelector(new VolumeClaimSpecSelector()
                                    .withMatchExpressions(Arrays.asList(new VolumeClaimSpecSelectorMatchExpressions()
                                        .withKey("fakeTokenPlaceholder").withOperator(OperatorValues.IN)
