...
public final class Main {
    ...
    public static void
        ...
        KubernetesClusterFeature resource = manager.kubernetesClusterFeatures().getWithResponse("resourceGroupName",
            "kubernetesClusterName", "featureName", com.azure.core.util.Context.NONE).getValue();
