...
public final class Main {
    ...
    public static void
        ...
        manager.serviceClient().getGalleryApplicationVersions().update("myResourceGroup", "myGalleryName",
            "myGalleryApplicationName", "1.0.0", new GalleryApplicationVersionUpdate()
