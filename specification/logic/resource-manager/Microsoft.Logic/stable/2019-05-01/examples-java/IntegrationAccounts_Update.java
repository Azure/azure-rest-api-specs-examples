...
public final class Main {
    ...
    public static void patchAnIntegrationAccount(com.azure.resourcemanager.logic.LogicManager manager) {
        IntegrationAccount resource = manager.integrationAccounts().getByResourceGroupWithResponse("testResourceGroup",
            "testIntegrationAccount", com.azure.core.util.Context.NONE).getValue();
