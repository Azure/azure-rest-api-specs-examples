...
public final class Main {
    ...
    public static void createOrUpdateRollout(com.azure.resourcemanager.deploymentmanager.DeploymentManager manager) {
        manager.rollouts().define("myRollout").withRegion("centralus").withExistingResourceGroup("myResourceGroup")
            .withIdentity(new Identity().withType("userAssigned").withIdentityIds(Arrays.asList(
            ...
            .withStepGroups(Arrays.asList(
                new StepGroup().withName("FirstRegion")
                    .withPreDeploymentSteps(
                        Arrays.asList(
                            new PrePostStep().withStepId("Microsoft.DeploymentManager/steps/preDeployStep1"),
                            new PrePostStep().withStepId("Microsoft.DeploymentManager/steps/preDeployStep2")))
                    ...
                    .withPostDeploymentSteps(Arrays
                        .asList(new PrePostStep().withStepId("Microsoft.DeploymentManager/steps/postDeployStep1"))),
                new StepGroup().withName("SecondRegion").withDependsOnStepGroups(Arrays.asList("FirstRegion"))
                    .withPreDeploymentSteps(
                        Arrays.asList(new PrePostStep().withStepId("Microsoft.DeploymentManager/steps/preDeployStep3"),
                            new PrePostStep().withStepId("Microsoft.DeploymentManager/steps/preDeployStep4")))
                    .withDeploymentTargetId(
                        "Microsoft.DeploymentManager/serviceTopologies/myTopology/services/myService/serviceUnits/myServiceUnit2'")
                    .withPostDeploymentSteps(Arrays
                        .asList(new PrePostStep().withStepId("Microsoft.DeploymentManager/steps/postDeployStep5")))))
            .withTags(mapOf())
