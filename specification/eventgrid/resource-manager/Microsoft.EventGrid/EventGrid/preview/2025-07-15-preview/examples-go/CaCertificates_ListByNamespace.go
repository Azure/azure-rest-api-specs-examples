...
func ExampleCaCertificatesClient_NewListByNamespacePager() {
	...
	pager := clientFactory.NewCaCertificatesClient().NewListByNamespacePager("examplerg", "namespace123", nil)
	for pager.More() {
		...
		// page = armeventgrid.CaCertificatesClientListByNamespaceResponse{
		// 	CaCertificatesListResult: armeventgrid.CaCertificatesListResult{
