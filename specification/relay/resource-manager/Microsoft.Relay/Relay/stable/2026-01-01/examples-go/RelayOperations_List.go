...
// Generated from example definition: 2026-01-01/RelayOperations_List.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armrelay.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armrelay.OperationsClientListResponse{
		// 	OperationListResult: armrelay.OperationListResult{
