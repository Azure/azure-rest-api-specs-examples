...
public final class Main {
    ...
    public static void
        ...
        manager.networkMonitors().define("example-monitor").withRegion("eastus").withExistingResourceGroup("example-rg")
            ...
            .withBmpConfiguration(new BmpConfigurationProperties()
                ...
                .withStationName("name").withStationIp("10.0.0.1").withStationPort(62695)
                ...
                .withStationConnectionProperties(new StationConnectionProperties().withKeepaliveIdleTime(49)
                    .withProbeInterval(3558).withProbeCount(43))
                .withStationNetwork(
