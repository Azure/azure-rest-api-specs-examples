...
public final class Main {
    ...
    public static void targetsCreateOrUpdateMaximumSet(
        ...
        manager.targets().define("testname").withRegion("kckloegmwsjgwtcl")
            .withExistingResourceGroup("rgconfigurationmanager").withTags(mapOf("key612", "fakeTokenPlaceholder"))
            .withProperties(new TargetProperties().withDescription("riabrxtvhlmizyhffdpjeyhvw")
                ...
                .withTargetSpecification(mapOf()).withCapabilities(Arrays.asList("grjapghdidoao"))
                .withHierarchyLevel("octqptfirejhjfavlnfqeiikqx").withSolutionScope("testname")
