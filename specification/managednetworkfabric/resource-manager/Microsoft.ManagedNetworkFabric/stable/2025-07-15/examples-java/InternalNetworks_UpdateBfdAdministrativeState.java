...
public final class Main {
    ...
    public static void internalNetworksUpdateBfdAdministrativeState(
        ...
        manager.internalNetworks().updateBfdAdministrativeState("example-rg", "example-l3isd",
            ...
            new InternalNetworkUpdateBfdAdministrativeStateRequest().withRouteType(InternalNetworkRouteType.STATIC)
                .withNeighborAddress("10.10.1.10").withAdministrativeState(BfdAdministrativeState.fromString("Enable")),
