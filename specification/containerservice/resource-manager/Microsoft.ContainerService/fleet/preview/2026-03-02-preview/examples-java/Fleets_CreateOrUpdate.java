...
public final class Main {
    ...
    public static void createsAFleetResourceWithALongRunningOperation(
        ...
        manager.fleets().define("fleet1").withRegion("East US").withExistingResourceGroup("rgfleets").withTags(mapOf())
            ...
            .withHubProfile(new FleetHubProfile().withDnsPrefix("dnsprefix1")
                .withApiServerAccessProfile(new ApiServerAccessProfile().withEnablePrivateCluster(true)
                    .withEnableVnetIntegration(true).withSubnetId(
            ...
            .withIfMatch("jzlrwaylijhsnzp").withIfNoneMatch("cqpzdjshmggwolagomzxfy").create();
    }
