...
func ExampleWorkspacesClient_BeginDelete() {
	...
	poller, err := clientFactory.NewWorkspacesClient().BeginDelete(ctx, "oiautorest6685", "oiautorest6685", nil)
	if err != nil {
	...
	// res = armoperationalinsights.WorkspacesClientDeleteResponse{
	// }
}
