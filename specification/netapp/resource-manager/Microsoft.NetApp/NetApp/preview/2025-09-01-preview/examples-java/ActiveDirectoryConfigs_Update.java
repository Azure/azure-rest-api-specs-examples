...
public final class Main {
    ...
    public static void activeDirectoryConfigsUpdate(com.azure.resourcemanager.netapp.NetAppFilesManager manager) {
        ActiveDirectoryConfig resource = manager.activeDirectoryConfigs()
            .getByResourceGroupWithResponse("myRG", "adconfig1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(new ActiveDirectoryConfigUpdateProperties().withSmbServerName("smbServer2"))
            .apply();
    }
}
