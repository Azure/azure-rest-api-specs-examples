...
func ExampleDrillRunResourcesClient_NewListPager() {
	...
	pager := clientFactory.NewDrillRunResourcesClient().NewListPager("sampleServiceGroupName", "drill1", "ca92602e-53bf-43d2-ae62-d3fc940474b3", nil)
	for pager.More() {
		...
		// page = armresiliencemanagement.DrillRunResourcesClientListResponse{
		// 	DrillRunResourceListResult: armresiliencemanagement.DrillRunResourceListResult{
		// 		Value: []*armresiliencemanagement.DrillRunResource{
		// 			{
