...
func ExampleWhatIfResultsAtSubscriptionClient_NewListPager() {
	...
	pager := clientFactory.NewWhatIfResultsAtSubscriptionClient().NewListPager(nil)
	for pager.More() {
		...
		// page = armdeploymentstacks.WhatIfResultsAtSubscriptionClientListResponse{
		...
		// 							{
		// 								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Authorization/policyAssignments/myPolicyAssignment"),
		...
		// 							},
		// 							{
		// 								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Authorization/policyAssignments/thirdPolicyAssignment"),
		// 								ManagementStatusChange: &armdeploymentstacks.ChangeBaseDeploymentStacksManagementStatus{
