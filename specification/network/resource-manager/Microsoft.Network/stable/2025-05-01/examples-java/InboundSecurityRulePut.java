...
public final class Main {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/InboundSecurityRulePut.json
     */
    /**
    ...
    public static void
        ...
        azure.networks().manager().serviceClient().getInboundSecurityRuleOperations()
            .createOrUpdate("rg1", "nva", "rule1",
                new InboundSecurityRuleInner().withRuleType(InboundSecurityRuleType.PERMANENT)
                    .withRules(Arrays.asList(new InboundSecurityRules().withName("inboundRule1")
                        .withProtocol(InboundSecurityRulesProtocol.TCP).withSourceAddressPrefix("50.20.121.5/32")
                        .withDestinationPortRange(22).withDestinationPortRanges(Arrays.asList("80-100"))
