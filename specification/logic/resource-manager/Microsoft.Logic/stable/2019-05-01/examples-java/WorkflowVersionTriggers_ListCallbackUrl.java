...
public final class Main {
    ...
    public static void
        ...
        manager.workflowVersionTriggers().listCallbackUrlWithResponse("testResourceGroup", "testWorkflowName",
            "testWorkflowVersionId", "testTriggerName", new GetCallbackUrlParameters()
                .withNotAfter(OffsetDateTime.parse("2017-03-05T08:00:00Z")).withKeyType(KeyType.PRIMARY),
