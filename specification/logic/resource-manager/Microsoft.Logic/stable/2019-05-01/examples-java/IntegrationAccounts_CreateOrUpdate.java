...
public final class Main {
    ...
    public static void createOrUpdateAnIntegrationAccount(com.azure.resourcemanager.logic.LogicManager manager) {
        manager.integrationAccounts().define("testIntegrationAccount").withRegion("westus")
            .withExistingResourceGroup("testResourceGroup")
            .withSku(new IntegrationAccountSku().withName(IntegrationAccountSkuName.STANDARD)).create();
    }
}
