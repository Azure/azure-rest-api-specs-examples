...
// Generated from example definition: 2026-06-01/VaultCRUD/GetBackupVaultWithCostManagementSettings.json
func ExampleBackupVaultsClient_Get_getBackupVaultWithCostManagementSettings() {
