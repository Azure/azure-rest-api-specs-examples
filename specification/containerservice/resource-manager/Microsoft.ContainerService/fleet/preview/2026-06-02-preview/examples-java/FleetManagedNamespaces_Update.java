...
public final class Main {
    ...
    public static void fleetManagedNamespacesUpdate(
        ...
        resource.update().withTags(mapOf("tag2", "tagValue2"))
            .withProperties(new FleetManagedNamespacePropertiesPatch()
                .withPropagationPolicy(new PropagationPolicyPatch().withPlacementProfile(new PlacementProfilePatch()
                    .withDefaultClusterResourcePlacement(new ClusterResourcePlacementSpecPatch().withRolloutStrategy(
                        new RolloutStrategy().withType(RolloutStrategyType.EXTERNAL).withClusterUpdateStrategy(
                            new ClusterUpdateStrategyReference().withName("my-staged-update-strategy")))))))
            .apply();
    }
