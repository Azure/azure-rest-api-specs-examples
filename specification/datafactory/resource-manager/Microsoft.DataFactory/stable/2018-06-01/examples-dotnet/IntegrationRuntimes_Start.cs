...
ArmOperation<IntegrationRuntimeStatusResult> lro = await factoryIntegrationRuntime.StartAsync(WaitUntil.Completed);
IntegrationRuntimeStatusResult result = lro.Value;
