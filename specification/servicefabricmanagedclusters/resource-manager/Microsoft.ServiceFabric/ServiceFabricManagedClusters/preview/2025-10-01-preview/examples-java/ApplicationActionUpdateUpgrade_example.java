...
public final class Main {
    ...
    public static void updateAnApplicationUpgrade(
        ...
        manager.applications().updateUpgrade("resRg", "myCluster", "myApp",
            new RuntimeUpdateApplicationUpgradeParameters().withName("fabric:/Voting")
                ...
                .withApplicationHealthPolicy(new RuntimeApplicationHealthPolicy().withConsiderWarningAsError(true)
                    ...
                    .withDefaultServiceTypeHealthPolicy(new RuntimeServiceTypeHealthPolicy()
                        .withMaxPercentUnhealthyServices(12).withMaxPercentUnhealthyPartitionsPerService(10)
                ...
                .withUpdateDescription(new RuntimeRollingUpgradeUpdateMonitoringPolicy()
                    .withRollingUpgradeMode(RuntimeRollingUpgradeMode.MONITORED).withForceRestart(true)
                    ...
                    .withHealthCheckRetryTimeoutInMilliseconds("PT0H15M0S").withUpgradeTimeoutInMilliseconds("PT2H0M0S")
