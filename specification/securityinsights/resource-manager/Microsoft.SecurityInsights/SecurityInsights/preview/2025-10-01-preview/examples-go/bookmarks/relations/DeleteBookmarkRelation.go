...
func ExampleBookmarkRelationsClient_Delete() {
	...
	res, err := clientFactory.NewBookmarkRelationsClient().Delete(ctx, "myRg", "myWorkspace", "2216d0e1-91e3-4902-89fd-d2df8c535096", "4bb36b7b-26ff-4d1c-9cbe-0d8ab3da0014", nil)
	if err != nil {
	...
	// res = armsecurityinsights.BookmarkRelationsClientDeleteResponse{
	// }
}
