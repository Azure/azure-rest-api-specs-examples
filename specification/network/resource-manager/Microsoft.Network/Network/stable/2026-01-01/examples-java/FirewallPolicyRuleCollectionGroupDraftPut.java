...
public final class Main {
     ...
     */
    public static void
        createOrUpdateRuleCollectionGroupDraft(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getFirewallPolicyRuleCollectionGroupDrafts().createOrUpdateWithResponse("rg1",
            ...
            new FirewallPolicyRuleCollectionGroupDraftInner().withPriority(100)
                .withRuleCollections(Arrays.asList(new FirewallPolicyFilterRuleCollection()
                    ...
                    .withRules(Arrays.asList(new NetworkRule().withName("network-rule1")
                        ...
                        .withDestinationPorts(Arrays.asList("*")).withSourceGeoLocations(Arrays.asList("CA", "US"))
