...
# USAGE
    python create_a_database_as_a_georestore_in_geopaired_location.py
...
# x-ms-original-file: specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2022-03-08-preview/examples/ServerCreateGeoRestore.json
