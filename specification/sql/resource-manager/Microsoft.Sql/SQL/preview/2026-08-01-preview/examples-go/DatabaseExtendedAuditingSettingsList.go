...
// Generated from example definition: 2026-08-01-preview/DatabaseExtendedAuditingSettingsList.json
func ExampleExtendedDatabaseBlobAuditingPoliciesClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.ExtendedDatabaseBlobAuditingPoliciesClientListByDatabaseResponse{
		// 	ExtendedDatabaseBlobAuditingPolicyListResult: armsql.ExtendedDatabaseBlobAuditingPolicyListResult{
