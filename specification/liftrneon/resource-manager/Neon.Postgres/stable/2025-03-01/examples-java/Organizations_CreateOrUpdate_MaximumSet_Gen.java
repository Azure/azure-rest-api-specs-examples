...
public final class Main {
    ...
    public static void
        ...
        manager.organizations().define("test-org").withRegion("kcdph").withExistingResourceGroup("rgneon")
            .withTags(
                mapOf("key8832", "fakeTokenPlaceholder"))
            .withProperties(new OrganizationProperties().withMarketplaceDetails(new MarketplaceDetails()
                .withSubscriptionId("xfahbbbzwlcwhhjbxarnwfcy")
                ...
                .withOfferDetails(new OfferDetails().withPublisherId("eibghzuyqsksouwlgqphhmuxeqeigf")
                    .withOfferId("qscggwfdnippiwrrnmuscg").withPlanId("sveqoxtdwxutxmtniuufyrdu").withPlanName("t")
                    .withTermUnit("jnxhyql").withTermId("uptombvymytfonj")))
                .withUserDetails(new UserDetails().withFirstName("zhelh").withLastName("zbdhouyeozylnerrc")
                    .withEmailAddress("test@contoso.com").withUpn("mixcikvxlnhkfugetqlngz")
                    .withPhoneNumber("zmejenytglrmjnt"))
                .withCompanyDetails(
                    new CompanyDetails().withCompanyName("xtul").withCountry("ycmyjdcpyjieemfrthfyxdlvn")
                        .withOfficeAddress("icirtoqmmozijk").withBusinessPhone("hucxvzcvpaupqjkgb")
                        .withDomain("snoshqumfsthyofpnrsgyjhszvgtj").withNumberOfEmployees(12L))
                .withPartnerOrganizationProperties(new PartnerOrganizationProperties()
                    .withOrganizationId("hzejhmftwsruhwspvtwoy").withOrganizationName("entity-name")
                    .withSingleSignOnProperties(new SingleSignOnProperties()
                        .withSingleSignOnState(SingleSignOnStates.INITIAL).withEnterpriseAppId("urtjzjfr")
                        .withSingleSignOnUrl("gcmlwvtxcsjozitm").withAadDomains(Arrays.asList("mdzbelaiphukhe"))))
