...
public final class Main {
    ...
    public static void createBasicV2ApplicationGateway(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getApplicationGateways().createOrUpdate("rg1", "appgw", new ApplicationGatewayInner()
            ...
            .withReservedCapacity(3).withGlobalConfiguration(new ApplicationGatewayGlobalConfiguration()
                .withEnableRequestBuffering(true).withEnableResponseBuffering(true)),
