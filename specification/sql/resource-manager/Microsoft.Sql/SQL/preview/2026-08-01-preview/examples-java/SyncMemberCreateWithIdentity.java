...
public final class Main {
    ...
    public static void
        ...
        manager.serviceClient().getSyncMembers().createOrUpdate("syncgroupcrud-65440", "syncgroupcrud-8475",
            ...
            new SyncMemberInner().withIdentity(new DataSyncParticipantIdentity()
                ...
                .withDatabaseName("syncgroupcrud-7421").withSyncDirection(SyncDirection.BIDIRECTIONAL),
