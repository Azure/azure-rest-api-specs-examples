...
public final class Main {
    /*
     * x-ms-original-file: 2026-04-01/restorePointExamples/RestorePointCollection_CreateOrUpdate.json
     */
    /**
     ...
     */
    public static void createOrUpdateARestorePointCollection(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getRestorePointCollections().createOrUpdateWithResponse("myResourceGroup", "myRpc",
