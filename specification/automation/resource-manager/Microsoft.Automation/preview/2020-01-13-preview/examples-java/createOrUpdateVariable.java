...
public final class Main {
    ...
    public static void createOrUpdateAVariable(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.variables().define("sampleVariable").withExistingAutomationAccount("rg", "sampleAccount9")
            .withName("sampleVariable").withValue("\"ComputerName.domain.com\"").withDescription("my description")
            .withIsEncrypted(false).create();
    }
}
