...
// Generated from example definition: 2024-04-01/transfersList.json
func ExampleTransfersClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armbilling.TransfersClientListResponse{
		// 	TransferDetailsListResult: armbilling.TransferDetailsListResult{
