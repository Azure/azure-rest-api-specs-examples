...
func ExampleEndpointsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewEndpointsClient().BeginCreateOrUpdate(ctx, "rgopenapi", "TestMyEnclave", "TestMyEnclaveEndpoint", armenclave.EndpointResource{
	...
	// res = armenclave.EndpointsClientCreateOrUpdateResponse{
