...
public final class Main {
    ...
    public static void labsCreateOrUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.labs().define("{labName}").withRegion("{location}").withExistingResourceGroup("resourceGroupName")
            .withTags(mapOf("tagName1", "tagValue1")).withLabStorageType(StorageType.fromString("{Standard|Premium}"))
            .create();
    }
