...
public final class Main {
     ...
     */
    public static void updateSecurityPartnerProviderTags(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getSecurityPartnerProviders().updateTagsWithResponse("rg1", "securityPartnerProvider",
