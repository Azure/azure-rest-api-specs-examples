...
public final class Main {
    ...
    public static void connectedRegistryUpdateManagedIdentity(
        ...
        manager.serviceClient().getConnectedRegistries().update("myResourceGroup", "myRegistry", "myConnectedRegistry",
            new ConnectedRegistryUpdateParameters().withIdentity(new ManagedServiceIdentity()
                ...
                .withSyncProperties(
                    new SyncUpdateProperties().withSchedule("0 0 */10 * *").withSyncWindow(Duration.parse("P2D"))
                        .withMessageTtl(Duration.parse("P30D")).withAuthType(AuthType.MANAGED_IDENTITY))
                .withLogging(
