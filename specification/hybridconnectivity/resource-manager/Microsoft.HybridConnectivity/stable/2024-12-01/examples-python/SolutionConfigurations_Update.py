...
# USAGE
    python solution_configurations_update.py
...
def main():
    ...
    response = client.solution_configurations.update(
        resource_uri="ymuj",
        solution_configuration="dxt",
        properties={"properties": {"solutionSettings": {}, "solutionType": "myzljlstvmgkp"}},
    )
    print(response)
