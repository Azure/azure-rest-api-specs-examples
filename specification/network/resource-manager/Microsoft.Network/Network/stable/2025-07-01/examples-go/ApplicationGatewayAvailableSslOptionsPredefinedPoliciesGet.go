...
func ExampleApplicationGatewaysClient_NewListAvailableSSLPredefinedPoliciesPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.ApplicationGatewaysClientListAvailableSSLPredefinedPoliciesResponse{
		// 	ApplicationGatewayAvailableSSLPredefinedPolicies: armnetwork.ApplicationGatewayAvailableSSLPredefinedPolicies{
		// 		Value: []*armnetwork.ApplicationGatewaySSLPredefinedPolicy{
		// 			{
		// 				Name: to.Ptr("AppGwSslPolicy20150501"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default/ApplicationGatewaySslPredefinedPolicy/AppGwSslPolicy20150501"),
