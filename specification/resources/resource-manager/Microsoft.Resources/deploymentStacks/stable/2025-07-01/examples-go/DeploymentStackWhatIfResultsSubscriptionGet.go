...
func ExampleWhatIfResultsAtSubscriptionClient_Get() {
	...
	res, err := clientFactory.NewWhatIfResultsAtSubscriptionClient().Get(ctx, "simpleDeploymentStackWhatIfResult", nil)
	if err != nil {
