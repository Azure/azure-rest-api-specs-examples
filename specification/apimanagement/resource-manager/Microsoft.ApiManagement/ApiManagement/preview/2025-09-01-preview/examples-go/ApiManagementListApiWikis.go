...
// Generated from example definition: 2025-09-01-preview/ApiManagementListApiWikis.json
func ExampleAPIWikisClient_NewListPager() {
	...
	pager := clientFactory.NewAPIWikisClient().NewListPager("rg1", "apimService1", "57d1f7558aa04f15146d9d8a", nil)
	for pager.More() {
		...
		// page = armapimanagement.APIWikisClientListResponse{
