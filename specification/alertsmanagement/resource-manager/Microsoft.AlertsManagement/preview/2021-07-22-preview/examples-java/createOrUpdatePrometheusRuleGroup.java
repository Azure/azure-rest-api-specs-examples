...
public final class Main {
    ...
    public static void
        ...
        manager.prometheusRuleGroups().define("myPrometheusRuleGroup").withRegion("East US")
            ...
            .withRules(Arrays.asList(
                new PrometheusRule().withRecord("job_type:billing_jobs_duration_seconds:99p5m").withExpression(
                    "histogram_quantile(0.99, sum(rate(jobs_duration_seconds_bucket{service=\"billing-processing\"}[5m])) by (job_type))")
                    .withLabels(mapOf("team", "prod")),
                new PrometheusRule().withAlert("Billing_Processing_Very_Slow")
                    .withExpression("job_type:billing_jobs_duration_seconds:99p5m > 30").withSeverity(2)
                    .withForProperty("PT5M").withLabels(mapOf("team", "prod"))
            ...
            .withDescription("This is the description of the first rule group").create();
    }
