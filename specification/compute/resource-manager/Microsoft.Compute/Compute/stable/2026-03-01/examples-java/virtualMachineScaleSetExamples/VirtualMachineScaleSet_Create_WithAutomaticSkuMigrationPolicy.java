...
import com.azure.resourcemanager.compute.models.AutomaticSkuMigrationPolicy;
...
public final class Main {
    /*
     * x-ms-original-file:
     * 2026-03-01/virtualMachineScaleSetExamples/VirtualMachineScaleSet_Create_WithAutomaticSkuMigrationPolicy.json
     */
    /**
     * Sample code: Create a scale set with automatic SKU migration policy.
     * 
     * @param manager Entry point to ComputeManager.
     */
    public static void
        createAScaleSetWithAutomaticSKUMigrationPolicy(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getVirtualMachineScaleSets().createOrUpdate("myResourceGroup", "{vmss-name}",
            new VirtualMachineScaleSetInner().withLocation("westus")
                ...
                .withSkuProfile(new SkuProfile()
                    ...
                    .withAutomaticSkuMigrationPolicy(new AutomaticSkuMigrationPolicy().withEnabled(true))),
