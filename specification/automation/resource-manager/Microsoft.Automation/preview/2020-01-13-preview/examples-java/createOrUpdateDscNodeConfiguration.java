...
public final class Main {
    ...
    public static void createNodeConfiguration(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.dscNodeConfigurations().define("configName.nodeConfigName")
            .withExistingAutomationAccount("rg", "myAutomationAccount20").withName("configName.nodeConfigName")
            ...
            .withIncrementNodeConfigurationBuild(true).create();
    }
}
