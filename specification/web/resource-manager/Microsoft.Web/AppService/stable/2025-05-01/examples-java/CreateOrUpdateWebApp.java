...
public final class Main {
     ...
     */
    public static void createOrUpdateWebApp(com.azure.resourcemanager.appservice.AppServiceManager manager) {
        manager.serviceClient().getWebApps().createOrUpdate("testrg123", "sitef6141",
