...
// Generated from example definition: 2025-09-01-preview/ApiManagementListContentTypes.json
func ExampleContentTypeClient_NewListByServicePager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.ContentTypeClientListByServiceResponse{
		// 	ContentTypeCollection: armapimanagement.ContentTypeCollection{
