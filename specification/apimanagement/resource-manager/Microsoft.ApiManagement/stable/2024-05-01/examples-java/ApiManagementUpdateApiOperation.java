...
public final class Main {
    ...
    public static void
        ...
        OperationContract resource = manager.apiOperations()
            ...
            .getValue();
        resource.update().withDisplayName("Retrieve resource").withMethod("GET").withUrlTemplate("/resource")
            ...
            .withRequest(new RequestContract().withQueryParameters(Arrays.asList(new ParameterContract()
                ...
                .withType("string").withDefaultValue("sample").withRequired(true).withValues(Arrays.asList("sample")))))
