...
public final class Main {
    ...
    public static void createACredential(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.credentials().define("myCredential").withExistingAutomationAccount("rg", "myAutomationAccount18")
            .withName("myCredential").withUsername("mylingaiah").withPassword("<password>")
            .withDescription("my description goes here").create();
    }
}
