...
public final class Main {
    ...
    public static void createServiceGateway(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.networks().manager().serviceClient().getServiceGateways().createOrUpdate("rg1", "sg",
            new ServiceGatewayInner().withLocation("eastus").withVirtualNetwork(new VirtualNetworkInner().withId(
