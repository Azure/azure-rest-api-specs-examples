...
public final class Main {
    ...
    public static void diagnosticsCreateOrUpdateMaximumSet(
        ...
        manager.diagnostics().define("testname").withRegion("ouwfvnokjvivmjzqpupwrbsmls")
            .withExistingResourceGroup("rgconfigurationmanager").withTags(mapOf("key4304", "fakeTokenPlaceholder"))
            .withProperties(new DiagnosticProperties()).withExtendedLocation(
