...
public final class Main {
    ...
    public static void iotHubResourceCreateOrUpdate(com.azure.resourcemanager.iothub.IotHubManager manager) {
        manager.iotHubResources().define("testHub").withRegion("centraluseuap")
            ...
            .withSku(
                new IotHubSkuInfo().withName(IotHubSku.S1).withCapacity(1L))
            .withTags(
                mapOf())
            .withProperties(new IotHubProperties().withIpFilterRules(Arrays.asList())
                ...
                .withRouting(new RoutingProperties().withEndpoints(new RoutingEndpoints()
                    .withServiceBusQueues(Arrays.asList()).withServiceBusTopics(Arrays.asList())
                    .withEventHubs(Arrays.asList()).withStorageContainers(Arrays.asList())
                ...
                .withCloudToDevice(new CloudToDeviceProperties().withMaxDeliveryCount(10)
                    ...
                    .withFeedback(new FeedbackProperties().withLockDurationAsIso8601(Duration.parse("PT1M"))
                        .withTtlAsIso8601(Duration.parse("PT1H")).withMaxDeliveryCount(10)))
                .withFeatures(Capabilities.NONE).withEnableDataResidency(true)
                .withRootCertificate(new RootCertificateProperties().withEnableRootCertificateV2(true))
                .withIpVersion(IpVersion.IPV4IPV6))
            .withEtag("AAAAAAFD6M4=").withIdentity(new ArmIdentity().withType(ResourceIdentityType.SYSTEM_ASSIGNED))
            .create();
    }
