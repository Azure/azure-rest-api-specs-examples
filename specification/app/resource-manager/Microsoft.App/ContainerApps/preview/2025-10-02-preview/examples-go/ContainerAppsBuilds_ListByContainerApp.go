...
// Generated from example definition: 2025-10-02-preview/ContainerAppsBuilds_ListByContainerApp.json
func ExampleContainerAppsBuildsByContainerAppClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.ContainerAppsBuildsByContainerAppClientListResponse{
		// 	ContainerAppsBuildCollection: armappcontainers.ContainerAppsBuildCollection{
