...
public final class Main {
    ...
    public static void createAHybridWorkerGroup(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.hybridRunbookWorkerGroups().define("TestHybridGroup").withExistingAutomationAccount("rg", "testaccount")
            .withCredential(new RunAsCredentialAssociationProperty().withName("myRunAsCredentialName")).create();
    }
}
