...
// Generated from example definition: 2025-07-01/NetworkManagerSecurityUserRuleCollectionPut.json
func ExampleSecurityUserRuleCollectionsClient_CreateOrUpdate() {
	...
	// res = armnetwork.SecurityUserRuleCollectionsClientCreateOrUpdateResponse{
	// 	SecurityUserRuleCollection: armnetwork.SecurityUserRuleCollection{
	// 		Name: to.Ptr("myTestSecurityConfig"),
	// 		Type: to.Ptr("Microsoft.Network/networkManagers/securityUserConfigurations/ruleCollections"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkManager/testNetworkManager/securityUserConfigurations/myTestSecurityConfig/ruleCollections/testRuleCollection"),
	// 		Properties: &armnetwork.SecurityUserRuleCollectionPropertiesFormat{
	// 			Description: to.Ptr("A sample policy"),
	// 			AppliesToGroups: []*armnetwork.SecurityUserGroupItem{
	// 				{
