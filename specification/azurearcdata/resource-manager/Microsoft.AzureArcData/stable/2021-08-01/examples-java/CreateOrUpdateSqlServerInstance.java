    ...
    public static void
        ...
        manager.sqlServerInstances().define("testsqlServerInstance").withRegion("northeurope")
            ...
            .withProperties(new SqlServerInstanceProperties().withVersion(SqlVersion.SQL_SERVER_2017)
                .withEdition(EditionType.DEVELOPER).withContainerResourceId("Arc Machine Name").withVCore("4")
                .withStatus(ConnectionStatus.CONNECTED).withPatchLevel("patchlevel").withCollation("collation")
                .withCurrentVersion("2008 R2").withInstanceName("name of instance").withTcpDynamicPorts("1433")
                .withTcpStaticPorts("1433").withProductId("sql id").withLicenseType(ArcSqlServerLicenseType.FREE)
