...
// Generated from example definition: 2025-09-01-preview/ApiManagementListApiDiagnostics.json
func ExampleAPIDiagnosticClient_NewListByServicePager() {
	...
	pager := clientFactory.NewAPIDiagnosticClient().NewListByServicePager("rg1", "apimService1", "echo-api", nil)
	for pager.More() {
		...
		// page = armapimanagement.APIDiagnosticClientListByServiceResponse{
