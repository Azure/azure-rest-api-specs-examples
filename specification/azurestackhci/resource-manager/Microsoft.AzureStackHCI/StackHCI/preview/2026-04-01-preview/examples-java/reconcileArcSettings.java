...
public final class Main {
    ...
    public static void reconcileArcSettings(com.azure.resourcemanager.azurestackhci.AzureStackHciManager manager) {
        manager.arcSettings().reconcile("test-rg", "myCluster", "default", new ReconcileArcSettingsRequest()
            .withProperties(new ReconcileArcSettingsRequestProperties().withClusterNodes(
                Arrays.asList("/subscriptions/sub1/resourceGroup/res1/providers/Microsoft.HybridCompute/machines/m1",
