...
# USAGE
    python private_endpoint_connection_operations_update_maximum_set_gen.py
...
def main():
    ...
    response = client.private_endpoint_connection_operations.begin_update(
        ...
        resource={
            "properties": {
                "privateEndpoint": {},
                "privateLinkServiceConnectionState": {"actionsRequired": "", "description": None, "status": "Approved"},
            }
        },
    ).result()
    print(response)
