...
public final class Main {
    ...
    public static void
        ...
        manager.accessPolicies().define("ap1").withExistingEnvironment("rg1", "env1").withPrincipalObjectId("aGuid")
            .withDescription("some description").withRoles(Arrays.asList(AccessPolicyRole.READER)).create();
    }
}
