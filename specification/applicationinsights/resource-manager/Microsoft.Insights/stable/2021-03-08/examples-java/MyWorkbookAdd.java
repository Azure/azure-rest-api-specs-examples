...
public final class Main {
    ...
    public static void workbookAdd(com.azure.resourcemanager.applicationinsights.ApplicationInsightsManager manager) {
        manager.myWorkbooks().define("deadb33f-8bee-4d3b-a059-9be8dac93960").withRegion("west us")
            .withExistingResourceGroup("my-resource-group").withName("deadb33f-8bee-4d3b-a059-9be8dac93960")
            .withKind(Kind.USER).withDisplayName("Blah Blah Blah")
            .withSerializedData(
