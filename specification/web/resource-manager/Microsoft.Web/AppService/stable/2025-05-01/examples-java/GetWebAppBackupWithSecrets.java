...
public final class Main {
     ...
     */
    public static void getWebAppBackupWithSecrets(com.azure.resourcemanager.appservice.AppServiceManager manager) {
        manager.serviceClient().getWebApps().listBackupStatusSecretsWithResponse("testrg123", "sitef6141", "12345",
