...
public final class Main {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/VirtualNetworkUpdateTags.json
     */
    /**
    ...
    public static void updateVirtualNetworkTags(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.networks().manager().serviceClient().getVirtualNetworks().updateTagsWithResponse("rg1", "test-vnet",
