...
public final class Main {
    ...
    public static void
        ...
        manager.namespaces().define("adr-namespace-gbk0925-n01").withRegion("North Europe")
            .withExistingResourceGroup("myResourceGroup")
            .withProperties(
                new NamespaceProperties().withMessaging(new Messaging().withEndpoints(mapOf("iothubEndpoint",
                    new MessagingEndpoint().withEndpointType("Microsoft.Devices/IotHubs")
                        .withAddress("https://iothub-for-dps.azure-devices.net"),
                    "anotherIothubEndpoint", new MessagingEndpoint().withEndpointType("Microsoft.Devices/IotHubs")
