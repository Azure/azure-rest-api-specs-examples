...
// Generated from example definition: 2024-04-01/invoicesDownloadSummaryByBillingAccount.json
func ExampleInvoicesClient_BeginDownloadSummaryByBillingAccount() {
	...
	// res = armbilling.InvoicesClientDownloadSummaryByBillingAccountResponse{
