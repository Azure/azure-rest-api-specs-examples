...
func ExampleEventSubscriptionsClient_NewListByDomainTopicPager() {
	...
	pager := clientFactory.NewEventSubscriptionsClient().NewListByDomainTopicPager("examplerg", "domain1", "topic1", nil)
	for pager.More() {
		...
		// page = armeventgrid.EventSubscriptionsClientListByDomainTopicResponse{
