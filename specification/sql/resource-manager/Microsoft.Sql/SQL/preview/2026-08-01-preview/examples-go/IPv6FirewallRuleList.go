...
// Generated from example definition: 2026-08-01-preview/IPv6FirewallRuleList.json
func ExampleIPv6FirewallRulesClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armsql.IPv6FirewallRulesClientListByServerResponse{
		// 	IPv6FirewallRuleListResult: armsql.IPv6FirewallRuleListResult{
