...
# USAGE
    python kusto_pools_check_name_availability.py
...
def main():
    ...
    response = client.kusto_pools.check_name_availability(
        location="westus",
        kusto_pool_name={"name": "kustoclusterrptest4", "type": "Microsoft.Synapse/workspaces/kustoPools"},
    )
    print(response)
