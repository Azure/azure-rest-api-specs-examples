...
# USAGE
    python private_link_resource_operations_list_by_assessment_project_maximum_set_gen.py
...
def main():
    ...
    response = client.private_link_resource_operations.list_by_assessment_project(
