...
public final class Main {
    ...
    public static void
        ...
        manager.metadatas().define("metadataName").withExistingWorkspace("myRg", "myWorkspace")
            ...
            .withDependencies(new MetadataDependencies().withOperator(MetadataDependencyOperator.AND)
                .withCriteria(Arrays.asList(
                    new MetadataDependencies().withOperator(MetadataDependencyOperator.OR)
                        .withCriteria(Arrays.asList(
