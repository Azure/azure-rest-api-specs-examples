...
// Generated from example definition: 2019-01-01-preview/RegulatoryCompliance/getRegulatoryComplianceAssessment_example.json
func ExampleRegulatoryComplianceAssessmentsClient_Get() {
	...
	// res = armsecurity.RegulatoryComplianceAssessmentsClientGetResponse{
	// 	RegulatoryComplianceAssessment: armsecurity.RegulatoryComplianceAssessment{
