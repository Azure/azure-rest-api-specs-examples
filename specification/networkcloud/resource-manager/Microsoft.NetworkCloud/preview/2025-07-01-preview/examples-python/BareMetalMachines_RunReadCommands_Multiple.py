...
# USAGE
    python bare_metal_machines_run_read_commands_multiple.py
...
# x-ms-original-file: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2025-07-01-preview/examples/BareMetalMachines_RunReadCommands_Multiple.json
