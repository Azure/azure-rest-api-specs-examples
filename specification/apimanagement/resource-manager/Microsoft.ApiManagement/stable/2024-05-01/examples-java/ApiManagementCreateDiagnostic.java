...
public final class Main {
    ...
    public static void
        ...
        manager.diagnostics().createOrUpdateWithResponse("rg1", "apimService1", "applicationinsights",
            new DiagnosticContractInner().withAlwaysLog(AlwaysLog.ALL_ERRORS).withLoggerId("/loggers/azuremonitor")
