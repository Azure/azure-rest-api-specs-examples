...
// Generated from example definition: 2025-03-01/OperationList.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armcostmanagement.OperationsClientListResponse{
		// 	OperationListResult: armcostmanagement.OperationListResult{
