...
// Generated from example definition: 2025-06-01/BatchAccountListOutboundNetworkDependenciesEndpoints.json
func ExampleAccountClient_NewListOutboundNetworkDependenciesEndpointsPager() {
	...
	for pager.More() {
		...
		// page = armbatch.AccountClientListOutboundNetworkDependenciesEndpointsResponse{
		// 	OutboundEnvironmentEndpointCollection: armbatch.OutboundEnvironmentEndpointCollection{
		...
		// 				Endpoints: []*armbatch.EndpointDependency{
		// 					{
		// 						Description: to.Ptr("Only applicable to pools containing a Mount Configuration. Learn about Mount Configurations in Batch at https://learn.microsoft.com/azure/batch/virtual-file-mount."),
		...
		// 				Endpoints: []*armbatch.EndpointDependency{
		// 					{
		// 						Description: to.Ptr("Only applicable to pools containing a Disk Encryption Configuration and whose VM size does not support encryption at host. Learn more about disk encryption in Azure Batch at https://learn.microsoft.com/azure/batch/disk-encryption. Learn more about encryption at host and supported VM sizes at https://learn.microsoft.com/azure/virtual-machines/disks-enable-host-based-encryption-portal."),
