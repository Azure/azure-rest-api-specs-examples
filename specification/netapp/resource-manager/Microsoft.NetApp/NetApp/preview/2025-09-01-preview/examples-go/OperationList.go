...
// Generated from example definition: 2025-09-01-preview/OperationList.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armnetapp.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armnetapp.OperationsClientListResponse{
		// 	OperationListResult: armnetapp.OperationListResult{
