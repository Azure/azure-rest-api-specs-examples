        ...
        resource.update()
            .withProperties(new ExternalAuthProperties()
                ...
                .withClients(Arrays.asList(new ExternalAuthClientProfile()
                    ...
                    .withClientId("vobxtzobefgl").withExtraScopes(Arrays.asList("ejmvezdxvoozyiickteiqnvpxqciep"))
                    .withType(ExternalAuthClientType.CONFIDENTIAL)))
                .withClaim(new ExternalAuthClaimProfile()
                    .withMappings(new TokenClaimMappingsProfile().withUsername(new UsernameClaimProfile().withClaim(
                        ...
                        .withGroups(new GroupClaimProfile()
                            .withClaim("yrqawnseinzjlcevwxetagxeqkxoepjoctyrvddrfozociinj").withPrefix("ajnojzalbh")))
                    .withValidationRules(Arrays.asList(new TokenClaimValidationRule()
                        .withType(TokenValidationRuleType.REQUIRED_CLAIM).withRequiredClaim(new TokenRequiredClaim()
                            .withClaim("ciapdmvrnfitudpx").withRequiredValue("mqzzjiozgxfgflhdrnwawpke"))))))
            .apply();
    }
}
