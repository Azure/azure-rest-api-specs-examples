...
// Generated from example definition: 2022-01-01/Alerts/GetAlertsResourceGroupLocation_example.json
func ExampleAlertsClient_NewListResourceGroupLevelByRegionPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AlertsClientListResourceGroupLevelByRegionResponse{
		// 	AlertList: armsecurity.AlertList{
