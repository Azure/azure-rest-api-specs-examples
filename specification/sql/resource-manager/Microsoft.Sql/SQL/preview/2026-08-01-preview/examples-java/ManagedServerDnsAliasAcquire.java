...
public final class Main {
    /*
     * x-ms-original-file: 2026-08-01-preview/ManagedServerDnsAliasAcquire.json
     */
    /**
    ...
    public static void acquireManagedServerDNSAlias(com.azure.resourcemanager.sql.SqlServerManager manager) {
        manager.serviceClient().getManagedServerDnsAliases().acquire("Default", "new-mi", "dns-alias-mi",
