...
public final class Main {
     ...
     */
    public static void updateServiceEndpointPolicyTags(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getServiceEndpointPolicies().updateTagsWithResponse("rg1", "testServiceEndpointPolicy",
