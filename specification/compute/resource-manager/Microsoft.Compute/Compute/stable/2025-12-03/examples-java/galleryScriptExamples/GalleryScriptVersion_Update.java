...
public final class Main {
     ...
     */
    public static void updateASimpleGalleryScriptVersion(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getGalleryScriptVersions().update("myResourceGroupName", "myGalleryName",
