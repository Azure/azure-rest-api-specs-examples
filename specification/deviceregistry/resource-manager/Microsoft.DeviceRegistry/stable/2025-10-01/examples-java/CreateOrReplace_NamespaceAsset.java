...
public final class Main {
    ...
    public static void
        ...
        manager.namespaceAssets().define("my-asset-1").withRegion("West Europe")
            ...
            .withProperties(new NamespaceAssetProperties().withEnabled(true).withExternalAssetId("8ZBA6LRHU0A458969")
                ...
                .withAssetTypeRefs(Arrays.asList("myAssetTypeRef1", "myAssetTypeRef2")).withManufacturer("Contoso")
                .withManufacturerUri("https://www.contoso.com/manufacturerUri").withModel("ContosoModel")
                .withProductCode("fakeTokenPlaceholder").withHardwareRevision("1.0").withSoftwareRevision("2.0")
                .withDocumentationUri("https://www.example.com/manual").withSerialNumber("64-103816-519918-8")
                ...
                .withDefaultStreamsDestinations(Arrays.asList(new StreamMqttDestination()
                    .withConfiguration(new MqttDestinationConfiguration().withTopic("/contoso/test")
                        .withRetain(TopicRetainType.NEVER).withQos(MqttDestinationQos.QOS0).withTtl(3600L))))
                .withDatasets(Arrays.asList(new NamespaceDataset().withName("dataset1")
                    .withDataSource("nsu=http://microsoft.com/Opc/OpcPlc/Oven;i=5").withTypeRef("dataset1TypeRef")
                        ...
                        new NamespaceEvent().withName("event1")
                            ...
                            .withDestinations(Arrays.asList(new EventMqttDestination()
                                .withConfiguration(new MqttDestinationConfiguration().withTopic("/contoso/testEvent1")
                                    .withRetain(TopicRetainType.KEEP).withQos(MqttDestinationQos.QOS0).withTtl(7200L))))
                    ...
                    new NamespaceStream().withName("stream2")
                        ...
                        .withDestinations(Arrays.asList(new StreamMqttDestination()
                            .withConfiguration(new MqttDestinationConfiguration().withTopic("/contoso/testStream2")
                                .withRetain(TopicRetainType.NEVER).withQos(MqttDestinationQos.QOS0).withTtl(7200L))))))
                    ...
                    Arrays
                        .asList(
                            new ManagementGroup().withName("managementGroup1")
                                ...
                                .withTypeRef("managementGroup1TypeRef").withDefaultTopic("/contoso/managementGroup1")
                                .withDefaultTimeoutInSeconds(100).withActions(
                                    Arrays
                                        .asList(
                                            new ManagementAction().withName("action1")
                                                ...
                                                .withActionType(ManagementActionType.CALL).withTimeoutInSeconds(60),
