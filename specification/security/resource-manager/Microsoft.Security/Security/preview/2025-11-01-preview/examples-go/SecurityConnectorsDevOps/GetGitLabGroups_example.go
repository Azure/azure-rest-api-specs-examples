...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/GetGitLabGroups_example.json
func ExampleGitLabGroupsClient_Get() {
	...
	// res = armsecurity.GitLabGroupsClientGetResponse{
	// 	GitLabGroup: armsecurity.GitLabGroup{
