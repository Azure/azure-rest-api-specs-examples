...
func ExampleDrillRunResourcesClient_Get() {
	...
	res, err := clientFactory.NewDrillRunResourcesClient().Get(ctx, "sampleServiceGroupName", "drill1", "ca92602e-53bf-43d2-ae62-d3fc940474b3", "56f942da-a30e-43c0-b5f0-1c22e44f2d94", nil)
	if err != nil {
	...
	// res = armresiliencemanagement.DrillRunResourcesClientGetResponse{
	// 	DrillRunResource: armresiliencemanagement.DrillRunResource{
	// 		Properties: &armresiliencemanagement.DrillRunResourceProperties{
	...
	// 			},
	// 			JobID: to.Ptr("/providers/Microsoft.AzureResilienceManagement/drills/drill1/drillRuns/ca92602e-53bf-43d2-ae62-d3fc940474b3"),
	// 			TaskID: to.Ptr("sampleTaskId"),
	// 			TaskName: to.Ptr("sampleTaskName"),
	// 			JobResourceType: to.Ptr(armresiliencemanagement.JobResourceTypeDrillRun),
	// 			UserComments: []*armresiliencemanagement.JobUserComment{
	// 				{
	// 					CommentType: to.Ptr(armresiliencemanagement.CommentTypeDescription),
	...
	// 			},
	// 		},
	// 		ID: to.Ptr("/providers/Microsoft.Management/serviceGroups/sampleServiceGroupName/providers/Microsoft.AzureResilienceManagement/drills/drill1/drillRuns/ca92602e-53bf-43d2-ae62-d3fc940474b3/drillRunResources/56f942da-a30e-43c0-b5f0-1c22e44f2d94"),
	// 		Name: to.Ptr("56f942da-a30e-43c0-b5f0-1c22e44f2d94"),
	// 		Type: to.Ptr("Microsoft.AzureResilienceManagement/drills/drillRuns/drillRunResources"),
