...
public final class Main {
    ...
    public static void createOrUpdateWorkspaceDataVersionBase(
        ...
        manager.dataVersions().define("string").withExistingData("test-rg", "my-aml-workspace", "string")
            .withProperties(new UriFileDataVersion().withDescription("string").withTags(mapOf("string", "string"))
                .withProperties(mapOf("string", "string")).withIsAnonymous(false).withDataUri("string"))
            .create();
    }
