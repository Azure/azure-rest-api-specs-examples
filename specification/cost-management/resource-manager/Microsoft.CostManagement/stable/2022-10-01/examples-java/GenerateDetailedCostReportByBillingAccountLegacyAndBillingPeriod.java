...
public final class Main {
    ...
    public static void generateDetailedCostReportByBillingAccountLegacyAndBillingPeriod(
        ...
        manager.generateDetailedCostReports().createOperation(
            "providers/Microsoft.Billing/billingAccounts/12345", new GenerateDetailedCostReportDefinition()
                .withMetric(GenerateDetailedCostReportMetricType.ACTUAL_COST).withBillingPeriod("202008"),
