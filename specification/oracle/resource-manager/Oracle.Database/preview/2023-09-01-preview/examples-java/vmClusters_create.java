    ...
    public static void createVMCluster(com.azure.resourcemanager.oracledatabase.OracleDatabaseManager manager) {
        manager.cloudVmClusters().define("cluster1").withRegion("eastus").withExistingResourceGroup("rg000")
            ...
            .withProperties(new CloudVmClusterProperties().withDataStorageSizeInTbs(1000.0D)
                .withDbNodeStorageSizeInGbs(1000).withMemorySizeInGbs(1000).withTimeZone("UTC")
                .withHostname("hostname1").withDomain("domain1").withCpuCoreCount(2).withOcpuCount(3.0F)
                ...
                .withNsgCidrs(Arrays.asList(new NsgCidr().withSource("10.0.0.0/16").withDestinationPortRange(
                    new PortRange().withMin(1520).withMax(1522)), new NsgCidr().withSource("10.10.0.0/24")))
                ...
                .withDisplayName("cluster 1").withDbServers(Arrays.asList("ocid1..aaaa")))
            .create();
    }
