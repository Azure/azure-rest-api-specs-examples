...
public final class Main {
    ...
    public static void createOrUpdateAnAccountAssembly(com.azure.resourcemanager.logic.LogicManager manager)
        throws IOException {
        manager.integrationAccountAssemblies().define("testAssembly").withRegion("westus")
            ...
            .withProperties(new AssemblyProperties()
                ...
                .withContent("Base64 encoded Assembly Content").withAssemblyName("System.IdentityModel.Tokens.Jwt"))
            .create();
    }
}
