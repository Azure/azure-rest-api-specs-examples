...
public final class Main {
    ...
    public static void createAnUpdateRunGeneratedByMaximumSetRule(
        ...
        manager.updateRuns().define("fleet1").withExistingFleet("rgfleets", "fleet1").withUpdateStrategyId(
            ...
            .withIfMatch("wyolpuaxgybeygcbz").withIfNoneMatch("rwrhonlormgshamadufoo").create();
    }
}
