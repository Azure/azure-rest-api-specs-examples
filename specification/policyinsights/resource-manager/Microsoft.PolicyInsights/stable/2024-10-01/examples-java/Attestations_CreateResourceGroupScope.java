...
public final class Main {
    ...
    public static void createAttestationAtResourceGroupScope(
        ...
        manager.attestations().define("790996e6-9871-4b1f-9cd9-ec42cd6ced1e").withExistingResourceGroup("myRg")
            ...
            .withComplianceState(ComplianceState.COMPLIANT).withExpiresOn(OffsetDateTime.parse("2021-06-15T00:00:00Z"))
