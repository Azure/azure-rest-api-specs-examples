...
PostgreSqlFlexibleServerNameAvailabilityResult result = await FlexibleServersExtensions.CheckPostgreSqlFlexibleServerNameAvailabilityAsync(subscriptionResource, content);
