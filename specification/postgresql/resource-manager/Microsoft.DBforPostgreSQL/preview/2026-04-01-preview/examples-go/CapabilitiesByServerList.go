...
// Generated from example definition: 2026-04-01-preview/CapabilitiesByServerList.json
func ExampleCapabilitiesByServerClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armpostgresqlflexibleservers.CapabilitiesByServerClientListResponse{
