...
public final class Main {
    ...
    public static void organizationsCreateOrUpdateGeneratedByMaximumSetRule(
        ...
        manager.organizations().define("test-organization-1").withRegion("gigxuxdonjfmqnljxcgctfwqapllu")
            .withExistingResourceGroup("rgopenapi").withTags(mapOf())
            .withProperties(
                new OrganizationProperties()
                    .withMarketplace(new MarketplaceDetails().withSubscriptionId("meaowktoejxwfqomc")
                        .withOfferDetails(new OfferDetails().withPublisherId("flrya").withOfferId("hwhtxmtmmlwsu")
                            .withPlanId("jozklohkdpng").withPlanName("clnynwt")
                            .withTermUnit("cbfktammjyqewljjjaokakilog").withTermId("iugvvvoggusxuz")))
                    .withUser(new UserDetails().withFirstName("aorfffgdmglvzdvfvdyjohtnblzsfw").withLastName("tojbqzk")
                        .withEmailAddress("btables@arize.com").withUpn("xzvwwbjpqakqqyfudyp")
                    ...
                    .withSingleSignOnProperties(new SingleSignOnPropertiesV2().withType(SingleSignOnType.SAML)
                        .withState(SingleSignOnStates.INITIAL).withEnterpriseAppId("kqykskeuqffsslmpjryzggphhpeh")
                        .withUrl("ihidsswbeahnsjjxxqntz").withAadDomains(Arrays.asList("tyjdvljasl"))))
