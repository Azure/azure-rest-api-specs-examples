...
async function updateAVMByDetachingDataDisk() {
  ...
  const result = await client.virtualMachines.update("myResourceGroup", "myVM", {
    ...
    storageProfile: {
      ...
      dataDisks: [
        { diskSizeGB: 1023, createOption: "Empty", lun: 0, toBeDetached: true },
        { diskSizeGB: 1023, createOption: "Empty", lun: 1, toBeDetached: false },
      ],
    },
    osProfile: {
