...
NullableResponse<FarmBeatResource> response = await collection.GetIfExistsAsync(farmBeatsResourceName);
FarmBeatResource result = response.HasValue ? response.Value : null;
