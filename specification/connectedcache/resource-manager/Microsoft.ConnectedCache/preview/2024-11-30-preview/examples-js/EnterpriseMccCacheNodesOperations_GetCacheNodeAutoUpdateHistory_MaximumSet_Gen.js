 ...
 */
async function enterpriseMccCacheNodesOperationsGetCacheNodeAutoUpdateHistoryMaximumSet() {
  const credential = new DefaultAzureCredential();
  const subscriptionId = "12345678-1234-1234-1234-123456789098";
  const client = new ConnectedCacheClient(credential, subscriptionId);
  const result = await client.enterpriseMccCacheNodesOperations.getCacheNodeAutoUpdateHistory(
    "rgConnectedCache",
    "MccRPTest1",
    "MCCCachenode1",
  );
