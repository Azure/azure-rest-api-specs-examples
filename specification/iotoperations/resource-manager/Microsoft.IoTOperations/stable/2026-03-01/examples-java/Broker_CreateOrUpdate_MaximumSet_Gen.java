                ...
                new BrokerProperties()
                    ...
                    .withDiagnostics(new BrokerDiagnostics()
                        ...
                        .withTraces(new Traces().withMode(OperationalMode.ENABLED).withCacheSizeMegabytes(28)
                            .withSelfTracing(new SelfTracing().withMode(OperationalMode.ENABLED)
                                .withIntervalSeconds(22))
                            .withSpanChannelCapacity(1000)))
                    .withDiskBackedMessageBuffer(
                        new DiskBackedMessageBuffer().withMaxSize("500M")
