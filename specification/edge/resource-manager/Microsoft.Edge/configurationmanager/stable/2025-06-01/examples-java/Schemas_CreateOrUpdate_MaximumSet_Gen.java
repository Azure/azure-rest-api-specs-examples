...
public final class Main {
    ...
    public static void schemasCreateOrUpdateMaximumSet(
        ...
        manager.schemas().define("testname").withRegion("alvi").withExistingResourceGroup("rgconfigurationmanager")
            .withTags(mapOf("key7017", "fakeTokenPlaceholder")).withProperties(new SchemaProperties()).create();
    }
