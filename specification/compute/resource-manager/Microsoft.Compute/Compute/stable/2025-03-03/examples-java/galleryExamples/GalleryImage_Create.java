...
public final class Main {
     ...
     */
    public static void createOrUpdateASimpleGalleryImage(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getGalleryImages().createOrUpdate(
