...
public final class Main {
    ...
    public static void executionsUpdateMaximumSetGeneratedByMaximumSetRule(
        ...
        Execution resource = manager.executions().getWithResponse("rgconfigurationmanager", "abcde", "abcde", "abcde",
            "abcde", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(
            new ExecutionProperties().withWorkflowVersionId("xjsxzbfltzvbuvn").withSpecification(mapOf())).apply();
    }
