...
public final class Main {
    ...
    public static void updatesTheSpecifiedDataLakeStoreAccountInformation(
        ...
        resource.update().withTags(mapOf("test_key", "fakeTokenPlaceholder")).withDefaultGroup("test_default_group")
            ...
            .withTrustedIdProviderState(TrustedIdProviderState.ENABLED).withNewTier(TierType.CONSUMPTION).apply();
    }
