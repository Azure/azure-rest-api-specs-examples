...
public final class Main {
    ...
    public static void virtualNetworkGatewayNatRulePut(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVirtualNetworkGatewayNatRules().createOrUpdate("rg1", "gateway1", "natRule1",
            new VirtualNetworkGatewayNatRuleInner().withTypePropertiesType(VpnNatRuleType.STATIC)
