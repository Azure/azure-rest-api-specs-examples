...
// Generated from example definition: 2024-04-05/getGuestConfigurationAssignmentReportById.json
func ExampleAssignmentReportsClient_Get() {
	...
	// res = armguestconfiguration.AssignmentReportsClientGetResponse{
