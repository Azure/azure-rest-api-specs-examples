...
func ExampleManagedInstanceOperationsClient_NewListByManagedInstancePager() {
	...
	for pager.More() {
		...
		// 								Status: to.Ptr(armsql.UpsertManagedServerOperationStepWithEstimatesAndDurationStatusCompleted),
		// 								StepEndTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-06T11:22:47.35Z"); return t}()),
		// 								StepStartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-06T11:08:46.15Z"); return t}()),
		...
		// 								StepEndTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-06T11:24:50.51Z"); return t}()),
		// 								StepStartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-06T11:22:47.42Z"); return t}()),
		...
		// 								StepEndTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-04T09:01:00.57Z"); return t}()),
		// 								StepStartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-04T09:00:30.15Z"); return t}()),
		// 								TimeElapsed: to.Ptr("0"),
		// 							},
		// 						},
		// 						TotalSteps: to.Ptr("1"),
		// 					},
		// 					PercentComplete: to.Ptr[int32](100),
		// 					StartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-12-04T09:00:08.1Z"); return t}()),
		// 					State: to.Ptr(armsql.ManagementOperationStateFailed),
		// 				},
		// 			},
		// 		},
