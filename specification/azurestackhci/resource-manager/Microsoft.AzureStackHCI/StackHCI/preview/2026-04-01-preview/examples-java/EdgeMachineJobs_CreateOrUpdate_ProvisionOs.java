...
public final class Main {
    ...
    public static void
        ...
        manager.edgeMachineJobs().define("ProvisionOs").withExistingEdgeMachine("ArcInstance-rg", "machine1")
            .withProperties(
                new ProvisionOsJobProperties().withDeploymentMode(DeploymentMode.DEPLOY)
                    .withProvisioningRequest(new ProvisioningRequest().withTarget(ProvisioningOsType.AZURE_LINUX)
                        .withOsProfile(new OsProvisionProfile().withOsName("AzureLinux").withOsType("AzureLinux")
                            .withOsVersion("3.0").withOsImageLocation("https://aka.ms/aep/azlinux3.0")
                            .withVsrVersion("1.0.0")
                            .withImageHash("sha256:a1b2c3d4e5f6789012345678901234567890abcdef1234567890abcdef123456")
                            .withGpgPubKey("fakeTokenPlaceholder").withOperationType(OSOperationType.PROVISION))
