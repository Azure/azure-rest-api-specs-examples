...
public final class Main {
    ...
    public static void topQueryStatisticsListByServer(com.azure.resourcemanager.mariadb.MariaDBManager manager) {
        manager.topQueryStatistics().listByServer("testResourceGroupName", "testServerName",
            new TopQueryStatisticsInput().withNumberOfTopQueries(5).withAggregationFunction("avg")
