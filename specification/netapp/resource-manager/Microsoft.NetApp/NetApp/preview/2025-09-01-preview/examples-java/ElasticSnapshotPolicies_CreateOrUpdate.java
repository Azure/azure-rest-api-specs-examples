...
public final class Main {
    ...
    public static void
        ...
        manager.elasticSnapshotPolicies().define("snapshotPolicyName").withRegion("eastus")
            ...
            .withProperties(new ElasticSnapshotPolicyProperties()
                ...
                .withWeeklySchedule(new ElasticSnapshotPolicyWeeklySchedule().withSnapshotsToKeep(3)
                    .withDays(Arrays.asList(DayOfWeek.WEDNESDAY)).withHour(14).withMinute(45))
                .withMonthlySchedule(new ElasticSnapshotPolicyMonthlySchedule().withSnapshotsToKeep(5)
                    .withDaysOfMonth(Arrays.asList(10, 11, 12)).withHour(14).withMinute(15))
