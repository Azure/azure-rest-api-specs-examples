...
/**
 * This sample demonstrates how to Lists the admin credentials of a provisioned cluster instance used only in direct mode.
 *
 * @summary Lists the admin credentials of a provisioned cluster instance used only in direct mode.
