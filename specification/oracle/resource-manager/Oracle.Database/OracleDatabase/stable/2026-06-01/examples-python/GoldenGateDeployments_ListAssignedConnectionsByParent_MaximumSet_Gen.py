...
# USAGE
    python golden_gate_deployments_list_assigned_connections_by_parent_maximum_set_gen.py
...
def main():
    ...
    response = client.golden_gate_deployments.list_assigned_connections_by_parent(
