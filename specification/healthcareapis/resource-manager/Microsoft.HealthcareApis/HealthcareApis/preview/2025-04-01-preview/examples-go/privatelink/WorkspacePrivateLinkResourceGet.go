...
// Generated from example definition: 2025-04-01-preview/privatelink/WorkspacePrivateLinkResourceGet.json
func ExampleWorkspacePrivateLinkResourcesClient_Get() {
	...
	// res = armhealthcareapis.WorkspacePrivateLinkResourcesClientGetResponse{
