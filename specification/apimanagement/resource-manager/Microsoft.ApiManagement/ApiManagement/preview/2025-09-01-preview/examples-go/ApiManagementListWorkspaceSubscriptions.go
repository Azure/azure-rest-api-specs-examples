...
// Generated from example definition: 2025-09-01-preview/ApiManagementListWorkspaceSubscriptions.json
func ExampleWorkspaceSubscriptionClient_NewListPager() {
	...
	pager := clientFactory.NewWorkspaceSubscriptionClient().NewListPager("rg1", "apimService1", "wks1", nil)
	for pager.More() {
		...
		// page = armapimanagement.WorkspaceSubscriptionClientListResponse{
		...
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/subscriptions/5600b59475ff190048070001"),
		...
		// 					Scope: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/products/5600b59475ff190048060001"),
		...
		// 				Type: to.Ptr("Microsoft.ApiManagement/service/workspaces/subscriptions"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/subscriptions/56eaed3dbaf08b06e46d27fe"),
		// 				Properties: &armapimanagement.SubscriptionContractProperties{
		...
		// 				Type: to.Ptr("Microsoft.ApiManagement/service/workspaces/subscriptions"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/subscriptions/5931a769d8d14f0ad8ce13b8"),
		// 				Properties: &armapimanagement.SubscriptionContractProperties{
