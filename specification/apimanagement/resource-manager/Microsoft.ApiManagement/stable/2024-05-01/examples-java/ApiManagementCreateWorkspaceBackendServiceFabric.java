...
public final class Main {
    ...
    public static void apiManagementCreateWorkspaceBackendServiceFabric(
        ...
        manager.workspaceBackends().createOrUpdateWithResponse("rg1", "apimService1", "wks1", "sfbackend",
            new BackendContractInner().withUrl("fabric:/mytestapp/mytestservice").withProtocol(BackendProtocol.HTTP)
