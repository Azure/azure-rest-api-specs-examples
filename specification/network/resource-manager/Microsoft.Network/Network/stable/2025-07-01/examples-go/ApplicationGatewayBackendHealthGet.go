...
func ExampleApplicationGatewaysClient_BeginBackendHealth() {
	...
	poller, err := clientFactory.NewApplicationGatewaysClient().BeginBackendHealth(ctx, "appgw", "appgw", nil)
	if err != nil {
	...
	// res = armnetwork.ApplicationGatewaysClientBackendHealthResponse{
	// 	ApplicationGatewayBackendHealth: armnetwork.ApplicationGatewayBackendHealth{
	...
	// 			{
	// 				BackendAddressPool: &armnetwork.ApplicationGatewayBackendAddressPool{
	// 					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/backendaddressPools/MFPool"),
	// 				},
	// 				BackendHTTPSettingsCollection: []*armnetwork.ApplicationGatewayBackendHealthHTTPSettings{
	// 					{
	// 						BackendHTTPSettings: &armnetwork.ApplicationGatewayBackendHTTPSettings{
