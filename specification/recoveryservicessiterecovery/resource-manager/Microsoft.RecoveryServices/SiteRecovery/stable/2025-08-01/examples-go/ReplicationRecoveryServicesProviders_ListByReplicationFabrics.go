...
// Generated from example definition: 2025-08-01/ReplicationRecoveryServicesProviders_ListByReplicationFabrics.json
func ExampleReplicationRecoveryServicesProvidersClient_NewListByReplicationFabricsPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.ReplicationRecoveryServicesProvidersClientListByReplicationFabricsResponse{
		// 	RecoveryServicesProviderCollection: armrecoveryservicessiterecovery.RecoveryServicesProviderCollection{
