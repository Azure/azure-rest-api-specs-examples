...
public final class Main {
    ...
    public static void
        ...
        manager.newRegionFrontloadReleases().createOrUpdateWithResponse("Microsoft.Contoso", "2020week10",
            new FrontloadPayload().withProperties(new FrontloadPayloadProperties().withOperationType("Rollout")
                .withProviderNamespace("Microsoft.Contoso").withFrontloadLocation("Israel Central")
                .withCopyFromLocation("eastus").withEnvironmentType(AvailableCheckInManifestEnvironment.PROD)
                .withServiceFeatureFlag(ServiceFeatureFlagAction.DO_NOT_CREATE)
                .withIncludeResourceTypes(Arrays.asList("servers")).withExcludeResourceTypes(Arrays.asList("monitors"))
