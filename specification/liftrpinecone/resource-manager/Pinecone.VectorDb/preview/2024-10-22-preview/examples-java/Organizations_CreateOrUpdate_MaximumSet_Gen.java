...
public final class Main {
    ...
    public static void organizationsCreateOrUpdateMaximumSet(
        ...
        manager.organizations().define("example-organization-name").withRegion("us-east")
            .withExistingResourceGroup("rgopenapi").withTags(mapOf("my-tag", "tag.value"))
            .withProperties(new OrganizationProperties()
                .withMarketplace(new MarketplaceDetails().withSubscriptionId("76a38ef6-c8c1-4f0d-bfe0-00ec782c8077")
                    .withOfferDetails(new OfferDetails().withPublisherId("4d194daf-fa20-46a8-bfb4-5b7d96cae009")
                        ...
                        .withPlanId("62dda065-5acd-4ac5-b418-8610beed92a2").withPlanName("Freemium").withTermUnit("der")
                        .withTermId("a2b7ce01-f06d-4874-9f77-6ea4a4875c16")))
                .withUser(new UserDetails().withFirstName("Jimmy").withLastName("McExample")
                    .withEmailAddress("example.user@example.com").withUpn("example.user@example.com")
                ...
                .withSingleSignOnProperties(new SingleSignOnPropertiesV2().withType(SingleSignOnType.SAML)
                    .withState(SingleSignOnStates.INITIAL).withEnterpriseAppId("44d3fb26-d8d5-41ff-9b9a-769737f22f13")
