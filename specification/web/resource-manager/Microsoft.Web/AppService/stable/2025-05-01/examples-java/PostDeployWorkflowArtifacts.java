...
public final class Main {
     ...
     */
    public static void deploysWorkflowArtifacts(com.azure.resourcemanager.appservice.AppServiceManager manager)
        throws IOException {
        manager.serviceClient().getWebApps().deployWorkflowArtifactsWithResponse("testrg123", "testsite2",
