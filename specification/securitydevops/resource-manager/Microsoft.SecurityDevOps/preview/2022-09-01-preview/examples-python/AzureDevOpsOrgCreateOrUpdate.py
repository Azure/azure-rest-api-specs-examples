...
# USAGE
    python azure_dev_ops_org_create_or_update.py
...
def main():
    ...
    response = client.azure_dev_ops_org.begin_create_or_update(
        resource_group_name="westusrg",
        azure_dev_ops_connector_name="testconnector",
        azure_dev_ops_org_name="myOrg",
        azure_dev_ops_org={"properties": {"autoDiscovery": "Disabled"}},
    ).result()
    print(response)
