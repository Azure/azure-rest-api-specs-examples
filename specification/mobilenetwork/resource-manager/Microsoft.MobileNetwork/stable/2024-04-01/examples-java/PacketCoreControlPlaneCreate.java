...
public final class Main {
    ...
    public static void
        ...
        manager.packetCoreControlPlanes().define("TestPacketCoreCP").withRegion("eastus")
            ...
            .withSignaling(new SignalingConfiguration()
                .withNasReroute(new NasRerouteConfiguration().withMacroMmeGroupId(1024)).withNasEncryption(Arrays
                    .asList(NasEncryptionType.NEA2_EEA2, NasEncryptionType.NEA1_EEA1, NasEncryptionType.NEA0_EEA0)))
            .create();
    }
}
