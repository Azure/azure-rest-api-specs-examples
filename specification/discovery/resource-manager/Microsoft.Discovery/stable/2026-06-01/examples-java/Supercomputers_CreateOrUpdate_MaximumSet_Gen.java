...
public final class Main {
    ...
    public static void
        ...
        manager.supercomputers().define("4320c0c5e73e420d6c").withRegion("uksouth")
            .withExistingResourceGroup("rgdiscovery").withTags(mapOf("key5117", "fakeTokenPlaceholder"))
            .withProperties(new SupercomputerProperties().withSubnetId(
                ...
                .withOutboundType(NetworkEgressType.LOAD_BALANCER).withSystemSku(SystemSku.STANDARD_D4S_V6)
