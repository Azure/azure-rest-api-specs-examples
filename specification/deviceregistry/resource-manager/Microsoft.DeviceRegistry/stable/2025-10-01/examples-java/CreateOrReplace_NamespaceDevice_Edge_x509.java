        ...
        manager.namespaceDevices().define("namespace-device-on-edge").withRegion("West Europe")
            ...
            .withProperties(new NamespaceDeviceProperties().withEnabled(true)
                ...
                .withEndpoints(new MessagingEndpoints().withInbound(mapOf("theV1OPCUAEndpoint", new InboundEndpoints()
                    .withEndpointType("microsoft.opcua").withAddress("opc.tcp://192.168.86.23:51211/UA/SampleServer")
                    .withVersion("2")
                    .withAuthentication(new HostAuthentication().withMethod(AuthenticationMethod.CERTIFICATE)
                        .withX509Credentials(new X509CertificateCredentials()
                            .withCertificateSecretName("fakeTokenPlaceholder").withKeySecretName("fakeTokenPlaceholder")
                    ...
                    new InboundEndpoints().withEndpointType("microsoft.opcua")
                        ...
                        .withAuthentication(
                            new HostAuthentication().withMethod(AuthenticationMethod.CERTIFICATE).withX509Credentials(
                                new X509CertificateCredentials().withCertificateSecretName("fakeTokenPlaceholder")))
