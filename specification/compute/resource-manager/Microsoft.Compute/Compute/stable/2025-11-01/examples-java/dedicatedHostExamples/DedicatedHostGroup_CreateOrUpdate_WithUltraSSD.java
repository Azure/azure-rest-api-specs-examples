...
public final class Main {
     ...
     */
    public static void
        createOrUpdateADedicatedHostGroupWithUltraSSDSupport(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getDedicatedHostGroups().createOrUpdateWithResponse("myResourceGroup",
