...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListAvailableGitHubOwners_example.json
func ExampleGitHubOwnersClient_ListAvailable() {
	...
	// res = armsecurity.GitHubOwnersClientListAvailableResponse{
	// 	GitHubOwnerListResponse: armsecurity.GitHubOwnerListResponse{
