...
public final class Main {
    ...
    public static void createAStreamingJobShellAStreamingJobWithNoInputsOutputsTransformationOrFunctions(
        ...
        manager.streamingJobs().define("sj59").withRegion("West US").withExistingResourceGroup("sjrg6936")
            ...
            .withSku(new Sku().withName(SkuName.STANDARD)).withEventsOutOfOrderPolicy(EventsOutOfOrderPolicy.DROP)
            .withOutputErrorPolicy(OutputErrorPolicy.DROP).withEventsOutOfOrderMaxDelayInSeconds(5)
            .withEventsLateArrivalMaxDelayInSeconds(16).withDataLocale("en-US")
