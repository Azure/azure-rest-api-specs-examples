...
// Generated from example definition: 2025-06-01/ElasticVersions_List.json
func ExampleVersionsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armelastic.VersionsClientListResponse{
		// 	VersionsListResponse: armelastic.VersionsListResponse{
