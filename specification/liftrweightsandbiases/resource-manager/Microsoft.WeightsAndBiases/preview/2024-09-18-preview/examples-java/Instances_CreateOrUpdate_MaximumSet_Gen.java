...
public final class Main {
    ...
    public static void instancesCreateOrUpdateGeneratedByMaximumSetRule(
        ...
        manager.instances().define("myinstance").withRegion("pudewmshbcvbt").withExistingResourceGroup("rgopenapi")
            .withTags(mapOf())
            .withProperties(new InstanceProperties().withMarketplace(new MarketplaceDetails()
                .withSubscriptionId("00000000-0000-0000-0000-000000000000")
                .withOfferDetails(new OfferDetails().withPublisherId("kf").withOfferId("rfgoevxeke").withPlanId("ufopn")
                    .withPlanName("adysakgqlryufffz").withTermUnit("dgrkojow").withTermId("kklscqq")))
                .withUser(new UserDetails().withFirstName("kiiehcojcldrlndoid").withLastName("zhkvsfqvthwkfkvgxcruyud")
                    .withEmailAddress("user@outlook.com").withUpn("rmjpgqchpbw")
                ...
                .withSingleSignOnProperties(new SingleSignOnPropertiesV2().withType(SingleSignOnType.SAML)
                    .withState(SingleSignOnStates.INITIAL).withEnterpriseAppId("hkxtmpv").withUrl("iqlemoksqdygqyxpp")
