                ...
                new ElasticVolumeUpdateProperties()
                    .withExportPolicy(
                        new ElasticExportPolicy().withRules(Arrays.asList(new ElasticExportPolicyRule().withRuleIndex(1)
                            .withUnixAccessRule(ElasticUnixAccessRule.READ_ONLY).withNfsv3(ElasticNfsv3Access.ENABLED)
                            .withNfsv4(ElasticNfsv4Access.DISABLED).withAllowedClients(Arrays.asList("0.0.0.0/0"))
