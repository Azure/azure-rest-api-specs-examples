...
public final class Main {
    ...
    public static void appLinkMembersCreateOrUpdate(com.azure.resourcemanager.appnetwork.AppnetworkManager manager) {
        manager.appLinkMembers().define("member-01").withRegion("westus2")
            .withExistingAppLink("test_rg", "applink-test-01").withTags(mapOf("key2913", "fakeTokenPlaceholder"))
            .withProperties(new AppLinkMemberProperties().withClusterType(ClusterType.AKS)
                ...
                .withUpgradeProfile(
                    new UpgradeProfile().withMode(UpgradeMode.FULLY_MANAGED).withFullyManagedUpgradeProfile(
