...
// Generated from example definition: 2025-04-01-preview/workspaces/Workspaces_ListByResourceGroup.json
func ExampleWorkspacesClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armhealthcareapis.WorkspacesClientListByResourceGroupResponse{
		// 	WorkspaceList: armhealthcareapis.WorkspaceList{
