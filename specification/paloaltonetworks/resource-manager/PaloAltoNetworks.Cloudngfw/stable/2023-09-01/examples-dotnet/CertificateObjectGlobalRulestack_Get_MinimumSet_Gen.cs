...
string name = "armid1";
NullableResponse<GlobalRulestackCertificateObjectResource> response = await collection.GetIfExistsAsync(name);
GlobalRulestackCertificateObjectResource result = response.HasValue ? response.Value : null;
