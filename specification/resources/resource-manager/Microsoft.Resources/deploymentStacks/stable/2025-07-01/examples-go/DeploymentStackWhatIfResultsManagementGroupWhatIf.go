...
func ExampleWhatIfResultsAtManagementGroupClient_BeginWhatIf() {
	...
	poller, err := clientFactory.NewWhatIfResultsAtManagementGroupClient().BeginWhatIf(ctx, "myMg", "changedDeploymentStackWhatIfResult", nil)
	if err != nil {
	...
	// res = armdeploymentstacks.WhatIfResultsAtManagementGroupClientWhatIfResponse{
	// 	WhatIfResult: &armdeploymentstacks.WhatIfResult{
	// 		ID: to.Ptr("/providers/Microsoft.Management/managementGroups/myMg/providers/Microsoft.Resources/deploymentStacksWhatIfResults/changedDeploymentStackWhatIfResult"),
	...
	// 			DeploymentStackResourceID: to.Ptr("/providers/Microsoft.Management/managementGroups/myMg/providers/Microsoft.Resources/deploymentStacks/deploymentStack2"),
	...
	// 					{
	// 						ID: to.Ptr("/providers/Microsoft.Management/managementGroups/myMg/providers/Microsoft.Authorization/policyAssignments/anotherPolicyAssignment"),
	...
	// 					},
	// 					{
	// 						ID: to.Ptr("/providers/Microsoft.Management/managementGroups/myMg/providers/Microsoft.Authorization/policyAssignments/updatedPolicyAssignment"),
	// 						ManagementStatusChange: &armdeploymentstacks.ChangeBaseDeploymentStacksManagementStatus{
	...
	// 								"id": "/providers/Microsoft.Management/managementGroups/myManagementGroup/providers/Microsoft.Authorization/policyAssignments/updatedPolicyAssignment",
	// 								"type": "Microsoft.Authorization/policyAssignments",
	// 								"name": "updatedPolicyAssignment",
	// 								"location": "westus2",
	// 								"properties": map[string]any{
	// 									"policyDefinitionId": "/providers/Microsoft.Management/managementGroups/myManagementGroup/providers/Microsoft.Authorization/policyDefinitions/updatedPolicyDefinition",
