...
// Generated from example definition: 2025-09-01/GetApplicationGatewayWafDynamicManifests.json
func ExampleApplicationGatewayWafDynamicManifestsClient_NewGetPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.ApplicationGatewayWafDynamicManifestsClientGetResponse{
		// 	ApplicationGatewayWafDynamicManifestResultList: armnetwork.ApplicationGatewayWafDynamicManifestResultList{
