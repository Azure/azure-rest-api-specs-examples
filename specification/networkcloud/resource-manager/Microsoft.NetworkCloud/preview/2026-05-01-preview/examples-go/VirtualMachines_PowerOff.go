...
func ExampleVirtualMachinesClient_BeginPowerOff() {
	...
	poller, err := clientFactory.NewVirtualMachinesClient().BeginPowerOff(ctx, "resourceGroupName", "virtualMachineName", &armnetworkcloud.VirtualMachinesClientBeginPowerOffOptions{
		VirtualMachinePowerOffParameters: &armnetworkcloud.VirtualMachinePowerOffParameters{
