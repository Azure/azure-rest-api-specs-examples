...
// Generated from example definition: 2026-03-15-preview/Workspace/operationsList.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armmachinelearning.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armmachinelearning.OperationsClientListResponse{
		// 	OperationListResult: armmachinelearning.OperationListResult{
