...
public final class Main {
    ...
    public static void virtualEnclaveUpdate(com.azure.resourcemanager.enclave.AzureEnclaveManager manager) {
        EnclaveResource resource = manager.virtualEnclaves()
            .getByResourceGroupWithResponse("rgopenapi", "TestMyEnclave", com.azure.core.util.Context.NONE).getValue();
        resource
            .update().withTags(
                mapOf("Tag1", "Value1"))
            .withProperties(
                new VirtualEnclavePatchProperties()
                    ...
                    .withEnclaveRoleAssignments(Arrays.asList(new RoleAssignmentItem()
                    ...
                    .withMaintenanceModeConfiguration(new MaintenanceModeConfigurationPatchModel()
                        ...
                        .withPrincipals(Arrays
                            .asList(new Principal().withId("355a6bb0-abc0-4cba-000d-12a345b678c9")
                                .withType(PrincipalType.USER)))
                    ...
                    .withApprovalSettings(
                        new VirtualEnclaveApprovalSettingsPatchProperties()
                            ...
                            .withEnclaveMaintenanceMode(new ApprovalSettingConfiguration()
                                .withApprovalPolicy(ApprovalPolicy.REQUIRED).withMinimumApproversRequired(1)
                                .withMandatoryApprovers(Arrays.asList(new MandatoryApprover()
                                    .withApproverEntraId("00000000-0000-0000-0000-000000000003"))))))
            .apply();
    }
