...
public final class Main {
    ...
    public static void
        ...
        ArcDeployment resource = manager.arcDeployments()
            ...
            .getValue();
        resource.update().withProperties(new ArcDeploymentUpdateProperties().withReplicas(3)
            .withResources(new ArcDeploymentPatchKubernetesResources()
                .withRequests(new ArcDeploymentPatchCpuMemoryResourceRequirements().withCpu("500m").withMemory("2Gi"))
                .withLimits(new ArcDeploymentResourceRequirements().withCpu("4").withMemory("16Gi")))
            .withNodeSelector(mapOf("agentpool", "cpu"))).apply();
    }
