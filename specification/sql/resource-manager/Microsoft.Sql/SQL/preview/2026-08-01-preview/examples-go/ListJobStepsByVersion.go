...
// Generated from example definition: 2026-08-01-preview/ListJobStepsByVersion.json
func ExampleJobStepsClient_NewListByVersionPager() {
	...
	for pager.More() {
		...
		// page = armsql.JobStepsClientListByVersionResponse{
		// 	JobStepListResult: armsql.JobStepListResult{
