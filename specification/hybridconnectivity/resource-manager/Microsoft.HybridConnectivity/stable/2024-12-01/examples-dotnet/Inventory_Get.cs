...
// get the collection of this PublicCloudInventoryResource
PublicCloudInventoryCollection collection = publicCloudConnectorSolutionConfiguration.GetPublicCloudInventories();

// invoke the operation
string inventoryId = "xofprmcboosrbd";
NullableResponse<PublicCloudInventoryResource> response = await collection.GetIfExistsAsync(inventoryId);
PublicCloudInventoryResource result = response.HasValue ? response.Value : null;
