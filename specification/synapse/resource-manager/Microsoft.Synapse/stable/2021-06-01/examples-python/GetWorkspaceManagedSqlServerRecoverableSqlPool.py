...
# USAGE
    python get_workspace_managed_sql_server_recoverable_sql_pool.py
...
def main():
    ...
    response = client.workspace_managed_sql_server_recoverable_sql_pools.get(
        resource_group_name="wsg-7398",
        workspace_name="testWorkspace",
        sql_pool_name="recoverableSqlpools-1235",
    )
    print(response)
