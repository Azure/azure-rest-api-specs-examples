...
// Generated from example definition: 2025-06-01/VMCollection_Update.json
func ExampleVMCollectionClient_Update() {
	...
	res, err := clientFactory.NewVMCollectionClient().Update(ctx, "myResourceGroup", "myMonitor", nil)
	if err != nil {
	...
	// res = armelastic.VMCollectionClientUpdateResponse{
	// }
}
