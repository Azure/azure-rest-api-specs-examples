...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/CreateOrUpdateAzureDevOpsRepos_example.json
func ExampleAzureDevOpsReposClient_BeginCreateOrUpdate() {
	...
	// res = armsecurity.AzureDevOpsReposClientCreateOrUpdateResponse{
	// 	AzureDevOpsRepository: armsecurity.AzureDevOpsRepository{
