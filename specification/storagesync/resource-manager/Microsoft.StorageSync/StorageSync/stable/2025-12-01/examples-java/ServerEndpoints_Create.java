...
public final class Main {
    ...
    public static void serverEndpointsCreate(com.azure.resourcemanager.storagesync.StorageSyncManager manager) {
        manager.serverEndpoints().define("SampleServerEndpoint_1")
            .withExistingSyncGroup("SampleResourceGroup_1", "SampleStorageSyncService_1", "SampleSyncGroup_1")
            .withServerLocalPath("D:\\SampleServerEndpoint_1").withCloudTiering(FeatureStatus.OFF)
            .withVolumeFreeSpacePercent(100).withTierFilesOlderThanDays(0)
            ...
            .withOfflineDataTransfer(FeatureStatus.ON).withOfflineDataTransferShareName("myfileshare")
            ...
            .withInitialUploadPolicy(InitialUploadPolicy.SERVER_AUTHORITATIVE).create();
    }
}
