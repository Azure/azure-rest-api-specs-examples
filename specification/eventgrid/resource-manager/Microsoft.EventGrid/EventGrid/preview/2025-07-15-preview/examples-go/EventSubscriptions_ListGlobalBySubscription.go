...
func ExampleEventSubscriptionsClient_NewListGlobalBySubscriptionPager() {
	...
	pager := clientFactory.NewEventSubscriptionsClient().NewListGlobalBySubscriptionPager(nil)
	for pager.More() {
		...
		// page = armeventgrid.EventSubscriptionsClientListGlobalBySubscriptionResponse{
