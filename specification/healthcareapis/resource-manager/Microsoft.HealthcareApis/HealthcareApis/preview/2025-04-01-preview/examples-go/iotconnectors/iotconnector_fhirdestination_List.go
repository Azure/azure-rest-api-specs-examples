...
// Generated from example definition: 2025-04-01-preview/iotconnectors/iotconnector_fhirdestination_List.json
func ExampleFhirDestinationsClient_NewListByIotConnectorPager() {
	...
	for pager.More() {
		...
		// page = armhealthcareapis.FhirDestinationsClientListByIotConnectorResponse{
		// 	IotFhirDestinationCollection: armhealthcareapis.IotFhirDestinationCollection{
