...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/GetAzureDevOpsRepos_example.json
func ExampleAzureDevOpsReposClient_Get() {
	...
	// res = armsecurity.AzureDevOpsReposClientGetResponse{
