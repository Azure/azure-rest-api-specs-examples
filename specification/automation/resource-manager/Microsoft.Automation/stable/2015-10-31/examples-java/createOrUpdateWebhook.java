...
public final class Main {
    ...
    public static void createOrUpdateWebhook(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.webhooks().define("TestWebhook").withExistingAutomationAccount("rg", "myAutomationAccount33")
            .withName("TestWebhook").withIsEnabled(true).withUri("<uri>")
            .withExpiryTime(OffsetDateTime.parse("2018-03-29T22:18:13.7002872Z"))
            .withRunbook(new RunbookAssociationProperty().withName("TestRunbook")).create();
    }
}
