    ...
    public static void bucketsCreateOrUpdateWithAkv(com.azure.resourcemanager.netapp.NetAppFilesManager manager) {
        manager.buckets().define("bucket1").withExistingVolume("myRG", "account1", "pool1", "volume1").withPath("/path")
            ...
            .withAkvDetails(new AzureKeyVaultDetails()
                .withCertificateAkvDetails(new CertificateAkvDetails()
                    .withCertificateKeyVaultUri("fakeTokenPlaceholder").withCertificateName("my-certificate"))
                .withCredentialsAkvDetails(new CredentialsAkvDetails()
                    .withCredentialsKeyVaultUri("fakeTokenPlaceholder").withSecretName("fakeTokenPlaceholder")))
            .create();
    }
}
