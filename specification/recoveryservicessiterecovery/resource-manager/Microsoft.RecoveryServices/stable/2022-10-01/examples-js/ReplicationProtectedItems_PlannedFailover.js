 ...
 */
async function executePlannedFailover() {
  ...
  const result = await client.replicationProtectedItems.beginPlannedFailoverAndWait(
    resourceName,
    resourceGroupName,
    fabricName,
...
executePlannedFailover().catch(console.error);
