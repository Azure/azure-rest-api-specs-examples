...
public final class Main {
    ...
    public static void exadbVmClustersCreateOrUpdateMaximumSet(
        ...
        manager.exadbVmClusters().define("vmcluster1").withRegion("dsmvbplxdvesmvsgdvorgxalwpqxwt")
            .withExistingResourceGroup("rgopenapi").withTags(mapOf("key8577", "fakeTokenPlaceholder"))
            .withProperties(new ExadbVmClusterProperties().withClusterName("p").withBackupSubnetCidr("ca").withVnetId(
                ...
                .withDataCollectionOptions(new DataCollectionOptions().withIsDiagnosticsEventsEnabled(true)
                    .withIsHealthMonitoringEnabled(true).withIsIncidentLogsEnabled(true))
                .withDisplayName(
                ...
                .withDomain("akltvmctvumwfuqi").withEnabledEcpuCount(0)
                ...
                .withGridImageOcid("ocid1.autonomousdatabase.oc1..aaaaa3klq").withHostname("uwrzwwhrr")
                .withLicenseModel(LicenseModel.LICENSE_INCLUDED).withNodeCount(30)
                ...
                .withPrivateZoneOcid("ocid1.autonomousdatabase.oc1..aaaaa3klq").withScanListenerPortTcp(30)
                .withScanListenerPortTcpSsl(14).withShape("pzfyfjznebdsakeira")
                .withSshPublicKeys(Arrays.asList("wzzayf")).withSystemVersion("ssqzevdtjtcnxpdspcyqzgdtmonqjj")
                .withTimeZone(
            ...
            .withZones(Arrays.asList("ozwhowofqaq")).create();
    }
