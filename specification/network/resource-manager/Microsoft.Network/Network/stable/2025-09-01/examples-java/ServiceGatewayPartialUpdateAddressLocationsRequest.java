...
public final class Main {
    ...
    public static void partialUpdateCreateUpdateOrDeleteAddressLocationsInTheServiceGateway(
        ...
        manager.serviceClient().getServiceGateways().updateAddressLocationsWithResponse("rg1", "sg",
            new ServiceGatewayUpdateAddressLocationsRequest().withAction(UpdateAction.PARTIAL_UPDATE)
