...
public final class Main {
     ...
     */
    public static void updateVirtualNetworkGateway(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVirtualNetworkGateways().createOrUpdate("rg1", "vpngw",
            new VirtualNetworkGatewayInner().withLocation("centralus").withIdentity(new ManagedServiceIdentity()
                ...
                .withActive(false).withEnableHighBandwidthVpnGateway(false).withDisableIPSecReplayProtection(false)
