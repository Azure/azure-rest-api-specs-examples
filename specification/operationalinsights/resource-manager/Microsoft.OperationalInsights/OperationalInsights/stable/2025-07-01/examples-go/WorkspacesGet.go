...
func ExampleWorkspacesClient_Get() {
	...
	// res = armoperationalinsights.WorkspacesClientGetResponse{
	// 	Workspace: armoperationalinsights.Workspace{
	// 		Name: to.Ptr("oiautorest6685"),
	// 		Type: to.Ptr("Microsoft.OperationalInsights/workspaces"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/oiautorest6685/providers/microsoft.operationalinsights/workspaces/oiautorest6685"),
