...
// Generated from example definition: 2019-08-01/IoTSecuritySolutionsAnalytics/GetIoTSecuritySolutionsSecurityRecommendationList.json
func ExampleIotSecuritySolutionsAnalyticsRecommendationClient_NewListPager() {
	...
	pager := clientFactory.NewIotSecuritySolutionsAnalyticsRecommendationClient().NewListPager("IoTEdgeResources", "default", nil)
	for pager.More() {
		...
		// page = armsecurity.IotSecuritySolutionsAnalyticsRecommendationClientListResponse{
		// 	IoTSecurityAggregatedRecommendationList: armsecurity.IoTSecurityAggregatedRecommendationList{
		...
		// 			},
		// 			{
		// 				Name: to.Ptr("TooLargeIPRange"),
		// 				Type: to.Ptr("Microsoft.Security/iotSecuritySolutions/analyticsModels/aggregatedRecommendations"),
		// 				ID: to.Ptr("/subscriptions/075423e9-7d33-4166-8bdf-3920b04e3735/resourceGroups/IoTEdgeResources/providers/Microsoft.Security/iotSecuritySolutions/default/analyticsModels/default/aggregatedRecommendations/TooLargeIPRange"),
		// 				Properties: &armsecurity.IoTSecurityAggregatedRecommendationProperties{
