...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/UpdateAzureDevOpsProjects_example.json
func ExampleAzureDevOpsProjectsClient_BeginUpdate() {
	...
	// res = armsecurity.AzureDevOpsProjectsClientUpdateResponse{
