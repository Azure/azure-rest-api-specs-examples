...
# USAGE
    python attestations_create_resource_scope.py
...
def main():
    ...
    response = client.attestations.begin_create_or_update_at_resource(
...
# x-ms-original-file: 2024-10-01/Attestations_CreateResourceScope.json
