...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListGitLabSubgroups_example.json
func ExampleGitLabSubgroupsClient_List() {
	...
	// res = armsecurity.GitLabSubgroupsClientListResponse{
