...
public final class Main {
    ...
    public static void
        ...
        manager.workspaceGlobalSchemas().createOrUpdate("rg1", "apimService1", "wks1", "schema1",
            new GlobalSchemaContractInner().withSchemaType(SchemaType.XML).withDescription("sample schema description")
                .withValue(
