...
public final class Main {
    ...
    public static void subscriptionCreate(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.serviceBusNamespaces().manager().serviceClient().getSubscriptions().createOrUpdateWithResponse(
            "ResourceGroup", "sdk-Namespace-1349", "sdk-Topics-8740", "sdk-Subscriptions-2178",
            new SBSubscriptionInner().withEnableBatchedOperations(true), com.azure.core.util.Context.NONE);
    }
}
