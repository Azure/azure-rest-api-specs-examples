...
public final class Main {
    ...
    public static void createOrReplaceATimeSeriesDatabaseConnectionForADigitalTwinsInstanceWithUserAssignedIdentity(
        ...
        manager.timeSeriesDatabaseConnections().define("myConnection")
            ...
            .withProperties(new AzureDataExplorerConnectionProperties().withIdentity(
                ...
                .withAdxTableName("myTable").withEventHubEndpointUri("sb://myeh.servicebus.windows.net/")
                .withEventHubEntityPath("myeh").withEventHubNamespaceResourceId(
