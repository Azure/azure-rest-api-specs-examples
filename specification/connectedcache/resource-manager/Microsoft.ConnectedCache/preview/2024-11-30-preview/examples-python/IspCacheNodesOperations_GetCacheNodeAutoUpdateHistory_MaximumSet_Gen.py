...
# USAGE
    python isp_cache_nodes_operations_get_cache_node_auto_update_history_maximum_set_gen.py
...
def main():
    ...
    response = client.isp_cache_nodes_operations.get_cache_node_auto_update_history(
