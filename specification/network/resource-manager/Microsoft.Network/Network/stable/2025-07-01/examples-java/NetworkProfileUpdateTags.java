...
public final class Main {
     ...
     */
    public static void updateNetworkProfileTags(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getNetworkProfiles().updateTagsWithResponse("rg1", "test-np",
