 ...
 * x-ms-original-file: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/stable/2025-09-01/examples/DeleteRaiTopic.json
 */
async function deleteRaiTopic() {
  ...
  const result = await client.raiTopics.beginDeleteAndWait(
    resourceGroupName,
    accountName,
    raiTopicName,
  );
