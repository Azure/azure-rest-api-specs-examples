...
public final class Main {
    ...
    public static void saaSActivateResource(com.azure.resourcemanager.datadog.MicrosoftDatadogManager manager) {
        manager.saaSOperationGroups().activateResourceWithResponse(new ActivateSaaSParameterRequest()
            .withSaaSResourceId(
            ...
            .withUserInfo(
                new UserInfo().withName("Alice").withEmailAddress("alice@example.com").withPhoneNumber("+1234567890"))
