...
public final class Main {
    ...
    public static void createOrUpdateAccessBridge(com.azure.resourcemanager.networkcloud.NetworkCloudManager manager) {
        manager.accessBridges().define(AccessBridgeAllowedName.BASTION).withRegion("location")
            ...
            .withIpv4ConnectedPrefix("198.51.100.0/24").withIpv6ConnectedPrefix("2001:db8::/64")
            .withSecurityRules(Arrays.asList(new AccessBridgeSecurityRule()
