...
public final class Main {
    ...
    public static void createsOrUpdatesTheSpecifiedComputePolicy(
        ...
        manager.computePolicies().define("test_policy").withExistingAccount("contosorg", "contosoadla")
            .withObjectId(UUID.fromString("776b9091-8916-4638-87f7-9c989a38da98")).withObjectType(AadObjectType.USER)
            .withMaxDegreeOfParallelismPerJob(10).withMinPriorityPerJob(30).create();
    }
}
