...
public final class Main {
    ...
    public static void
        ...
        ForwardingRule resource = manager.forwardingRules().getWithResponse("sampleResourceGroup",
            "sampleDnsForwardingRuleset", "sampleForwardingRule", com.azure.core.util.Context.NONE).getValue();
        resource.update().withMetadata(mapOf("additionalProp2", "value2"))
            .withForwardingRuleState(ForwardingRuleState.DISABLED).apply();
    }
