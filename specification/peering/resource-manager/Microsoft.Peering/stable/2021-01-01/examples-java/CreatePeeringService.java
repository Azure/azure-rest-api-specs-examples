...
public final class Main {
    ...
    public static void createAPeeringService(com.azure.resourcemanager.peering.PeeringManager manager) {
        manager.peeringServices().define("peeringServiceName").withRegion("eastus").withExistingResourceGroup("rgName")
            .withPeeringServiceLocation("state1").withPeeringServiceProvider("serviceProvider1")
            .withProviderPrimaryPeeringLocation("peeringLocation1")
            .withProviderBackupPeeringLocation("peeringLocation2").create();
    }
}
