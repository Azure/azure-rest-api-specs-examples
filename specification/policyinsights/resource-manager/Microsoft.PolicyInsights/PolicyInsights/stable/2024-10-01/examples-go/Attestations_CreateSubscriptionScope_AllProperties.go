...
// Generated from example definition: 2024-10-01/Attestations_CreateSubscriptionScope_AllProperties.json
func ExampleAttestationsClient_BeginCreateOrUpdateAtSubscription_createAttestationAtSubscriptionScopeWithAllProperties() {
	...
	// res = armpolicyinsights.AttestationsClientCreateOrUpdateAtSubscriptionResponse{
	// 	Attestation: armpolicyinsights.Attestation{
