...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetPolicyFormat.json
func ExamplePolicyClient_Get_apiManagementGetPolicyFormat() {
	...
	res, err := clientFactory.NewPolicyClient().Get(ctx, "rg1", "apimService1", armapimanagement.PolicyIDNamePolicy, &armapimanagement.PolicyClientGetOptions{
		Format: to.Ptr(armapimanagement.PolicyExportFormatRawxml)})
	if err != nil {
	...
	// res = armapimanagement.PolicyClientGetResponse{
