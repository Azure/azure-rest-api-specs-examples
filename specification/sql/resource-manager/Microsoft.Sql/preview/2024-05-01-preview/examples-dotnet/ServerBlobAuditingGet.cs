...
// Generated from example definition: specification/sql/resource-manager/Microsoft.Sql/preview/2024-05-01-preview/examples/ServerBlobAuditingGet.json
...
NullableResponse<SqlServerBlobAuditingPolicyResource> response = await collection.GetIfExistsAsync(blobAuditingPolicyName);
SqlServerBlobAuditingPolicyResource result = response.HasValue ? response.Value : null;
