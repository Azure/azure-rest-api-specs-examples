...
public final class Main {
    /*
     * x-ms-original-file: 2025-09-01/NetworkManagerConnectionManagementGroupPut.json
     */
    /**
    ...
    public static void createOrUpdateManagementGroupNetworkManagerConnection(
        ...
        manager.serviceClient().getManagementGroupNetworkManagerConnections().createOrUpdateWithResponse(
            "managementGroupA", "TestNMConnection",
