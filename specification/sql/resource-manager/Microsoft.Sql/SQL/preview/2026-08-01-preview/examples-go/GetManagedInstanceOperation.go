...
// Generated from example definition: 2026-08-01-preview/GetManagedInstanceOperation.json
func ExampleManagedInstanceOperationsClient_Get() {
	...
	// 						Status: to.Ptr(armsql.UpsertManagedServerOperationStepWithEstimatesAndDurationStatusCompleted),
	// 						StepEndTime: to.Ptr(time.Date(2019, time.December, 6, 11, 23, 5, 470000000, time.UTC)),
	// 						StepStartTime: to.Ptr(time.Date(2019, time.December, 6, 11, 8, 46, 50000000, time.UTC)),
	...
	// 						StepEndTime: to.Ptr(time.Date(2019, time.December, 6, 11, 23, 11, 510000000, time.UTC)),
	// 						StepStartTime: to.Ptr(time.Date(2019, time.December, 6, 11, 23, 5, 550000000, time.UTC)),
	// 						TimeElapsed: to.Ptr("0"),
	// 					},
	// 					{
