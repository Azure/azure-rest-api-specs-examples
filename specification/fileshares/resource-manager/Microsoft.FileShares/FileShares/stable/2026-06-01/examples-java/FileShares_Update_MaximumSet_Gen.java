...
public final class Main {
    ...
    public static void fileSharesUpdateMaximumSet(com.azure.resourcemanager.fileshares.FileSharesManager manager) {
        FileShare resource = manager.fileShares()
            .getByResourceGroupWithResponse("rgfileshares", "fileshare", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key173", "fakeTokenPlaceholder"))
            .withProperties(new FileShareUpdateProperties().withProvisionedStorageGiB(7).withProvisionedIOPerSec(1)
