...
public final class Main {
    ...
    public static void disconnectedOperationsUpdate(
        ...
        DisconnectedOperation resource
            = manager.disconnectedOperations().getByResourceGroupWithResponse("rgdisconnectedoperations",
                "demo-resource", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key2", "fakeTokenPlaceholder"))
            .withProperties(new DisconnectedOperationUpdateProperties().withConnectionIntent(ConnectionIntent.CONNECTED)
                .withRegistrationStatus(RegistrationStatus.REGISTERED).withDeviceVersion("2.0.0"))
            .apply();
    }
