...
// Generated from example definition: 2025-12-26-preview/MarketplaceAgreements_Create.json
func ExampleMarketplaceAgreementsClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewMarketplaceAgreementsClient().CreateOrUpdate(ctx, armdatadog.AgreementResource{
