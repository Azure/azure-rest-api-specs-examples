...
public final class Main {
    ...
    public static void createOrUpdateAWorkflow(com.azure.resourcemanager.logic.LogicManager manager)
        throws IOException {
        manager.workflows().define("test-workflow").withRegion("brazilsouth")
            .withExistingResourceGroup("test-resource-group").withTags(mapOf())
            ...
            .withDefinition(SerializerFactory.createDefaultManagementSerializerAdapter().deserialize(
            ...
            .withParameters(mapOf("$connections", new WorkflowParameter()
