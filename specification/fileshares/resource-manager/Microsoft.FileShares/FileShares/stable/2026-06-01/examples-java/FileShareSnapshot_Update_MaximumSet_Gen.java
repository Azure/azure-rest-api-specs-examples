...
public final class Main {
    ...
    public static void
        ...
        FileShareSnapshot resource = manager.fileShareSnapshots().getFileShareSnapshotWithResponse("rgfileshares",
            "fileshare", "testfilesharesnapshot", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(
            new FileShareSnapshotUpdateProperties().withMetadata(mapOf("key491", "fakeTokenPlaceholder"))).apply();
    }
