...
// Generated from example definition: 2024-04-01/invoicesDownloadDocumentsByBillingSubscription.json
func ExampleInvoicesClient_BeginDownloadDocumentsByBillingSubscription() {
	...
	// res = armbilling.InvoicesClientDownloadDocumentsByBillingSubscriptionResponse{
