...
# USAGE
    python pipeline_run_create_export.py
...
# x-ms-original-file: specification/containerregistry/resource-manager/Microsoft.ContainerRegistry/preview/2025-05-01-preview/examples/PipelineRunCreate_Export.json
