...
// Generated from example definition: 2025-09-01/suppressionLists/getAddresses.json
func ExampleSuppressionListAddressesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armcommunication.SuppressionListAddressesClientListResponse{
		// 	SuppressionListAddressResourceCollection: armcommunication.SuppressionListAddressResourceCollection{
