...
// Generated from example definition: 2026-04-01-preview/CosmosDBRestorableGremlinResourceList.json
func ExampleRestorableGremlinResourcesClient_NewListPager() {
	...
	pager := clientFactory.NewRestorableGremlinResourcesClient().NewListPager("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", &armcosmos.RestorableGremlinResourcesClientListOptions{
	...
	for pager.More() {
		...
		// page = armcosmos.RestorableGremlinResourcesClientListResponse{
