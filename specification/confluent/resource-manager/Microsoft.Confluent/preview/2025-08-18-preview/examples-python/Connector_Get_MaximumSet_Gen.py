...
# USAGE
    python connector_get_maximum_set_gen.py
...
def main():
    ...
    response = client.connector.get(
        ...
        organization_name="pgwuoi",
        environment_id="rxbrvvdnplvbedrzwbgtwhbdm",
        cluster_id="eknmpvbhtvwxdxddkos",
        connector_name="zakwjragxeiur",
    )
    print(response)
