...
public final class Main {
    ...
    public static void
        ...
        manager.autoImportJobs().define("autojob1").withRegion("eastus").withExistingAmlFilesystem("scgroup", "fs1")
            .withTags(mapOf("Dept", "ContosoAds")).withAdminStatus(AutoImportJobPropertiesAdminStatus.ENABLE)
            .withAutoImportPrefixes(Arrays.asList("/")).withConflictResolutionMode(ConflictResolutionMode.SKIP)
            .withEnableDeletions(false).withMaximumErrors(0L).create();
    }
