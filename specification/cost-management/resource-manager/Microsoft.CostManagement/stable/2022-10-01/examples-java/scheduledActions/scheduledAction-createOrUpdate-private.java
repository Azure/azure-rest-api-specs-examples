...
public final class Main {
    ...
    public static void
        ...
        manager.scheduledActions().createOrUpdateWithResponse("monthlyCostByResource",
            new ScheduledActionInner().withKind(ScheduledActionKind.EMAIL).withDisplayName("Monthly Cost By Resource")
                ...
                .withStatus(ScheduledActionStatus.ENABLED).withViewId(
