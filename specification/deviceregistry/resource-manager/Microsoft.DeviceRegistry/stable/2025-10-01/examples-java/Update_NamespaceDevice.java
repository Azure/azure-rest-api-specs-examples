...
public final class Main {
    ...
    public static void updateNamespaceDevices(com.azure.resourcemanager.deviceregistry.DeviceRegistryManager manager) {
        NamespaceDevice resource = manager.namespaceDevices().getWithResponse("myResourceGroup",
            "adr-namespace-gbk0925-n01", "dev-namespace-gbk0925-n01", com.azure.core.util.Context.NONE).getValue();
        resource.update().withProperties(new NamespaceDeviceUpdateProperties()
            .withEndpoints(
                new MessagingEndpoints().withOutbound(new OutboundEndpoints().withAssigned(mapOf("eventGridEndpoint",
