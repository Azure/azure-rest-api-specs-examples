...
public final class Main {
    ...
    public static void purchase(com.azure.resourcemanager.reservations.ReservationsManager manager) {
        manager.reservationOrders().purchase("a075419f-44cc-497f-b68a-14ee811d48b9",
            new PurchaseRequest().withSku(new SkuName().withName("standard_D1")).withLocation("westus")
                .withReservedResourceType(ReservedResourceType.VIRTUAL_MACHINES)
                .withBillingScopeId("/subscriptions/ed3a1871-612d-abcd-a849-c2542a68be83").withTerm(ReservationTerm.P1Y)
                .withBillingPlan(ReservationBillingPlan.MONTHLY).withQuantity(1).withDisplayName("TestReservationOrder")
                .withAppliedScopeType(AppliedScopeType.SHARED).withRenew(false)
