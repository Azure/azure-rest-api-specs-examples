...
// Generated from example definition: 2015-06-01-preview/Locations/GetLocations_example.json
func ExampleLocationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.LocationsClientListResponse{
		// 	AscLocationList: armsecurity.AscLocationList{
