...
// x-ms-original-file: specification/m365securityandcompliance/resource-manager/Microsoft.M365SecurityAndCompliance/preview/2021-03-25-preview/examples/ComplianceCenterServiceCreatePrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsCompClient_BeginCreateOrUpdate() {
	...
	log.Printf("Response result: %#v\n", res.PrivateEndpointConnectionsCompClientCreateOrUpdateResult)
}
```
