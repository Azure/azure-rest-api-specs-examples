    ...
    public static void
        ...
        manager.providerRegistrations().createOrUpdate("Microsoft.Contoso",
            new ProviderRegistrationInner().withProperties(new ProviderRegistrationProperties()
                .withServices(Arrays
                    .asList(new ResourceProviderService().withServiceName("tags").withStatus(ServiceStatus.INACTIVE)))
                .withServiceName("root").withProviderVersion("2.0").withProviderType(ResourceProviderType.INTERNAL)
                .withManagement(new ResourceProviderManifestPropertiesManagement()
                    ...
                    .withIncidentContactEmail("helpme@contoso.com").withServiceTreeInfos(
                ...
                .withCapabilities(Arrays.asList(
                    ...
                    new ResourceProviderCapabilities().withQuotaId("CSP_MG_2017-12-01")
                        .withEffect(ResourceProviderCapabilitiesEffect.ALLOW)))
                .withDstsConfiguration(new ResourceProviderManifestPropertiesDstsConfiguration()
                    .withServiceName("prds-shim").withServiceDnsName("prds.sparta.azure.com"))
                ...
                .withNotificationSettings(
                    new ResourceProviderManifestPropertiesNotificationSettings().withSubscriberSettings(Arrays
                        .asList(new SubscriberSetting().withFilterRules(Arrays.asList(new FilterRule().withFilterQuery(
                            ...
                            .withEndpointInformation(Arrays.asList(
                                new EndpointInformation().withEndpoint("https://userrp.azure.com/arnnotify")
                                    .withEndpointType(NotificationEndpointType.WEBHOOK).withSchemaVersion("3.0"),
                                new EndpointInformation().withEndpoint("https://userrp.azure.com/arnnotify")
                                    .withEndpointType(NotificationEndpointType.EVENTHUB).withSchemaVersion("3.0"))))))))
                .withManagementGroupGlobalNotificationEndpoints(Arrays.asList(
                    new ResourceProviderEndpoint().withEndpointUri("{your_management_group_notification_endpoint}")))
                ...
                .withLegacyNamespace("legacyNamespace").withLegacyRegistrations(Arrays.asList("legacyRegistration"))
