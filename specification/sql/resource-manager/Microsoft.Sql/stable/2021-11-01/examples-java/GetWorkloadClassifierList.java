...
public final class Main {
    ...
    public static void
        ...
        azure.sqlServers().manager().serviceClient().getWorkloadClassifiers().listByWorkloadGroup(
            "Default-SQL-SouthEastAsia", "testsvr", "testdb", "wlm_workloadgroup", com.azure.core.util.Context.NONE);
    }
}
