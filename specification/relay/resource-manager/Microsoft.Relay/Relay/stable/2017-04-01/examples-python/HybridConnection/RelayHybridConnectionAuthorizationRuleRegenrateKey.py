...
# USAGE
    python relay_hybrid_connection_authorization_rule_regenrate_key.py
...
# x-ms-original-file: specification/relay/resource-manager/Microsoft.Relay/Relay/stable/2017-04-01/examples/HybridConnection/RelayHybridConnectionAuthorizationRuleRegenrateKey.json
