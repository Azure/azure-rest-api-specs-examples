...
# USAGE
    python cluster_managers_get.py
...
def main():
    ...
    response = client.cluster_managers.get(
...
# x-ms-original-file: specification/networkcloud/resource-manager/Microsoft.NetworkCloud/preview/2024-10-01-preview/examples/ClusterManagers_Get.json
