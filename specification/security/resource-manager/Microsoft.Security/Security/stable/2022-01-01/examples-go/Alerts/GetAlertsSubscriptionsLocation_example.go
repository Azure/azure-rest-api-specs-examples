...
// Generated from example definition: 2022-01-01/Alerts/GetAlertsSubscriptionsLocation_example.json
func ExampleAlertsClient_NewListSubscriptionLevelByRegionPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AlertsClientListSubscriptionLevelByRegionResponse{
