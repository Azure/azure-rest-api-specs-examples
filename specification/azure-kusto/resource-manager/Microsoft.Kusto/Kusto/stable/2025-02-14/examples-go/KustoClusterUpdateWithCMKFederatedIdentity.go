...
// Generated from example definition: 2025-02-14/KustoClusterUpdateWithCMKFederatedIdentity.json
func ExampleClustersClient_BeginUpdate_kustoClusterUpdateWithCmkFederatedIdentity() {
	...
	poller, err := clientFactory.NewClustersClient().BeginUpdate(ctx, "kustoRgTest", "kustoCluster2", armkusto.ClusterUpdate{
		...
		Properties: &armkusto.ClusterProperties{
			...
			KeyVaultProperties: &armkusto.KeyVaultProperties{
				...
				KeyVersion:                to.Ptr("12345678-1234-1234-1234-123456789098"),
				...
				FederatedIdentityClientID: to.Ptr("11111111-2222-3333-4444-555555555555"),
			},
	...
	// 		ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustoRgTest/providers/Microsoft.Kusto/Clusters/kustoCluster2"),
