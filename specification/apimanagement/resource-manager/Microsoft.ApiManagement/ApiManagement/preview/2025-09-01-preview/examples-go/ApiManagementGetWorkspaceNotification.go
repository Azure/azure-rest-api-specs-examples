...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetWorkspaceNotification.json
func ExampleWorkspaceNotificationClient_Get() {
	...
	// res = armapimanagement.WorkspaceNotificationClientGetResponse{
