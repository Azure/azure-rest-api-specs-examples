...
public final class Main {
    ...
    public static void updateAnExistingVault(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.vaults().manager().serviceClient().getVaults().updateWithResponse("sample-resource-group", "sample-vault",
            new VaultPatchParameters().withProperties(new VaultPatchProperties()
