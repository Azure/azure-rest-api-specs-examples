                                ...
                                Arrays.asList(
                                    ...
                                    new MapperTable().withName("lookup")
                                        .withSchema(Arrays.asList(
                                            ...
                                            new MapperTableSchema().withName("DepLoc").withDataType("string"),
                                        ...
                                        .withDslConnectorProperties(Arrays.asList(
                                            ...
                                            new MapperDslConnectorProperties().withName("inferDriftedColumnTypes")
                                                .withValue(false))),
                                    new MapperTable().withName("source/justSchema").withSchema(Arrays
                                        .asList(new MapperTableSchema().withName("CustId").withDataType("string"),
                                            new MapperTableSchema().withName("CustName").withDataType("string"),
                                            new MapperTableSchema().withName("CustAddres").withDataType("string"),
                                ...
                                .withCommonDslConnectorProperties(Arrays.asList(
                                    ...
                                    new MapperDslConnectorProperties().withName("dateFormats")
                                        .withValue(SerializerFactory
                                            .createDefaultManagementSerializerAdapter().deserialize(
                                                "[\"MM/dd/yyyy\",\"dd/MM/yyyy\",\"yyyy/MM/dd\",\"MM-dd-yyyy\",\"dd-MM-yyyy\",\"yyyy-MM-dd\",\"dd.MM.yyyy\",\"MM.dd.yyyy\",\"yyyy.MM.dd\"]",
                                                Object.class, SerializerEncoding.JSON)),
                                    new MapperDslConnectorProperties().withName("timestampFormats").withValue(
                    ...
                    .asList(
                        new MapperTargetConnectionsInfo()
                            ...
                            .withConnection(new MapperConnection()
                                ...
                                .withLinkedServiceType("AzureSqlDatabase").withType(ConnectionType.LINKEDSERVICETYPE)
                                .withIsInlineDataset(true)
                                .withCommonDslConnectorProperties(Arrays.asList(
                                    new MapperDslConnectorProperties().withName("allowSchemaDrift").withValue(true),
                                ...
                                .withAttributeMappingInfo(
                                    new MapperAttributeMappings().withAttributeMappings(Arrays.asList(
                                        new MapperAttributeMapping().withName("CustAddres")
                                            .withType(MappingType.DERIVED).withFunctionName("trim").withExpression(
                                                "trim(CustAddres)")
                                            .withAttributeReferences(
                                                Arrays.asList(new MapperAttributeReference().withName("CustAddres")
                                                    .withEntity("source/customer").withEntityConnectionReference(
                                        ...
                                        new MapperAttributeMapping()
                                            .withName("CustDeptName").withType(MappingType.DIRECT).withFunctionName("")
                                            .withAttributeReference(
                                                new MapperAttributeReference().withName("CustDepName").withEntity(
                                                    "source/customer")
                                                    .withEntityConnectionReference(
                                                        new MapperConnectionReference().withConnectionName("amjaAdls03")
                                                            .withType(ConnectionType.LINKEDSERVICETYPE))),
                                        new MapperAttributeMapping().withName("CustEmail").withType(MappingType.DIRECT)
                                            .withFunctionName("").withAttributeReference(new MapperAttributeReference()
                                                .withName("CustName").withEntity("source/customer")
                                                .withEntityConnectionReference(
                                        ...
                                        new MapperAttributeMapping().withName("CustId").withType(MappingType.DIRECT)
                                            .withFunctionName("")
                                            .withAttributeReference(new MapperAttributeReference().withName("CustId")
                                                .withEntity("source/customer").withEntityConnectionReference(
                                                    new MapperConnectionReference().withConnectionName("amjaAdls03")
                                                        .withType(ConnectionType.LINKEDSERVICETYPE))),
                                        new MapperAttributeMapping().withName("CustName").withType(MappingType.DIRECT)
                                            .withFunctionName("")
                                            .withAttributeReference(new MapperAttributeReference().withName("CustName")
                                                .withEntity("source/customer").withEntityConnectionReference(
                                                    new MapperConnectionReference()
                                                        .withConnectionName("amjaAdls03")
                                                        .withType(ConnectionType.LINKEDSERVICETYPE)))))),
