...
public final class Main {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/PublicIpPrefixUpdateTags.json
     */
    /**
    ...
    public static void updatePublicIPPrefixTags(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.networks().manager().serviceClient().getPublicIpPrefixes().updateTagsWithResponse("rg1", "test-ipprefix",
