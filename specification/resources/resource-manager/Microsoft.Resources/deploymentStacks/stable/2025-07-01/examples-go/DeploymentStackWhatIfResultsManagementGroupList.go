...
func ExampleWhatIfResultsAtManagementGroupClient_NewListPager() {
	...
	pager := clientFactory.NewWhatIfResultsAtManagementGroupClient().NewListPager("myMg", nil)
	for pager.More() {
		...
		// page = armdeploymentstacks.WhatIfResultsAtManagementGroupClientListResponse{
		...
		// 							},
		// 							{
		// 								ID: to.Ptr("/providers/Microsoft.Management/managementGroups/myMg/providers/Microsoft.Authorization/policyAssignments/thirdPolicyAssignment"),
		// 								ManagementStatusChange: &armdeploymentstacks.ChangeBaseDeploymentStacksManagementStatus{
