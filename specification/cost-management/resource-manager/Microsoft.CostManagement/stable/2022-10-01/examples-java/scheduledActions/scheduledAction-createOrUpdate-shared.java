...
public final class Main {
    ...
    public static void
        ...
        manager.scheduledActions().define("monthlyCostByResource")
            .withExistingScope("subscriptions/00000000-0000-0000-0000-000000000000").withKind(ScheduledActionKind.EMAIL)
            ...
            .withSchedule(new ScheduleProperties().withFrequency(ScheduleFrequency.MONTHLY).withHourOfDay(10)
            ...
            .withViewId("/providers/Microsoft.CostManagement/views/swaggerExample").withIfMatch("").create();
    }
}
