...
public final class Main {
    /*
     * x-ms-original-file: 2026-08-01-preview/ColumnSensitivityLabelCreateMax.json
     */
    /**
    ...
    public static void updatesTheSensitivityLabelOfAGivenColumnWithAllParameters(
        ...
        manager.serviceClient().getSensitivityLabels().createOrUpdateWithResponse("myRG", "myServer", "myDatabase",
            "dbo", "myTable", "myColumn", CurrentSensitivityLabelSource.CURRENT,
