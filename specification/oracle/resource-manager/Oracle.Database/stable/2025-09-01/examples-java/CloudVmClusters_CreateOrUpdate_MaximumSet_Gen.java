    ...
    public static void createVMClusterGeneratedByMaximumSetRule(
        ...
        manager.cloudVmClusters().define("cloudvmcluster1").withRegion("eastus").withExistingResourceGroup("rgopenapi")
            ...
            .withProperties(new CloudVmClusterProperties().withStorageSizeInGbs(1000)
                ...
                .withTimeZone("UTC").withZoneId("ocid1..aaaa").withHostname("hostname1").withDomain("domain1")
                .withCpuCoreCount(2).withOcpuCount(3.0D).withClusterName("cluster1").withDataStoragePercentage(100)
                ...
                .withIsSparseDiskgroupEnabled(true).withSystemVersion("v1")
                .withSshPublicKeys(Arrays.asList("ssh-key 1")).withLicenseModel(LicenseModel.LICENSE_INCLUDED)
                .withScanListenerPortTcp(1050).withScanListenerPortTcpSsl(1025)
                .withVnetId(
