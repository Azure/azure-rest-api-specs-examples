...
public final class Main {
    ...
    public static void
        ...
        manager.orchestratorInstanceServices().define("testk8s1").withRegion("West US")
            .withExistingResourceGroup("TestRG").withKind(OrchestratorKind.KUBERNETES)
            ...
            .withProperties(new OrchestratorResourceProperties()
                ...
                .withClusterRootCA("ddsadsad344mfdsfdl").withApiServerEndpoint("https://testk8s.cloudapp.net")
