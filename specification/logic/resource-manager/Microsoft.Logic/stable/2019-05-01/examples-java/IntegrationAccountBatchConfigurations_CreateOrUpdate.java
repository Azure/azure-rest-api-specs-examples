...
public final class Main {
    ...
    public static void createOrUpdateABatchConfiguration(com.azure.resourcemanager.logic.LogicManager manager) {
        manager.integrationAccountBatchConfigurations().define("testBatchConfiguration").withRegion("westus")
            ...
            .withProperties(new BatchConfigurationProperties().withBatchGroupName("DEFAULT")
                .withReleaseCriteria(new BatchReleaseCriteria().withMessageCount(10).withBatchSize(234567)
                    .withRecurrence(new WorkflowTriggerRecurrence().withFrequency(RecurrenceFrequency.MINUTE)
                        .withInterval(1).withStartTime("2017-03-24T11:43:00").withTimeZone("India Standard Time"))))
            .create();
    }
}
