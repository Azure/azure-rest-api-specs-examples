...
// Generated from example definition: 2025-12-26-preview/MarketplaceAgreements_List.json
func ExampleMarketplaceAgreementsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armdatadog.MarketplaceAgreementsClientListResponse{
		// 	AgreementResourceListResponse: armdatadog.AgreementResourceListResponse{
