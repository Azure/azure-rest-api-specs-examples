...
// Generated from example definition: 2024-10-01/Attestations_ListSubscriptionScope_WithQuery.json
func ExampleAttestationsClient_NewListForSubscriptionPager_listAttestationsAtSubscriptionScopeWithQueryParameters() {
	...
	pager := clientFactory.NewAttestationsClient().NewListForSubscriptionPager(&armpolicyinsights.AttestationsClientListForSubscriptionOptions{
	...
	for pager.More() {
		...
		// page = armpolicyinsights.AttestationsClientListForSubscriptionResponse{
