...
// Generated from example definition: specification/managednetworkfabric/resource-manager/Microsoft.ManagedNetworkFabric/preview/2023-02-01-preview/examples/NetworkDevices_Create_MaximumSet_Gen.json
...
NetworkDeviceData data = new NetworkDeviceData(new AzureLocation("eastus"))
{
    ...
    NetworkDeviceRole = NetworkDeviceRoleType.CE,
    Tags =
    {
    ["keyID"] = "keyValue",
    },
