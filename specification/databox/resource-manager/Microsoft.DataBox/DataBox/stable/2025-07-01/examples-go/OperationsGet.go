...
// Generated from example definition: 2025-07-01/OperationsGet.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armdatabox.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armdatabox.OperationsClientListResponse{
		// 	OperationList: armdatabox.OperationList{
		...
		// 				},
		// 				Origin: to.Ptr("user"),
		// 				Properties: &armdatabox.OperationProperties{
		// 				},
		// 			},
		// 			{
