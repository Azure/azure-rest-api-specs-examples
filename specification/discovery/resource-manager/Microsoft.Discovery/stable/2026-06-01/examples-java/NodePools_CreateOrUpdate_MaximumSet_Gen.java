...
public final class Main {
    ...
    public static void nodePoolsCreateOrUpdateMaximumSet(com.azure.resourcemanager.discovery.DiscoveryManager manager) {
        manager.nodePools().define("932c7b8d4ff0c243b8").withRegion("uksouth")
            ...
            .withProperties(new NodePoolProperties().withSubnetId(
                ...
                .withVmSize(VmSize.STANDARD_NC24ADS_A100_V4).withMaxNodeCount(18).withMinNodeCount(0)
                .withScaleSetPriority(ScaleSetPriority.REGULAR).withOsDiskSizeGb(610).withImageCacheLowerThreshold(4)
