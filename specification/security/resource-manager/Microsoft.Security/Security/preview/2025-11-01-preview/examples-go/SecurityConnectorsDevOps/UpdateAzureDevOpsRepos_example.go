...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/UpdateAzureDevOpsRepos_example.json
func ExampleAzureDevOpsReposClient_BeginUpdate() {
	...
	// res = armsecurity.AzureDevOpsReposClientUpdateResponse{
