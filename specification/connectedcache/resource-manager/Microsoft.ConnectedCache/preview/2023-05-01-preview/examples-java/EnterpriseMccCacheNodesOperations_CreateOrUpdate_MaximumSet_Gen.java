        ...
        manager.enterpriseMccCacheNodesOperations()
            ...
            .withProperties(new CacheNodeProperty()
                .withCacheNode(new CacheNodeEntity().withFullyQualifiedResourceId("yeinlleavzbehelhsucb")
                    .withCustomerName("zsklcocjfjhkcpmzyefzkwamdzc").withIpAddress("gbfkdhloyphnpnhemwrcrxlk")
                    .withCustomerIndex("vafvezmelfgmjsrccjukrhppljvipg").withCacheNodeId("fmrjefyddfn")
                    .withCacheNodeName("qppvqxliajjfoalzjbgmxggr").withCustomerAsn(25).withIsEnabled(true)
                    .withMaxAllowableEgressInMbps(27).withIsEnterpriseManaged(true)
                    .withCidrCsv(Arrays.asList("nlqlvrthafvvljuupcbcw")).withShouldMigrate(true)
                ...
                .withAdditionalCacheNodeProperties(new AdditionalCacheNodeProperties()
                    ...
                    .withDriveConfiguration(
                        Arrays.asList(new CacheNodeDriveConfiguration().withPhysicalPath("pcbkezoofhamkycot")
                            .withSizeInGb(14).withCacheNumber(11).withNginxMapping("cirlpkpuxg")))
                    ...
                    .withProxyUrl("ihkzxlzvpcywtzrogupqozkdud").withOptionalProperty1("ph")
                    .withOptionalProperty2("soqqgpgcbhb").withOptionalProperty3("fpnycrbagptsujiotnjfuhlm")
                    .withOptionalProperty4("gesqugrxvhxlxxyvatgrautxwlmxsf").withOptionalProperty5("zknjgzpaqtvdqjydd"))
                .withStatusCode("fakeTokenPlaceholder").withStatusText("Success").withStatusDetails("lgljxmyyoakw")
