...
public final class Main {
    ...
    public static void scheduledActionsVirtualMachinesExecuteCreateMaximumSetGenGeneratedByMaximumSetRule(
        ...
        manager.scheduledActions().virtualMachinesExecuteCreateWithResponse("oslhbouzgevzpeydssyelhw",
            new ExecuteCreateRequest()
                .withResourceConfigParameters(new ResourceProvisionPayload().withBaseProfile(mapOf("hardwareProfile",
                    ...
                    .withResourceOverrides(Arrays.asList(mapOf(
                        "name", BinaryData.fromBytes("myFleet_523".getBytes(StandardCharsets.UTF_8)), "location",
                        BinaryData
                            .fromBytes("LocalDev".getBytes(StandardCharsets.UTF_8)),
                        "properties",
                        BinaryData.fromBytes(
                    ...
                    .withResourceCount(2).withResourcePrefix("TL1"))
