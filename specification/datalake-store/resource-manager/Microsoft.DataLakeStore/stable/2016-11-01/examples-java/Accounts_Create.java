...
public final class Main {
    ...
    public static void
        ...
        manager.accounts().define("contosoadla").withRegion("eastus2").withExistingResourceGroup("contosorg")
            .withTags(mapOf("test_key", "fakeTokenPlaceholder")).withIdentity(new EncryptionIdentity())
            ...
            .withEncryptionConfig(new EncryptionConfig().withType(EncryptionConfigType.USER_MANAGED)
                .withKeyVaultMetaInfo(new KeyVaultMetaInfo().withKeyVaultResourceId("fakeTokenPlaceholder")
                    .withEncryptionKeyName("fakeTokenPlaceholder").withEncryptionKeyVersion("fakeTokenPlaceholder")))
            ...
            .withTrustedIdProviderState(TrustedIdProviderState.ENABLED).withNewTier(TierType.CONSUMPTION).create();
    }
