        ...
        manager.containerApps().define("testcontainerAppTcp").withRegion("East US").withExistingResourceGroup("rg")
            ...
            .withConfiguration(
                new Configuration()
                    .withIngress(
                        new Ingress()
                            .withExternal(true).withTargetPort(3000).withExposedPort(
                                4000)
                            .withTransport(IngressTransportMethod.TCP).withTraffic(
                                Arrays.asList(new TrafficWeight().withRevisionName("testcontainerAppTcp-ab1234")))))
            .withTemplate(new Template()
                ...
                .withScale(
                    new Scale().withMinReplicas(1).withMaxReplicas(5).withCooldownPeriod(350).withPollingInterval(35)
