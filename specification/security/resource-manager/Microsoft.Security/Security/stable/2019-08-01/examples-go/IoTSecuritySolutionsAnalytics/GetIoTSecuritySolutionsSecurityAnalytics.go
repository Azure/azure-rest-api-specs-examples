...
// Generated from example definition: 2019-08-01/IoTSecuritySolutionsAnalytics/GetIoTSecuritySolutionsSecurityAnalytics.json
func ExampleIotSecuritySolutionAnalyticsClient_Get() {
	...
	// res = armsecurity.IotSecuritySolutionAnalyticsClientGetResponse{
	// 	IoTSecuritySolutionAnalyticsModel: armsecurity.IoTSecuritySolutionAnalyticsModel{
