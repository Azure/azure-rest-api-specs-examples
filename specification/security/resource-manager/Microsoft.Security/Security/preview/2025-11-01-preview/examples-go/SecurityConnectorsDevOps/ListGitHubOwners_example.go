...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListGitHubOwners_example.json
func ExampleGitHubOwnersClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.GitHubOwnersClientListResponse{
