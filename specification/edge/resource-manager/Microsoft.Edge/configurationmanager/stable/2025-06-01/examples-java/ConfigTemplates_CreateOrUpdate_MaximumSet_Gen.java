...
public final class Main {
    ...
    public static void configTemplatesCreateOrUpdateMaximumSet(
        ...
        manager.configTemplates().define("testname").withRegion("egqjo")
            .withExistingResourceGroup("rgconfigurationmanager").withTags(mapOf("key6936", "fakeTokenPlaceholder"))
            .withProperties(new ConfigTemplateProperties().withDescription("ccdyggozwmhyvemlcwlsnhijwg")).create();
    }
