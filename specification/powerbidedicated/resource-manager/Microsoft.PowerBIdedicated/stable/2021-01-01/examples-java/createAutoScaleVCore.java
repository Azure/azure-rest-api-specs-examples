...
public final class Main {
    ...
    public static void
        ...
        manager.autoScaleVCores().define("testvcore").withRegion("West US").withExistingResourceGroup("TestRG")
            ...
            .withCapacityObjectId("a28f00bd-5330-4572-88f1-fa883e074785").withCapacityLimit(10).create();
    }
