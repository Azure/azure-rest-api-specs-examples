...
# USAGE
    python management_association_create.py
...
def main():
    ...
    response = client.management_associations.create_or_update(
...
# x-ms-original-file: specification/operationsmanagement/resource-manager/Microsoft.OperationsManagement/OperationsManagement/preview/2015-11-01-preview/examples/ManagementAssociationCreate.json
