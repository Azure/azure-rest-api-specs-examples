...
public final class Main {
    ...
    public static void clusterCreateOrUpdateMaximumSet(com.azure.resourcemanager.confluent.ConfluentManager manager) {
        manager.clusters().define("rdizpgcbewizsgffpg")
            ...
            .withSpec(new SCClusterSpecEntity().withName("cq").withAvailability("mtt")
                .withCloud("zamxartuouxpglfbitjwhqy").withZone("pqcxm").withPackageProperty(Package.ESSENTIALS)
                .withRegion("gbodcnzmbifwyitnojrxali").withKafkaBootstrapEndpoint("cnbkuhfnnqjb")
                .withHttpEndpoint("bircvfulzjdeobklsrbuxwr").withApiEndpoint("axxhwauhucchb")
                ...
                .withEnvironment(new SCClusterNetworkEnvironmentEntity().withId("wbshmvpdhycxltclubn")
                    .withEnvironment("ern").withRelated("q").withResourceName("ewjrvururrahroszquhvhryqzmncp"))
                .withNetwork(new SCClusterNetworkEnvironmentEntity().withId("wbshmvpdhycxltclubn")
                    .withEnvironment("ern").withRelated("q").withResourceName("ewjrvururrahroszquhvhryqzmncp"))
                .withByok(new SCClusterByokEntity().withId("kfppxiwgcmp").withRelated("sfvjcdvrpzwwmplohiniuselqq")
                    .withResourceName("dvttcugicoklgyavt")))
            .withStatus(new ClusterStatusEntity().withPhase("qkpkryngvlvlostlvilptnfhpj").withCku(1)).create();
    }
}
