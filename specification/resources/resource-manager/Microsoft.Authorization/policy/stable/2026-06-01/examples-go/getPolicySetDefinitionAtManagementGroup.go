...
// Generated from example definition: 2026-06-01/getPolicySetDefinitionAtManagementGroup.json
func ExampleSetDefinitionsClient_GetAtManagementGroup() {
	...
	res, err := clientFactory.NewSetDefinitionsClient().GetAtManagementGroup(ctx, "MyManagementGroup", "CostManagement", nil)
	if err != nil {
