...
public final class Main {
     ...
     */
    public static void queueServicesPut(com.azure.resourcemanager.storage.StorageManager manager) {
        manager.serviceClient().getQueueServices().setServicePropertiesWithResponse("res4410", "sto8607",
