...
// Generated from example definition: 2026-08-01-preview/ManagedInstanceTopQueriesListMax.json
func ExampleManagedInstancesClient_NewListByManagedInstancePager_obtainListOfInstanceSTopResourceConsumingQueriesFullBlownRequestAndResponse() {
	...
	pager := clientFactory.NewManagedInstancesClient().NewListByManagedInstancePager("sqlcrudtest-7398", "sqlcrudtest-4645", &armsql.ManagedInstancesClientListByManagedInstanceOptions{
	...
	for pager.More() {
		...
		// page = armsql.ManagedInstancesClientListByManagedInstanceResponse{
		// 	TopQueriesListResult: armsql.TopQueriesListResult{
