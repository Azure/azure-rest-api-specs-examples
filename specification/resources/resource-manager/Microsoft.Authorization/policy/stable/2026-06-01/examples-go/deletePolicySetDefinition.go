...
// Generated from example definition: 2026-06-01/deletePolicySetDefinition.json
func ExampleSetDefinitionsClient_Delete() {
	...
	res, err := clientFactory.NewSetDefinitionsClient().Delete(ctx, "CostManagement", nil)
	if err != nil {
	...
	// res = armpolicy.SetDefinitionsClientDeleteResponse{
	// }
}
