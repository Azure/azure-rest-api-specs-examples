...
// Generated from example definition: 2025-07-01/NetworkManagerSecurityUserRuleCollectionList.json
func ExampleSecurityUserRuleCollectionsClient_NewListPager() {
	...
	pager := clientFactory.NewSecurityUserRuleCollectionsClient().NewListPager("rg1", "testNetworkManager", "myTestSecurityConfig", nil)
	for pager.More() {
		...
		// page = armnetwork.SecurityUserRuleCollectionsClientListResponse{
		// 	SecurityUserRuleCollectionListResult: armnetwork.SecurityUserRuleCollectionListResult{
		// 		NextLink: to.Ptr("https://management.azure.com/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/securityUserConfigurations/myTestSecurityConfig/ruleCollections?api-version=2025-07-01&$skipToken=10"),
		...
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/securityUserConfigurations/myTestSecurityConfig/ruleCollections/testRuleCollection"),
