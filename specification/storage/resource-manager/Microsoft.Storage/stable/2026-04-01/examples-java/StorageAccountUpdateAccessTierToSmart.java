    ...
    public static void storageAccountUpdateAccessTierToSmart(com.azure.resourcemanager.storage.StorageManager manager) {
        manager.serviceClient().getStorageAccounts().updateWithResponse("res9407", "sto8596",
            new StorageAccountUpdateParameters()
                ...
                .withKeyPolicy(new KeyPolicy().withKeyExpirationPeriodInDays(20)).withAccessTier(AccessTier.SMART)
                .withIsSftpEnabled(true).withIsLocalUserEnabled(true).withEnableExtendedGroups(true)
