...
NullableResponse<RegistrationNewRegionFrontloadReleaseResource> response = await collection.GetIfExistsAsync(releaseName);
RegistrationNewRegionFrontloadReleaseResource result = response.HasValue ? response.Value : null;
