...
// Generated from example definition: 2023-02-15-preview/SensitivitySettings/GetSensitivitySettings_example.json
func ExampleSensitivitySettingsClient_Get() {
	...
	// res = armsecurity.SensitivitySettingsClientGetResponse{
