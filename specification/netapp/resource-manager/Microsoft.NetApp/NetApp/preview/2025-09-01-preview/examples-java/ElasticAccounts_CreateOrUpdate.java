...
public final class Main {
    ...
    public static void elasticAccountsCreateOrUpdate(com.azure.resourcemanager.netapp.NetAppFilesManager manager) {
        manager.elasticAccounts().define("account1").withRegion("eastus").withExistingResourceGroup("myRG")
            .withTags(mapOf("ac-tag1", "account1")).withProperties(new ElasticAccountProperties()).create();
    }
