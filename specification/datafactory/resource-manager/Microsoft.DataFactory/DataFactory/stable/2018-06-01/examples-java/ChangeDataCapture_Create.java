...
public final class Main {
    ...
    public static void changeDataCaptureCreate(com.azure.resourcemanager.datafactory.DataFactoryManager manager)
        ...
        manager.changeDataCaptures().define("exampleChangeDataCapture")
            .withExistingFactory("exampleResourceGroup",
                "exampleFactoryName")
            .withSourceConnectionsInfo(Arrays.asList(new MapperSourceConnectionsInfo()
                .withSourceEntities(Arrays.asList(new MapperTable().withName("source/customer")
                    .withSchema(Arrays.asList(new MapperTableSchema().withName("CustId").withDataType("short"),
                        new MapperTableSchema().withName("CustName").withDataType("string"), new MapperTableSchema()
                            .withName("CustAddres").withDataType("string"),
                        new MapperTableSchema().withName("CustDepName").withDataType("string"), new MapperTableSchema()
                            .withName("CustDepLoc").withDataType("string")))
                    .withDslConnectorProperties(Arrays
                        .asList(new MapperDslConnectorProperties().withName("container").withValue("source"),
                            new MapperDslConnectorProperties().withName("fileSystem").withValue("source"),
                            new MapperDslConnectorProperties().withName("folderPath").withValue("customer"),
                            new MapperDslConnectorProperties().withName("allowSchemaDrift").withValue(false),
                            new MapperDslConnectorProperties().withName("inferDriftedColumnTypes").withValue(false))),
                    new MapperTable().withName("source/employee").withSchema(Arrays.asList())
                        .withDslConnectorProperties(Arrays
                            .asList(new MapperDslConnectorProperties().withName("container").withValue("source"),
                                new MapperDslConnectorProperties().withName("fileSystem").withValue("source"),
                                new MapperDslConnectorProperties().withName("folderPath").withValue("employee"))),
                    new MapperTable().withName("lookup").withSchema(
                        Arrays.asList(new MapperTableSchema().withName("EmpId").withDataType("short"),
                            new MapperTableSchema().withName("EmpName").withDataType("string"),
                            new MapperTableSchema().withName("HomeAddress").withDataType("string"),
                            new MapperTableSchema().withName("OfficeAddress").withDataType("string"),
                            new MapperTableSchema().withName("EmpPhoneNumber").withDataType("integer"),
                            new MapperTableSchema().withName("DepName").withDataType("string"), new MapperTableSchema()
                                .withName("DepLoc").withDataType("string"),
                            new MapperTableSchema().withName("DecimalCol").withDataType("double")))
                        .withDslConnectorProperties(Arrays.asList(
                            new MapperDslConnectorProperties().withName("container").withValue("lookup"),
                            new MapperDslConnectorProperties().withName("fileSystem").withValue("lookup"),
                            new MapperDslConnectorProperties().withName("allowSchemaDrift").withValue(false),
                            new MapperDslConnectorProperties().withName("inferDriftedColumnTypes").withValue(false))),
                    new MapperTable().withName("source/justSchema").withSchema(Arrays.asList(new MapperTableSchema()
                        .withName("CustId").withDataType("string"),
                        ...
                        .withDslConnectorProperties(
                            Arrays.asList(new MapperDslConnectorProperties().withName("container").withValue("source"),
                                new MapperDslConnectorProperties().withName("fileSystem").withValue("source"),
                                new MapperDslConnectorProperties().withName("folderPath").withValue("justSchema"),
                                new MapperDslConnectorProperties().withName("allowSchemaDrift").withValue(false),
                ...
                .withConnection(new MapperConnection()
                    ...
                    .withLinkedServiceType("AzureBlobFS").withType(ConnectionType.LINKEDSERVICETYPE)
                    ...
                    .withCommonDslConnectorProperties(Arrays.asList(
                        ...
                        new MapperDslConnectorProperties().withName("inferDriftedColumnTypes").withValue(true),
                        new MapperDslConnectorProperties().withName("format").withValue("delimited"),
                    ...
                    .asList(
                        new MapperTargetConnectionsInfo()
                            .withTargetEntities(Arrays.asList(
                                new MapperTable().withName("dbo.employee").withSchema(Arrays.asList())
                                    .withDslConnectorProperties(Arrays.asList(
                                        new MapperDslConnectorProperties().withName("schemaName").withValue("dbo"),
                                        new MapperDslConnectorProperties().withName("tableName")
                                            .withValue("employee"))),
                                new MapperTable().withName("dbo.justSchema").withSchema(Arrays.asList())
                                    .withDslConnectorProperties(Arrays.asList(
                                        new MapperDslConnectorProperties().withName("schemaName").withValue("dbo"),
                                        new MapperDslConnectorProperties().withName("tableName")
                                        ...
                                        new MapperDslConnectorProperties().withName("inferDriftedColumnTypes")
                                            .withValue(true))),
                                new MapperTable().withName("dbo.customer").withSchema(
                                    Arrays.asList(new MapperTableSchema().withName("CustId").withDataType("integer"),
                                        new MapperTableSchema().withName("CustName").withDataType("string"),
                                        new MapperTableSchema().withName("CustAddres").withDataType("string"),
                                    ...
                                    .withDslConnectorProperties(Arrays.asList(
                                        ...
                                        new MapperDslConnectorProperties().withName("inferDriftedColumnTypes")
                                            .withValue(false))),
                                new MapperTable().withName("dbo.data_source_table").withSchema(
                                    Arrays.asList(new MapperTableSchema().withName("PersonID").withDataType("integer"),
                                    ...
                                    .withDslConnectorProperties(Arrays.asList(
                                        ...
                                        new MapperDslConnectorProperties()
                                            .withName("inferDriftedColumnTypes").withValue(false),
                            ...
                            .withConnection(new MapperConnection()
                                ...
                                .withLinkedServiceType(
                                    "AzureSqlDatabase")
                                .withType(ConnectionType.LINKEDSERVICETYPE).withIsInlineDataset(true)
                                .withCommonDslConnectorProperties(Arrays.asList(
                                    new MapperDslConnectorProperties().withName("allowSchemaDrift").withValue(true),
                                    new MapperDslConnectorProperties().withName("inferDriftedColumnTypes").withValue(
                                        true),
                            ...
                            .withDataMapperMappings(Arrays.asList(new DataMapperMapping()
                                .withTargetEntityName("dbo.customer").withSourceEntityName("source/customer")
                                .withSourceConnectionReference(
                                    new MapperConnectionReference()
                                        .withConnectionName("amjaAdls03").withType(ConnectionType.LINKEDSERVICETYPE))
                                ...
                                new DataMapperMapping().withTargetEntityName("dbo.data_source_table")
                                    ...
                                    .withAttributeMappingInfo(
                                        new MapperAttributeMappings().withAttributeMappings(Arrays.asList(
                                            new MapperAttributeMapping().withName("Name").withType(MappingType.DERIVED)
                                                .withFunctionName("upper").withExpression("upper(EmpName)")
                                            ...
                                            new MapperAttributeMapping()
                                                .withName("PersonID").withType(MappingType.DIRECT).withFunctionName("")
                                    ...
                                    .withAttributeMappingInfo(
                                        new MapperAttributeMappings().withAttributeMappings(Arrays.asList(
                                            new MapperAttributeMapping().withName("CustAddres")
                                                .withType(MappingType.DERIVED).withFunctionName("trim")
                                                .withExpression("trim(CustAddres)").withAttributeReferences(Arrays
                                                    .asList(new MapperAttributeReference().withName("CustAddres")
                                                        .withEntity("source/justSchema")
                                                        .withEntityConnectionReference(new MapperConnectionReference()
                                                            .withConnectionName("amjaAdls03")
                                                            .withType(ConnectionType.LINKEDSERVICETYPE)))),
                                            new MapperAttributeMapping().withName("CustDepLoc")
                                                .withType(MappingType.DIRECT).withAttributeReference(
                                                    new MapperAttributeReference().withName("CustDepLoc")
                                                        .withEntity("source/justSchema")
                                                        .withEntityConnectionReference(
                                                            new MapperConnectionReference()
                                                                .withConnectionName("amjaAdls03")
                                                ...
                                                .withAttributeReferences(Arrays.asList(new MapperAttributeReference()
                                                    ...
                                                    new MapperAttributeReference().withName("CustDepName")
                                                        ...
                                                        .withEntityConnectionReference(new MapperConnectionReference()
                                                            .withConnectionName("amjaAdls03")
                                                            .withType(ConnectionType.LINKEDSERVICETYPE)))),
                                            new MapperAttributeMapping().withName("CustId").withType(MappingType.DIRECT)
                                                .withFunctionName("").withAttributeReference(
