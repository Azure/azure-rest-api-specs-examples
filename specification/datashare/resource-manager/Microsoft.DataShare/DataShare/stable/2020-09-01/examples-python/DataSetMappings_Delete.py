...
def main():
    ...
    client.data_set_mappings.delete(
...
# x-ms-original-file: specification/datashare/resource-manager/Microsoft.DataShare/DataShare/stable/2020-09-01/examples/DataSetMappings_Delete.json
