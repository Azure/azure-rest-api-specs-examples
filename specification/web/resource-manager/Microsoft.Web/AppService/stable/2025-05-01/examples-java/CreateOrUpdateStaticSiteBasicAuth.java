...
public final class Main {
    ...
    public static void createsOrUpdatesBasicAuthPropertiesForAStaticSite(
        ...
        manager.serviceClient().getStaticSites().createOrUpdateBasicAuthWithResponse("rg", "testStaticSite0",
            BasicAuthName.DEFAULT, new StaticSiteBasicAuthPropertiesArmResourceInner()
