...
public final class Main {
    ...
    public static void createAnInstancePoolWithMinProperties(com.azure.resourcemanager.sql.SqlServerManager manager) {
        manager.serviceClient().getInstancePools().createOrUpdate("group1", "testIP", new InstancePoolInner()
            ...
            .withVCores(8).withLicenseType(InstancePoolLicenseType.LICENSE_INCLUDED), com.azure.core.util.Context.NONE);
    }
