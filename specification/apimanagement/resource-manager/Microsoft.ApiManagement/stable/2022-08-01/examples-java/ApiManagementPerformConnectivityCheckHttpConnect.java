...
public final class Main {
    ...
    public static void hTTPConnectivityCheck(com.azure.resourcemanager.apimanagement.ApiManagementManager manager) {
        manager.resourceProviders().performConnectivityCheckAsync("rg1", "apimService1",
            new ConnectivityCheckRequest().withSource(new ConnectivityCheckRequestSource().withRegion("northeurope"))
                .withDestination(
                ...
                .withProtocolConfiguration(new ConnectivityCheckRequestProtocolConfiguration()
                    .withHttpConfiguration(new ConnectivityCheckRequestProtocolConfigurationHttpConfiguration()
                        .withMethod(Method.GET).withValidStatusCodes(Arrays.asList(200L, 204L))
