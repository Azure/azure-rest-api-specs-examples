...
public final class Main {
    ...
    public static void
        ...
        manager.autoExportJobs().define("job1").withRegion("eastus").withExistingAmlFilesystem("scgroup", "fs1")
            .withTags(mapOf("Dept", "ContosoAds")).withAutoExportPrefixes(Arrays.asList("/")).create();
    }
