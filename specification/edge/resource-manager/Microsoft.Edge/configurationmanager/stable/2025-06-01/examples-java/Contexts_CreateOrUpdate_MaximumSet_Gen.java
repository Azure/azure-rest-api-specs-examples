...
public final class Main {
    ...
    public static void contextsCreateOrUpdateMaximumSet(
        ...
        manager.contexts().define("testname").withRegion("pkquwbplcp")
            .withExistingResourceGroup("rgconfigurationmanager").withTags(mapOf("key3046", "fakeTokenPlaceholder"))
            .withProperties(new ContextProperties()
                .withCapabilities(Arrays.asList(new Capability().withName("tpylinjcmlnycfpofpxjtqmt")
                    .withDescription("banbenutsngwytoqh").withState(ResourceState.ACTIVE)))
