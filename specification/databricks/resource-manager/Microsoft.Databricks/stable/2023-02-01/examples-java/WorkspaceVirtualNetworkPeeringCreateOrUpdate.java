...
public final class Main {
    ...
    public static void
        ...
        manager.vNetPeerings().define("vNetPeeringTest").withExistingWorkspace("rg", "myWorkspace")
            ...
            .withAllowVirtualNetworkAccess(true).withAllowForwardedTraffic(false).withAllowGatewayTransit(false)
            .withUseRemoteGateways(false).create();
    }
}
