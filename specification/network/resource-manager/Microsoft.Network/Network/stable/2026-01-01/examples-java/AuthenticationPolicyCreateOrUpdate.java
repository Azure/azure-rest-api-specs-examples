...
public final class Main {
    ...
    public static void createsOrUpdatesAUserSignInAuthenticationPolicyWithinAResourceGroup(
        ...
        manager.serviceClient().getAuthenticationPolicies()
                ...
                new AuthenticationPolicyInner().withLocation("eastus")
                    .withProperties(new AuthenticationPolicyPropertiesFormat()
                        ...
                        .withAuthenticationProperties(new AuthenticationProviderProperties()
                            ...
                            .withClientSecret("fakeTokenPlaceholder").withScope(Arrays.asList("openid", "profile"))
                            .withSessionTimeout("86400").withSessionCookieName("ApplicationGatewayUserSession")))
