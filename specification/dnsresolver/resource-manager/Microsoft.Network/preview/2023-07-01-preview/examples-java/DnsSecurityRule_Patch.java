...
public final class Main {
    ...
    public static void
        ...
        DnsSecurityRule resource = manager.dnsSecurityRules().getWithResponse("sampleResourceGroup",
            "sampleDnsResolverPolicy", "sampleDnsSecurityRule", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder"))
            .withDnsSecurityRuleState(DnsSecurityRuleState.DISABLED).apply();
    }
