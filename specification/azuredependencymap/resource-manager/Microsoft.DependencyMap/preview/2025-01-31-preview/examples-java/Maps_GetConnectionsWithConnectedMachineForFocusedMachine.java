...
public final class Main {
    ...
    public static void mapsGetConnectionsWithConnectedMachineForFocusedMachineGeneratedByMaximumSetRule(
        ...
        manager.maps().getConnectionsWithConnectedMachineForFocusedMachine("rgdependencyMap", "mapsTest1",
            new GetConnectionsWithConnectedMachineForFocusedMachineRequest().withFocusedMachineId("gagovctcfgocievqwq")
