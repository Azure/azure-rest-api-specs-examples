...
// Generated from example definition: 2023-10-01-preview/MaintenanceConfigurationsResourceGroup_List.json
func ExampleConfigurationsForResourceGroupClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmaintenance.ConfigurationsForResourceGroupClientListResponse{
