...
public final class Main {
    ...
    public static void networkToNetworkInterconnectsCreateMaximumSetGen(
        ...
        manager.networkToNetworkInterconnects().define("example-nni")
            .withExistingNetworkFabric("example-rg", "example-nf").withUseOptionB(BooleanEnumProperty.TRUE)
            ...
            .withOptionBLayer3Configuration(new OptionBLayer3Configuration().withPrimaryIpv4Prefix("10.0.0.12/30")
                ...
                .withSecondaryIpv6Prefix("6FFE:FFFF:0:CD30::ac/127").withPeerAsn(61234L).withVlanId(1234)
