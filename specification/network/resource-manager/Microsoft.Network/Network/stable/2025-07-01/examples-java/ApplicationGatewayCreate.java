...
public final class Main {
     ...
     */
    public static void createApplicationGateway(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getApplicationGateways().createOrUpdate("rg1", "appgw", new ApplicationGatewayInner()
            .withLocation("eastus")
            ...
            .withGatewayIpConfigurations(Arrays.asList(new ApplicationGatewayIpConfigurationInner().withName("appgwipc")
            ...
            .withRequestRoutingRules(Arrays.asList(new ApplicationGatewayRequestRoutingRuleInner().withName("appgwrule")
                ...
                .withEntraJWTValidationConfig(new SubResource().withId(
                    "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/applicationGateways/appgw/entraJWTValidationConfigs/entraJWTValidationConfig1"))))
            .withRewriteRuleSets(
