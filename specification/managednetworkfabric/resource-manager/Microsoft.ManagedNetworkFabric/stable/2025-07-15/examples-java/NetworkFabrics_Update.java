...
public final class Main {
    ...
    public static void networkFabricsUpdateMaximumSetGen(
        ...
        resource.update().withTags(mapOf("keyId", "fakeTokenPlaceholder"))
            ...
            .withAnnotation("annotation1").withRackCount(6).withServerCountPerRack(10).withIpv4Prefix("10.18.0.0/17")
            .withIpv6Prefix("3FFE:FFFF:0:CD40::/60").withFabricAsn(12345L)
            .withTerminalServerConfiguration(new TerminalServerPatchConfiguration().withUsername("username1")
                .withPassword("fakeTokenPlaceholder").withSerialNumber("1234567").withPrimaryIpv4Prefix("10.0.0.12/30")
