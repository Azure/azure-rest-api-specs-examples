...
// Generated from example definition: 2026-08-01-preview/SqlAgentConfigurationPut.json
func ExampleAgentClient_CreateOrUpdate() {
	...
	// res = armsql.AgentClientCreateOrUpdateResponse{
	// 	AgentConfiguration: armsql.AgentConfiguration{
	// 		Name: to.Ptr("current"),
