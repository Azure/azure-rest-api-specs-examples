...
public final class Main {
     ...
     */
    public static void createConnectionMonitorV2(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getConnectionMonitors().createOrUpdate("rg1", "nw1", "cm1", new ConnectionMonitorInner()
            .withEndpoints(Arrays.asList(new ConnectionMonitorEndpoint().withName("vm1").withResourceId(
