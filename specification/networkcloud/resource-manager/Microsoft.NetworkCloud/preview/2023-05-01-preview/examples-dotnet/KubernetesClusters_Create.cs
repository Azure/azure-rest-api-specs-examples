...
// get the collection of this KubernetesClusterResource
...
ArmOperation<KubernetesClusterResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, kubernetesClusterName, data);
