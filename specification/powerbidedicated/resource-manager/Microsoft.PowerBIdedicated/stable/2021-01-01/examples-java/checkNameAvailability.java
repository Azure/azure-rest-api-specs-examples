...
public final class Main {
    ...
    public static void
        ...
        manager.capacities()
            .checkNameAvailabilityWithResponse("West US", new CheckCapacityNameAvailabilityParameters()
                .withName("azsdktest").withType("Microsoft.PowerBIDedicated/capacities"),
