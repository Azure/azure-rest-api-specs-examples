...
NullableResponse<HciVmNetworkInterfaceResource> response = await collection.GetIfExistsAsync(networkInterfaceName);
HciVmNetworkInterfaceResource result = response.HasValue ? response.Value : null;
