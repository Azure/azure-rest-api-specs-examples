...
public final class Main {
    ...
    public static void
        ...
        manager.networkAnchors().define("networkAnchor1").withRegion("igamtwfkkmjnkcceh")
            .withExistingResourceGroup("rgopenapi").withTags(mapOf("key4863", "fakeTokenPlaceholder"))
            .withProperties(new NetworkAnchorProperties().withResourceAnchorId("ivxnsdkelptazxrbzzrs").withSubnetId(
                ...
                .withOciVcnDnsLabel("taqimtjhlsshwakiaocbsrewvkq").withOciBackupCidrBlock("i")
                .withIsOracleToAzureDnsZoneSyncEnabled(true).withIsOracleDnsListeningEndpointEnabled(true)
            ...
            .withZones(Arrays.asList("qwrgwcmycokwbhdafhoheaxzoxx")).create();
    }
