...
// Generated from example definition: 2022-06-15/WebTestListByResourceGroup.json
func ExampleWebTestsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armapplicationinsights.WebTestsClientListByResourceGroupResponse{
		// 	WebTestListResult: armapplicationinsights.WebTestListResult{
