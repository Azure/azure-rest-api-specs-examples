...
func ExampleVirtualMachinesClient_BeginAssignRelay() {
	...
	poller, err := clientFactory.NewVirtualMachinesClient().BeginAssignRelay(ctx, "resourceGroupName", "virtualMachineName", &armnetworkcloud.VirtualMachinesClientBeginAssignRelayOptions{
		VirtualMachineAssignRelayParameters: &armnetworkcloud.VirtualMachineAssignRelayParameters{
