...
public final class Main {
    /*
     * x-ms-original-file:
     * specification/network/resource-manager/Microsoft.Network/stable/2025-05-01/examples/NetworkWatcherFlowLogCreate.
     * json
     */
    /**
    ...
    public static void createOrUpdateFlowLog(com.azure.resourcemanager.AzureResourceManager azure) {
        azure.networks().manager().serviceClient().getFlowLogs().createOrUpdate("rg1", "nw1", "fl", new FlowLogInner()
            ...
            .withEnabledFilteringCriteria("srcIP=158.255.7.8 || dstPort=56891").withRecordTypes("B,E").withEnabled(true)
