...
public final class Main {
    ...
    public static void
        ...
        manager.fileShares().define("fileshare").withRegion("westus").withExistingResourceGroup("rgfileshares")
            .withTags(mapOf("key9647", "fakeTokenPlaceholder"))
            .withProperties(new FileShareProperties().withMountName("fileshare").withMediaTier(MediaTier.SSD)
                .withRedundancy(Redundancy.LOCAL).withProtocol(Protocol.NFS).withProvisionedStorageGiB(8)
                .withProvisionedIOPerSec(5).withProvisionedThroughputMiBPerSec(22)
