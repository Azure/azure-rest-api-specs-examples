            ...
            new SqlContainerCreateUpdateParameters().withLocation("West US").withTags(mapOf())
                .withResource(new SqlContainerResource().withId("containerName").withIndexingPolicy(new IndexingPolicy()
                    ...
                    .withFullTextIndexes(Arrays.asList(new FullTextIndexPath().withPath("/ftPath1"),
                        new FullTextIndexPath().withPath("/ftPath2"), new FullTextIndexPath().withPath("/ftPath3"))))
                    ...
                    .withVectorEmbeddingPolicy(new VectorEmbeddingPolicy().withVectorEmbeddings(Arrays.asList(
                        new VectorEmbedding().withPath("/vectorPath1").withDataType(VectorDataType.FLOAT32)
                            .withDistanceFunction(DistanceFunction.EUCLIDEAN).withDimensions(400),
                        new VectorEmbedding().withPath("/vectorPath2").withDataType(VectorDataType.UINT8)
                            .withDistanceFunction(DistanceFunction.COSINE).withDimensions(512),
                        new VectorEmbedding().withPath("/vectorPath3").withDataType(VectorDataType.INT8)
                            .withDistanceFunction(DistanceFunction.DOTPRODUCT).withDimensions(512))))
