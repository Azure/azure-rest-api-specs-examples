...
public final class Main {
    ...
    public static void updateDNSResolverDomainList(com.azure.resourcemanager.dnsresolver.DnsResolverManager manager) {
        DnsResolverDomainList resource
            = manager.dnsResolverDomainLists().getByResourceGroupWithResponse("sampleResourceGroup",
                "sampleDnsResolverDomainList", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key1", "fakeTokenPlaceholder")).withDomains(Arrays.asList("contoso.com"))
            .apply();
    }
