...
public final class Main {
    ...
    public static void createOrReplaceNamespaceDiscoveredDevice(
        ...
        manager.namespaceDiscoveredDevices().define("my-discovereddevice-1").withRegion("West Europe")
            ...
            .withProperties(new NamespaceDiscoveredDeviceProperties()
                ...
                .withDiscoveryId("discoveryId1").withVersion(1L))
            .create();
    }
