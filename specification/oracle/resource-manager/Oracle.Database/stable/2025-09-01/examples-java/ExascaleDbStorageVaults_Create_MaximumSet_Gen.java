...
public final class Main {
    ...
    public static void exascaleDbStorageVaultsCreateMaximumSet(
        ...
        manager.exascaleDbStorageVaults().define("storagevault1").withRegion("zuoudqbvlxerpjtlfooyqlb")
            .withExistingResourceGroup("rgopenapi").withTags(mapOf("key4521", "fakeTokenPlaceholder"))
            .withProperties(new ExascaleDbStorageVaultProperties().withAdditionalFlashCacheInPercent(0).withDescription(
            ...
            .withZones(Arrays.asList("npqjhyekyumfybqas")).create();
    }
