...
public final class Main {
    ...
    public static void putAClusterWithMaximumParameters(
        ...
        manager.managedClusters().define("myCluster").withRegion("eastus").withExistingResourceGroup("resRg")
            .withSku(new Sku().withName(SkuName.BASIC)).withTags(mapOf()).withDnsName("myCluster")
            .withClientConnectionPort(19000).withHttpGatewayConnectionPort(
                19080)
            .withAdminUsername(
                "vmadmin")
            .withAdminPassword(
            ...
            .withLoadBalancingRules(
                Arrays
                    .asList(
                        new LoadBalancingRule().withFrontendPort(80).withBackendPort(80)
                            .withProtocol(
                                Protocol.fromString("http"))
                            .withProbePort(80).withProbeProtocol(ProbeProtocol.HTTP),
                        new LoadBalancingRule().withFrontendPort(443).withBackendPort(443)
                            .withProtocol(Protocol.fromString("http")).withProbePort(443)
                            .withProbeProtocol(ProbeProtocol.HTTP),
                        new LoadBalancingRule().withFrontendPort(10000).withBackendPort(10000)
                            .withProtocol(Protocol.TCP).withProbePort(10000).withProbeProtocol(ProbeProtocol.HTTP)
                            .withLoadDistribution("Default")))
            .withAllowRdpAccess(true)
            .withNetworkSecurityRules(Arrays.asList(
                new NetworkSecurityRule().withName("TestName").withDescription("Test description")
                    .withProtocol(NsgProtocol.TCP).withSourceAddressPrefixes(Arrays.asList("*"))
                    .withDestinationAddressPrefixes(Arrays.asList("*")).withSourcePortRanges(Arrays.asList("*"))
                    .withDestinationPortRanges(Arrays.asList("*")).withAccess(Access.ALLOW).withPriority(1010)
                    .withDirection(Direction.INBOUND),
                new NetworkSecurityRule().withName("AllowARM").withProtocol(NsgProtocol.fromString("*"))
                    .withSourceAddressPrefix("AzureResourceManager").withDestinationAddressPrefix("*")
                    .withSourcePortRange("*").withDestinationPortRange("33500-33699").withAccess(Access.ALLOW)
                    .withPriority(2002).withDirection(Direction.INBOUND)))
            .withFabricSettings(
            ...
            .withClusterCodeVersion("7.1.168.9494").withClusterUpgradeMode(ClusterUpgradeMode.MANUAL)
            ...
            .withEnableAutoOSUpgrade(true).withZonalResiliency(true)
            .withApplicationTypeVersionsCleanupPolicy(
                new ApplicationTypeVersionsCleanupPolicy().withMaxUnusedVersionsToKeep(3))
            .withEnableIpv6(true).withIpTags(Arrays.asList(new IpTag().withIpTagType("FirstPartyUsage").withTag("SQL")))
            .withAuxiliarySubnets(Arrays.asList(new Subnet().withName("testSubnet1").withEnableIpv6(true)
            ...
            .withZonalUpdateMode(ZonalUpdateMode.FAST).withUseCustomVnet(true)
            ...
            .withUpgradeDescription(new ClusterUpgradePolicy().withForceRestart(false)
                ...
                .withDeltaHealthPolicy(new ClusterUpgradeDeltaHealthPolicy().withMaxPercentDeltaUnhealthyNodes(20)
                    .withMaxPercentUpgradeDomainDeltaUnhealthyNodes(40).withMaxPercentDeltaUnhealthyApplications(40))
                .withMonitoringPolicy(new ClusterMonitoringPolicy().withHealthCheckWaitDuration("00:05:00")
                    .withHealthCheckStableDuration("00:45:00").withHealthCheckRetryTimeout("00:55:00")
                    .withUpgradeTimeout("12:00:00").withUpgradeDomainTimeout("03:00:00")))
            .withHttpGatewayTokenAuthConnectionPort(19081).withEnableHttpGatewayExclusiveAuthMode(true).create();
    }
