...
// Generated from example definition: 2025-04-01-preview/privatelink/PrivateLinkResourcesListByWorkspace.json
func ExampleWorkspacePrivateLinkResourcesClient_NewListByWorkspacePager() {
	...
	for pager.More() {
		...
		// page = armhealthcareapis.WorkspacePrivateLinkResourcesClientListByWorkspaceResponse{
