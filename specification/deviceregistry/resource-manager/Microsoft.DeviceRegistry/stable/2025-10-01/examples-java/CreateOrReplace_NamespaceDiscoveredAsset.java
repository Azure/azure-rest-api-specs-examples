...
public final class Main {
    ...
    public static void createOrReplaceNamespaceDiscoveredAsset(
        ...
        manager.namespaceDiscoveredAssets().define("my-discoveredasset-1").withRegion("West Europe")
            ...
            .withProperties(new NamespaceDiscoveredAssetProperties()
                ...
                .withDiscoveryId("11111111-1111-1111-1111-111111111111").withVersion(73766L).withManufacturer("Contoso")
                ...
                .withDatasets(Arrays.asList(new NamespaceDiscoveredDataset().withName("dataset1")
                    .withDataSource("nsu=http://microsoft.com/Opc/OpcPlc/Boiler;i=5").withTypeRef("dataset1TypeRef")
