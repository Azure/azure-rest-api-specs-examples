...
func ExamplePrivateLinkScopesClient_GetValidationDetailsForMachine() {
	...
	// res = armhybridcompute.PrivateLinkScopesClientGetValidationDetailsForMachineResponse{
	// 	PrivateLinkScopeValidationDetails: armhybridcompute.PrivateLinkScopeValidationDetails{
