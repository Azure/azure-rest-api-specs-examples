...
public final class Main {
     ...
     */
    public static void updateAzureStorageAccounts(com.azure.resourcemanager.appservice.AppServiceManager manager) {
        manager.serviceClient().getWebApps().updateAzureStorageAccountsWithResponse("testrg123", "sitef6141",
