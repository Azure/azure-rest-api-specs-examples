...
// Generated from example definition: 2023-10-01/ListOperation.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armsqlvirtualmachine.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armsqlvirtualmachine.OperationsClientListResponse{
		// 	OperationListResult: armsqlvirtualmachine.OperationListResult{
		...
		// 					Description: to.Ptr("Retrieve details of SQL virtual machine group"),
		...
		// 				Display: &armsqlvirtualmachine.OperationDisplay{
		// 					Description: to.Ptr("Starts SQL best practices Assessment on SQL virtual machine"),
		// 					Operation: to.Ptr("Starts SQL best practices Assessment on SQL virtual machine"),
		// 				},
		// 			},
		// 			{
		...
		// 			},
		// 			{
		// 				Name: to.Ptr("Microsoft.SqlVirtualMachine/sqlVirtualMachines/fetchDCAssessment/action"),
		// 				Display: &armsqlvirtualmachine.OperationDisplay{
		// 				},
		// 			},
		// 			{
		// 				Name: to.Ptr("Microsoft.SqlVirtualMachine/sqlVirtualMachines/troubleshoot/action"),
		// 				Display: &armsqlvirtualmachine.OperationDisplay{
		// 					Description: to.Ptr("Start SQL virtual machine troubleshooting operation"),
		// 					Operation: to.Ptr("Start SQL virtual machine troubleshooting operation"),
		// 				},
		// 			},
		// 			{
