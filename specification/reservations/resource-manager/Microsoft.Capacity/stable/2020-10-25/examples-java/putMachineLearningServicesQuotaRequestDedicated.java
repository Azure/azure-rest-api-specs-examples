...
public final class Main {
    ...
    public static void quotasRequestPutForMachineLearningServicesDedicatedResource(
        ...
        manager.quotas().define("StandardDv2Family")
            .withExistingLocation("D7EC67B3-7657-4966-BFFC-41EFD36BAAB3", "Microsoft.MachineLearningServices", "eastus")
            .withProperties(new QuotaProperties().withLimit(200).withUnit("Count")
                .withName(new ResourceName().withValue("StandardDv2Family")).withResourceType(ResourceType.DEDICATED))
            .create();
    }
}
