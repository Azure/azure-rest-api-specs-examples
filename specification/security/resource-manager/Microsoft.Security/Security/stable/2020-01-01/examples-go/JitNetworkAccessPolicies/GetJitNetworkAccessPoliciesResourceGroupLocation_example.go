...
// Generated from example definition: 2020-01-01/JitNetworkAccessPolicies/GetJitNetworkAccessPoliciesResourceGroupLocation_example.json
func ExampleJitNetworkAccessPoliciesClient_NewListByResourceGroupAndRegionPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.JitNetworkAccessPoliciesClientListByResourceGroupAndRegionResponse{
		// 	JitNetworkAccessPoliciesList: armsecurity.JitNetworkAccessPoliciesList{
