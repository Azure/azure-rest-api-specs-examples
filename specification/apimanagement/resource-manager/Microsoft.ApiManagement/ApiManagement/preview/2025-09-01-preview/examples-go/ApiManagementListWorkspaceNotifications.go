...
// Generated from example definition: 2025-09-01-preview/ApiManagementListWorkspaceNotifications.json
func ExampleWorkspaceNotificationClient_NewListByServicePager() {
	...
	pager := clientFactory.NewWorkspaceNotificationClient().NewListByServicePager("rg1", "apimService1", "wks1", nil)
	for pager.More() {
		...
		// page = armapimanagement.WorkspaceNotificationClientListByServiceResponse{
		// 	NotificationCollection: armapimanagement.NotificationCollection{
