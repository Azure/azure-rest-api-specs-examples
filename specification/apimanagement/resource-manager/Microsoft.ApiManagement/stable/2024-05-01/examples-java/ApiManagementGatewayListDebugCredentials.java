...
public final class Main {
    ...
    public static void
        ...
        manager.gateways().listDebugCredentialsWithResponse("rg1", "apimService1", "gw1",
            new GatewayListDebugCredentialsContract().withCredentialsExpireAfter(Duration.parse("PT1H"))
                .withPurposes(Arrays.asList(GatewayListDebugCredentialsContractPurpose.TRACING)).withApiId(
