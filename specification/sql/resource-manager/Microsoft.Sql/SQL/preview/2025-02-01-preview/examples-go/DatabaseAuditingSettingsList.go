...
// Generated from example definition: 2025-02-01-preview/DatabaseAuditingSettingsList.json
func ExampleDatabaseBlobAuditingPoliciesClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.DatabaseBlobAuditingPoliciesClientListByDatabaseResponse{
		// 	DatabaseBlobAuditingPolicyListResult: armsql.DatabaseBlobAuditingPolicyListResult{
