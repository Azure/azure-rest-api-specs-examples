            ...
            .withDeploymentConfiguration(new DeploymentConfiguration().withVersion("string")
                .withScaleUnits(Arrays.asList(new ScaleUnits()
                    .withDeploymentData(new DeploymentData()
                        ...
                        .withStorage(new Storage().withConfigurationMode("Express").withStorageType(StorageType.S2D)
                        ...
                        .withNamingPrefix("ms169").withDomainFqdn("ASZ1PLab8.nttest.microsoft.com")
                        ...
                        .withHostNetwork(new DeploymentSettingHostNetwork()
                            .withIntents(Arrays.asList(new DeploymentSettingIntents().withName("Compute_Management")
                                ...
                                .withAdapterPropertyOverrides(new DeploymentSettingAdapterPropertyOverrides()
                                    .withJumboPacket("1514").withNetworkDirect("Enabled")
                                    .withNetworkDirectTechnology("iWARP"))))
                            .withStorageNetworks(
                                Arrays
                                    .asList(
                                        new DeploymentSettingStorageNetworks().withName("Storage1Network")
                                            .withNetworkAdapterName("Port3").withVlanId("5").withStorageAdapterIpInfo(
                                                Arrays
                                                    .asList(
                                                        new DeploymentSettingStorageAdapterIpInfo()
                                                            .withPhysicalNode("string").withIpv4Address("10.57.48.60")
                                                            .withSubnetMask("255.255.248.0")))))
                            .withSanNetworks(new SanNetworks().withClusterNetworkConfig(new SanClusterNetworkConfig()
                                .withAdapterProperties(new SanAdapterProperties().withPriorityValue8021ActionCluster(7)
                                    .withPriorityValue8021ActionSmb(3).withBandwidthPercentageSmb(50)
                                    .withJumboPacket(9014))
                                .withAdapterIPConfig(Arrays.asList(new SanAdapterIPConfig().withName("clusterNetwork-A")
                                    .withNetworkAdapterName("ethernet 3").withVlanId(711)
