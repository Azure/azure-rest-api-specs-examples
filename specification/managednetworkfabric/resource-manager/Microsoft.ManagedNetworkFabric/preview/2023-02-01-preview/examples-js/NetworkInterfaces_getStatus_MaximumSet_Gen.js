...
/**
 * This sample demonstrates how to Get the running status of the Network Interface.
 *
 * @summary Get the running status of the Network Interface.
 ...
 */
async function networkInterfacesGetStatusMaximumSetGen() {
  ...
  const result = await client.networkInterfaces.beginGetStatusAndWait(
    resourceGroupName,
    networkDeviceName,
