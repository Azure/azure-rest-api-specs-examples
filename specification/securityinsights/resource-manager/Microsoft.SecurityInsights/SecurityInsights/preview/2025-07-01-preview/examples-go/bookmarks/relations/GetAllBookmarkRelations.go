...
func ExampleBookmarkRelationsClient_NewListPager() {
	...
	pager := clientFactory.NewBookmarkRelationsClient().NewListPager("myRg", "myWorkspace", "2216d0e1-91e3-4902-89fd-d2df8c535096", nil)
	for pager.More() {
		...
		// page = armsecurityinsights.BookmarkRelationsClientListResponse{
