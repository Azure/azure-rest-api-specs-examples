    ...
    public static void cosmosDBDatabaseAccountCreateMax(com.azure.resourcemanager.cosmos.CosmosManager manager) {
        manager.serviceClient().getDatabaseAccounts().createOrUpdate("rg1", "ddb1",
            new DatabaseAccountCreateUpdateParameters().withLocation("westus").withTags(mapOf())
                ...
                .withCapacity(new Capacity().withTotalThroughputLimit(2000)).withEnableBurstCapacity(true)
                .withMinimalTlsVersion(MinimalTlsVersion.TLS12).withEnablePriorityBasedExecution(true)
                .withDefaultPriorityLevel(DefaultPriorityLevel.LOW).withEnablePerRegionPerPartitionAutoscale(true)
                .withEnforceHierarchicalPartitionKeyIdLastLevel(false),
