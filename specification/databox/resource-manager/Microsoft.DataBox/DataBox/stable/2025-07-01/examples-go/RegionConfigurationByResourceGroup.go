...
// Generated from example definition: 2025-07-01/RegionConfigurationByResourceGroup.json
func ExampleServiceClient_RegionConfigurationByResourceGroup() {
	...
	// res = armdatabox.ServiceClientRegionConfigurationByResourceGroupResponse{
	// 	RegionConfigurationResponse: armdatabox.RegionConfigurationResponse{
