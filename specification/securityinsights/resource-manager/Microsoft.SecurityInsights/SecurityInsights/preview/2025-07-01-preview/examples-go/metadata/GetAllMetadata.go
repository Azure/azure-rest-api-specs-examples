...
func ExampleMetadataClient_NewListPager_getAllMetadata() {
	...
	pager := clientFactory.NewMetadataClient().NewListPager("myRg", "myWorkspace", nil)
	for pager.More() {
		...
		// page = armsecurityinsights.MetadataClientListResponse{
		// 	MetadataList: armsecurityinsights.MetadataList{
