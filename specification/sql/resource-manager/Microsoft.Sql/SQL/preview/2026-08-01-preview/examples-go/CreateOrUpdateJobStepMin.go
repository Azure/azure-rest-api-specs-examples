...
// Generated from example definition: 2026-08-01-preview/CreateOrUpdateJobStepMin.json
func ExampleJobStepsClient_CreateOrUpdate_createOrUpdateAJobStepWithMinimalPropertiesSpecified() {
	...
	// res = armsql.JobStepsClientCreateOrUpdateResponse{
	// 	JobStep: armsql.JobStep{
	// 		Name: to.Ptr("step1"),
