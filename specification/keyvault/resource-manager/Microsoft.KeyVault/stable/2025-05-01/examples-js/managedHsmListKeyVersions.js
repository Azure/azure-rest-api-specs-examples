 ...
 * x-ms-original-file: specification/keyvault/resource-manager/Microsoft.KeyVault/stable/2025-05-01/examples/managedHsmListKeyVersions.json
 */
async function listKeyVersionsInTheManagedHsm() {
  ...
  for await (const item of client.managedHsmKeys.listVersions(resourceGroupName, name, keyName)) {
    resArray.push(item);
  }
