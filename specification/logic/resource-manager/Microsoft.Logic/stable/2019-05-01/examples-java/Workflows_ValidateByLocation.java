...
public final class Main {
    ...
    public static void validateAWorkflow(com.azure.resourcemanager.logic.LogicManager manager) throws IOException {
        manager.workflows().validateByLocationWithResponse("test-resource-group", "brazilsouth", "test-workflow",
            new WorkflowInner().withLocation("brazilsouth").withTags(mapOf())
