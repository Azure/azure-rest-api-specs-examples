...
// Generated from example definition: 2024-10-01/Attestations_ListResourceGroupScope_WithQuery.json
func ExampleAttestationsClient_NewListForResourceGroupPager_listAttestationsAtResourceGroupScopeWithQueryParameters() {
	...
	pager := clientFactory.NewAttestationsClient().NewListForResourceGroupPager("myRg", &armpolicyinsights.AttestationsClientListForResourceGroupOptions{
	...
	for pager.More() {
		...
		// page = armpolicyinsights.AttestationsClientListForResourceGroupResponse{
