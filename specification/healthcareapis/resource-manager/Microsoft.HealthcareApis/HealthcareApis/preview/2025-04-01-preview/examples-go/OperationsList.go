...
// Generated from example definition: 2025-04-01-preview/OperationsList.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armhealthcareapis.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armhealthcareapis.OperationsClientListResponse{
		// 	ListOperations: armhealthcareapis.ListOperations{
