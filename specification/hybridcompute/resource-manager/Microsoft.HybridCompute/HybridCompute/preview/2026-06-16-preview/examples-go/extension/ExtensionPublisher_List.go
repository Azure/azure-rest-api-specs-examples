...
// Generated from example definition: 2026-06-16-preview/extension/ExtensionPublisher_List.json
func ExampleExtensionPublisherClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armhybridcompute.ExtensionPublisherClientListResponse{
		// 	ExtensionPublisherListResult: armhybridcompute.ExtensionPublisherListResult{
