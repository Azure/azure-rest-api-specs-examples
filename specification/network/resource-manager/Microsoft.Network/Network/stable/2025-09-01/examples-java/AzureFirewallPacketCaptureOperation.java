...
public final class Main {
    /*
     * x-ms-original-file: 2025-09-01/AzureFirewallPacketCaptureOperation.json
     */
    /**
     ...
     */
    public static void azureFirewallPacketCaptureOperation(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getAzureFirewalls().packetCaptureOperation("rg1", "azureFirewall1",
