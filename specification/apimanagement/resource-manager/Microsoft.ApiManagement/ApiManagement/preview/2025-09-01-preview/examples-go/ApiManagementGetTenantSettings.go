...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetTenantSettings.json
func ExampleTenantSettingsClient_Get() {
	...
	// res = armapimanagement.TenantSettingsClientGetResponse{
	// 	TenantSettingsContract: armapimanagement.TenantSettingsContract{
	// 		Name: to.Ptr("public"),
