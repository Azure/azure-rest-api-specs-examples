...
// Generated from example definition: 2025-09-01-preview/ApiManagementListNotifications.json
func ExampleNotificationClient_NewListByServicePager() {
	...
	pager := clientFactory.NewNotificationClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.NotificationClientListByServiceResponse{
