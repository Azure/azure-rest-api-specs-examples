...
public final class Main {
    ...
    public static void
        ...
        manager.graphQLApiResolvers().define("newResolver").withExistingApi("rg1", "apimService1", "someAPI")
            .withDisplayName("Query Users").withPath("Query/users").withDescription("A GraphQL Resolver example")
            .create();
    }
}
