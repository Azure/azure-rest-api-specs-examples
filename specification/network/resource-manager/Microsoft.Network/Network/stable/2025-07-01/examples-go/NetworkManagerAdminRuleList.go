...
func ExampleAdminRulesClient_NewListPager() {
	...
	pager := clientFactory.NewAdminRulesClient().NewListPager("rg1", "testNetworkManager", "myTestSecurityConfig", "testRuleCollection", nil)
	for pager.More() {
		...
		// page = armnetwork.AdminRulesClientListResponse{
