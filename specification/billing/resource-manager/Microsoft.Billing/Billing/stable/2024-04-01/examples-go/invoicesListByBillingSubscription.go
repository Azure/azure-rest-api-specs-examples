...
// Generated from example definition: 2024-04-01/invoicesListByBillingSubscription.json
func ExampleInvoicesClient_NewListByBillingSubscriptionPager() {
	...
	for pager.More() {
		...
		// page = armbilling.InvoicesClientListByBillingSubscriptionResponse{
		// 	InvoiceListResult: armbilling.InvoiceListResult{
