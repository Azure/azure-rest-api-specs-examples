...
public final class Main {
    ...
    public static void ransomwareReportsClearSuspects(com.azure.resourcemanager.netapp.NetAppFilesManager manager) {
        manager.ransomwareReports().clearSuspects(
            "myRG", "account1", "pool1", "volume1", "ransomwareReport1", new RansomwareSuspectsClearRequest()
                .withResolution(RansomwareSuspectResolution.POTENTIAL_THREAT).withExtensions(Arrays.asList(".threat")),
