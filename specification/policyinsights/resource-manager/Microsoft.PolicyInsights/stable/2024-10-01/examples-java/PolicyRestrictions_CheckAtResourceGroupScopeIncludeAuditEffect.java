...
public final class Main {
    ...
    public static void checkPolicyRestrictionsAtResourceGroupScopeIncludingAuditEffect(
        ...
        manager.policyRestrictions().checkAtResourceGroupScopeWithResponse("vmRg",
            new CheckRestrictionsRequest()
                .withResourceDetails(new CheckRestrictionsResourceDetails()
                    .withResourceContent(SerializerFactory.createDefaultManagementSerializerAdapter().deserialize(
