...
// x-ms-original-file: specification/m365securityandcompliance/resource-manager/Microsoft.M365SecurityAndCompliance/preview/2021-03-25-preview/examples/ComplianceCenterServiceGetPrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsCompClient_Get() {
	...
	log.Printf("Response result: %#v\n", res.PrivateEndpointConnectionsCompClientGetResult)
}
```
