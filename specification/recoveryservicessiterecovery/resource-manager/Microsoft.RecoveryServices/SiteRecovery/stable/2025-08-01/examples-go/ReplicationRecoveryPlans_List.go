...
// Generated from example definition: 2025-08-01/ReplicationRecoveryPlans_List.json
func ExampleReplicationRecoveryPlansClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.ReplicationRecoveryPlansClientListResponse{
		// 	RecoveryPlanCollection: armrecoveryservicessiterecovery.RecoveryPlanCollection{
