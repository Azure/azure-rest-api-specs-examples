...
public final class Main {
    ...
    public static void entitiesIngestHealthReport(com.azure.resourcemanager.cloudhealth.CloudHealthManager manager) {
        manager.entities().ingestHealthReportWithResponse("rgopenapi", "myHealthModel", "entity1",
            new HealthReportRequest().withSignalName("uniqueSignalName1").withHealthState(HealthState.DEGRADED)
                .withValue(85.5D)
                ...
                .withExpiresInMinutes(60).withAdditionalContext("CPU usage elevated due to batch processing job"),
