...
public final class Main {
    ...
    public static void createGraphQuery(com.azure.resourcemanager.resourcegraph.ResourceGraphManager manager) {
        manager.graphQueries().define("MyDockerVMs").withRegion((String) null)
            .withExistingResourceGroup("024e2271-06fa-46b6-9079-f1ed3c7b070e", "my-resource-group").withTags(mapOf())
            .withDescription("Docker VMs in PROD")
            .withQuery("where isnotnull(tags['Prod']) and properties.extensions[0].Name == 'docker'").create();
    }
