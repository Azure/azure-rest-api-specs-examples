...
// Generated from example definition: 2026-08-01-preview/ListManagedInstanceOperations.json
func ExampleManagedInstanceOperationsClient_NewListByManagedInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.ManagedInstanceOperationsClientListByManagedInstanceResponse{
		// 	ManagedInstanceOperationListResult: armsql.ManagedInstanceOperationListResult{
		...
		// 					StartTime: to.Ptr(time.Date(2019, time.December, 6, 11, 8, 44, 490000000, time.UTC)),
		...
		// 								StepEndTime: to.Ptr(time.Date(2019, time.December, 6, 11, 8, 45, 570000000, time.UTC)),
		// 								StepStartTime: to.Ptr(time.Date(2019, time.December, 6, 11, 8, 44, 490000000, time.UTC)),
		...
		// 								Status: to.Ptr(armsql.UpsertManagedServerOperationStepWithEstimatesAndDurationStatusCompleted),
		// 								StepEndTime: to.Ptr(time.Date(2019, time.December, 6, 11, 22, 47, 350000000, time.UTC)),
		// 								StepStartTime: to.Ptr(time.Date(2019, time.December, 6, 11, 8, 46, 150000000, time.UTC)),
		// 								TimeElapsed: to.Ptr("14"),
		// 							},
		// 							{
		// 								Name: to.Ptr("New SQL Instance Startup"),
		// 								Order: to.Ptr[int32](3),
		// 								Status: to.Ptr(armsql.UpsertManagedServerOperationStepWithEstimatesAndDurationStatusInProgress),
		// 								StepEndTime: to.Ptr(time.Date(2019, time.December, 6, 11, 24, 50, 510000000, time.UTC)),
		// 								StepStartTime: to.Ptr(time.Date(2019, time.December, 6, 11, 22, 47, 420000000, time.UTC)),
		// 								TimeElapsed: to.Ptr("2"),
		// 							},
		// 						},
		// 						TotalSteps: to.Ptr("3"),
		// 					},
		...
		// 					OperationFriendlyName: to.Ptr("UPDATE MANAGED SERVER"),
		// 					PercentComplete: to.Ptr[int32](100),
		// 					StartTime: to.Ptr(time.Date(2019, time.December, 6, 14, 48, 34, 583000000, time.UTC)),
		...
		// 								Name: to.Ptr("Request validation"),
		// 								Order: to.Ptr[int32](1),
		// 								Status: to.Ptr(armsql.UpsertManagedServerOperationStepWithEstimatesAndDurationStatusFailed),
		// 								StepEndTime: to.Ptr(time.Date(2019, time.December, 4, 9, 1, 0, 570000000, time.UTC)),
		// 								StepStartTime: to.Ptr(time.Date(2019, time.December, 4, 9, 0, 30, 150000000, time.UTC)),
		// 								TimeElapsed: to.Ptr("0"),
		// 							},
		// 						},
		// 						TotalSteps: to.Ptr("1"),
		// 					},
		// 					PercentComplete: to.Ptr[int32](100),
		// 					StartTime: to.Ptr(time.Date(2019, time.December, 4, 9, 0, 8, 100000000, time.UTC)),
		// 					State: to.Ptr(armsql.ManagementOperationStateFailed),
		// 				},
		// 			},
		// 		},
