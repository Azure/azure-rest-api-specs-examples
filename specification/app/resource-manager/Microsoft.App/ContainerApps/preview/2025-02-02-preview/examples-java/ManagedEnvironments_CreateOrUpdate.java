...
public final class Main {
    ...
    public static void createEnvironments(com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        manager.managedEnvironments().define("testcontainerenv").withRegion("East US")
            ...
            .withZoneRedundant(true).withAvailabilityZones(Arrays.asList("1", "2", "3"))
            ...
            .withIngressConfiguration(new IngressConfiguration().withWorkloadProfileName("My-CO-01")
                ...
                .withTerminationGracePeriodSeconds(3600).withHeaderCountLimit(30).withRequestIdleTimeout(5))
