...
// Generated from example definition: 2024-10-01/Attestations_CreateResourceScope.json
func ExampleAttestationsClient_BeginCreateOrUpdateAtResource() {
	...
	// res = armpolicyinsights.AttestationsClientCreateOrUpdateAtResourceResponse{
