...
/**
 * This sample demonstrates how to Gets the metric definitions for the specified device.
 *
 * @summary Gets the metric definitions for the specified device.
 * x-ms-original-file: specification/storsimple8000series/resource-manager/Microsoft.StorSimple/stable/2017-06-01/examples/DevicesListMetricDefinition.json
 */
