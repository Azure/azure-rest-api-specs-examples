...
func ExampleEntityQueriesClient_NewListPager() {
	...
	pager := clientFactory.NewEntityQueriesClient().NewListPager("myRg", "myWorkspace", &armsecurityinsights.EntityQueriesClientListOptions{
		Kind: to.Ptr(armsecurityinsights.EntityQueryTemplateKindExpansion)})
	for pager.More() {
		...
		// page = armsecurityinsights.EntityQueriesClientListResponse{
		// 	EntityQueryList: armsecurityinsights.EntityQueryList{
