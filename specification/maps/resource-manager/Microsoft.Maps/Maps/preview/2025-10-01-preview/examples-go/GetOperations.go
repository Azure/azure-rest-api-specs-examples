...
func ExampleClient_NewListOperationsPager() {
	...
	clientFactory, err := armmaps.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armmaps.ClientListOperationsResponse{
		// 	OperationListResult: armmaps.OperationListResult{
		// 		Value: []*armmaps.Operation{
		// 			{
