...
// Generated from example definition: 2025-07-15/IpExtendedCommunities_ListByResourceGroup.json
func ExampleIPExtendedCommunitiesClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armmanagednetworkfabric.IPExtendedCommunitiesClientListByResourceGroupResponse{
		// 	IPExtendedCommunityListResult: armmanagednetworkfabric.IPExtendedCommunityListResult{
