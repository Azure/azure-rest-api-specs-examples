...
public final class Main {
    ...
    public static void akriConnectorTemplateCreateOrUpdateMaximumSet(
        ...
        manager.akriConnectorTemplates().define("resource-name123")
            ...
            .withProperties(new AkriConnectorTemplateProperties()
                    ...
                    .withManagedConfigurationSettings(new AkriConnectorTemplateRuntimeImageConfiguration()
                        .withImageConfigurationSettings(new AkriConnectorTemplateRuntimeImageConfigurationSettings()
                            ...
                            .withReadinessProbe(new AkriConnectorTemplateReadinessProbe()
                                ...
                                .withFailureThreshold(3).withInitialDelaySeconds(5).withPeriodSeconds(10)
                                .withSuccessThreshold(1).withTimeoutSeconds(2))
                ...
                .withDeviceInboundEndpointTypes(Arrays.asList(new AkriConnectorTemplateDeviceInboundEndpointType()
                    .withEndpointType("Microsoft.Rest").withVersion("0.0.1")))
                .withMqttConnectionConfiguration(new AkriConnectorsMqttConnectionConfiguration()
                    ...
                    .withHost("aio-broker:18883").withProtocol(AkriConnectorsMqttProtocolType.MQTT)
                    .withKeepAliveSeconds(10).withMaxInflightMessages(10).withSessionExpirySeconds(60)
