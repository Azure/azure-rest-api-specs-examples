...
public final class Main {
    /*
     * x-ms-original-file: 2025-07-01/ConfigurationPolicyGroupPut.json
     */
    /**
    ...
    public static void configurationPolicyGroupPut(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getConfigurationPolicyGroups().createOrUpdate("rg1", "vpnServerConfiguration1",
            "policyGroup1",
