...
public final class Main {
    ...
    public static void createOrUpdateSpecificFrontDoor(com.azure.resourcemanager.frontdoor.FrontDoorManager manager) {
        manager.frontDoors().define("frontDoor1").withRegion("westus").withExistingResourceGroup("rg1")
            ...
            .withRoutingRules(Arrays.asList(new RoutingRule().withName("routingRule1")
                ...
                .withAcceptedProtocols(Arrays.asList(FrontDoorProtocol.HTTP)).withPatternsToMatch(Arrays.asList("/*"))
            ...
            .withLoadBalancingSettings(Arrays.asList(new LoadBalancingSettingsModel().withName("loadBalancingSettings1")
                .withSampleSize(4).withSuccessfulSamplesRequired(2)))
            .withHealthProbeSettings(Arrays.asList(new HealthProbeSettingsModel().withName("healthProbeSettings1")
                .withPath("/").withProtocol(FrontDoorProtocol.HTTP).withIntervalInSeconds(120)
                .withHealthProbeMethod(FrontDoorHealthProbeMethod.HEAD).withEnabledState(HealthProbeEnabled.ENABLED)))
            .withBackendPools(Arrays.asList(new BackendPool().withName("backendPool1").withBackends(Arrays.asList(
                new Backend().withAddress("w3.contoso.com").withHttpPort(80).withHttpsPort(443).withPriority(2)
                    .withWeight(1),
                new Backend().withAddress("contoso.com.website-us-west-2.othercloud.net")
                    ...
                    .withHttpPort(80).withHttpsPort(443).withPriority(1).withWeight(2),
                new Backend().withAddress("10.0.1.5")
                    ...
                    .withHttpPort(80).withHttpsPort(443).withPriority(1).withWeight(1)))
            ...
            .withFrontendEndpoints(Arrays.asList(new FrontendEndpointInner().withName("frontendEndpoint1")
                .withHostname("www.contoso.com").withSessionAffinityEnabledState(SessionAffinityEnabledState.ENABLED)
                .withSessionAffinityTtlSeconds(60).withWebApplicationFirewallPolicyLink(
            ...
            .withEnabledState(FrontDoorEnabledState.ENABLED).create();
    }
