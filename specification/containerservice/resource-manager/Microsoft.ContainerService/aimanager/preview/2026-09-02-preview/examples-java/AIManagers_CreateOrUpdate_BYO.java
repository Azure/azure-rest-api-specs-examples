...
public final class Main {
    ...
    public static void createsOrUpdatesAnAIManagerResourceAttachedToAnExistingAKSClusterBringYourOwn(
        ...
        manager.aIManagers().define("aimanager1").withRegion("eastus").withExistingResourceGroup("rg1")
            .withTags(mapOf("key1", "fakeTokenPlaceholder"))
            .withProperties(new AIManagerProperties().withDeletePolicy(DeletePolicy.KEEP).withClusterResourceId(
