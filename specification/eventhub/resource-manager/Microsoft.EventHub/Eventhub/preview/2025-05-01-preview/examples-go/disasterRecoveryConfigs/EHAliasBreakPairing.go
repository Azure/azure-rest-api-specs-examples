...
func ExampleDisasterRecoveryConfigsClient_BreakPairing() {
	...
	res, err := clientFactory.NewDisasterRecoveryConfigsClient().BreakPairing(ctx, "exampleResourceGroup", "sdk-Namespace-8859", "sdk-DisasterRecovery-3814", nil)
	if err != nil {
	...
	// res = armeventhub.DisasterRecoveryConfigsClientBreakPairingResponse{
	// }
}
