...
public final class Main {
    /*
     * x-ms-original-file: 2025-07-01/ReachabilityAnalysisIntentPut.json
     */
    /**
    ...
    public static void reachabilityAnalysisIntentCreate(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getReachabilityAnalysisIntents().createWithResponse("rg1", "testNetworkManager",
            "testWorkspace", "testAnalysisIntentName",
