    ...
    public static void createOrUpdateKubernetesClusterWithALayer2LoadBalancer(
        ...
        manager.kubernetesClusters().define("kubernetesClusterName").withRegion("location")
            ...
            .withControlPlaneNodeConfiguration(new ControlPlaneNodeConfiguration()
                ...
                .withAvailabilityZones(Arrays.asList("1", "2", "3")).withCount(3L).withVmSkuName("NC_XXXX"))
            .withInitialAgentPoolConfigurations(Arrays.asList(new InitialAgentPoolConfiguration()
                ...
                .withUpgradeSettings(new AgentPoolUpgradeSettings().withMaxSurge("1")).withVmSkuName("NC_XXXX")))
