...
public final class Main {
    ...
    public static void getATemplate(com.azure.resourcemanager.securityinsights.SecurityInsightsManager manager)
        throws IOException {
        manager.contentTemplates().define("str.azure-sentinel-solution-str")
            .withExistingWorkspace("myRg", "myWorkspace").withContentId("8365ebfe-a381-45b7-ad08-7d818070e11f")
