...
# USAGE
    python tuning_configuration_start_session.py
...
def main():
    ...
    client.tuning_configuration.begin_start_session(
        resource_group_name="testrg",
        server_name="testserver",
        tuning_option="configuration",
        config_tuning_request={"allowServerRestarts": False, "targetImprovementMetric": "targetImprovementMetric"},
    ).result()
