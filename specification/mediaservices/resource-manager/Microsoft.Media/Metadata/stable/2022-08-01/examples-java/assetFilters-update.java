...
public final class Main {
    ...
    public static void updateAnAssetFilter(com.azure.resourcemanager.mediaservices.MediaServicesManager manager) {
        AssetFilter resource = manager.assetFilters().getWithResponse("contosorg", "contosomedia",
            "ClimbingMountRainer", "assetFilterWithTimeWindowAndTrack", com.azure.core.util.Context.NONE).getValue();
        resource.update()
            .withPresentationTimeRange(new PresentationTimeRange().withStartTimestamp(10L).withEndTimestamp(170000000L)
            ...
            .withFirstQuality(new FirstQuality().withBitrate(128000)).apply();
    }
}
