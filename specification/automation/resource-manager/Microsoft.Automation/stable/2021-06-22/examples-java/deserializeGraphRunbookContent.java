...
public final class Main {
    ...
    public static void
        ...
        manager.resourceProviders().convertGraphRunbookContentWithResponse("rg", "MyAutomationAccount",
            new GraphicalRunbookContentInner().withRawContent(new RawGraphicalRunbookContent().withSchemaVersion("1.10")
