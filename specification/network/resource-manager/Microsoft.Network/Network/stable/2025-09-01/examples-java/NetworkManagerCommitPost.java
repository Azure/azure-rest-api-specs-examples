...
public final class Main {
    /*
     * x-ms-original-file: 2025-09-01/NetworkManagerCommitPost.json
     */
    /**
     ...
     */
    public static void networkManageCommitPost(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getNetworkManagerCommits().post("resoureGroupSample", "testNetworkManager",
