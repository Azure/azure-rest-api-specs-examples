...
public final class Main {
    ...
    public static void patchContainerApp(com.azure.resourcemanager.appcontainers.ContainerAppsApiManager manager) {
        ...
        resource.update().withTags(mapOf("tag1", "value1", "tag2", "value2")).withConfiguration(new Configuration()
            ...
            .withDapr(new Dapr().withEnabled(true).withAppProtocol(AppProtocol.HTTP).withAppPort(3000)
                ...
                .withAppHealth(new DaprAppHealth().withEnabled(true).withPath("/health").withProbeIntervalSeconds(3)
                    .withProbeTimeoutMilliseconds(1000).withThreshold(3))
                .withMaxConcurrency(10))
            .withRuntime(new Runtime()
                .withJava(
                    new RuntimeJava().withEnableMetrics(true).withJavaAgent(
                        new RuntimeJavaAgent().withEnabled(true)
            ...
            .withMaxInactiveRevisions(
                10)
            .withRevisionTransitionThreshold(100).withService(new Service().withType("redis")))
            .withTemplate(new Template()
                ...
                .withContainers(Arrays.asList(
                    new Container()
                        .withImage("repo/testcontainerApp0:v1").withName(
                            "testcontainerApp0")
