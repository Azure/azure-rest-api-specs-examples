...
public final class Main {
    ...
    public static void hcpOpenShiftClustersCreateOrUpdate(
        ...
        manager.hcpOpenShiftClusters().define("hcpCluster-name").withRegion("ayecbdqonsqfowbq")
            .withExistingResourceGroup("rgopenapi").withTags(mapOf("key4181", "fakeTokenPlaceholder"))
            .withProperties(new HcpOpenShiftClusterProperties()
                ...
                .withNetwork(
                    new NetworkProfile().withNetworkType(NetworkType.OVNKUBERNETES).withPodCIDR("10.128.0.0/14")
                        .withServiceCIDR("172.30.0.0/16").withMachineCIDR("10.0.0.0/16").withHostPrefix(21))
                ...
                .withPlatform(new PlatformProfile().withManagedResourceGroup("nhyhywrxupo").withSubnetId(
                    ...
                    .withOperatorsAuthentication(new OperatorsAuthenticationProfile().withUserAssignedIdentities(
                        new UserAssignedIdentitiesProfile().withControlPlaneOperators(mapOf())
                            .withDataPlaneOperators(mapOf()).withServiceManagedIdentity(
                ...
                .withAutoscaling(new ClusterAutoscalingProfile().withMaxNodesTotal(0).withMaxPodGracePeriodSeconds(0)
                    .withMaxNodeProvisionTimeSeconds(0).withPodPriorityThreshold(1))
                .withEtcd(
                    new EtcdProfile()
