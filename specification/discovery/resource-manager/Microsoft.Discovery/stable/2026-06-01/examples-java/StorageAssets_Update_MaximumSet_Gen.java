...
public final class Main {
    ...
    public static void storageAssetsUpdateMaximumSet(com.azure.resourcemanager.discovery.DiscoveryManager manager) {
        StorageAsset resource = manager.storageAssets().getWithResponse("rgdiscovery", "0d1a35c1a97ad3a5d9",
            "06a17210ad733943d1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key6257", "fakeTokenPlaceholder"))
            .withProperties(new StorageAssetProperties().withDescription("hesvphxbjqrgbmdntuohbtmmllmqj")).apply();
    }
