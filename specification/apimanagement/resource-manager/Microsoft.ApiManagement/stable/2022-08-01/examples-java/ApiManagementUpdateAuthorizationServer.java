...
public final class Main {
    ...
    public static void
        ...
        AuthorizationServerContract resource = manager.authorizationServers()
            .getWithResponse("rg1", "apimService1", "newauthServer", com.azure.core.util.Context.NONE).getValue();
        resource.update().withUseInTestConsole(false).withUseInApiDocumentation(true).withClientId("update")
            .withClientSecret("updated").withIfMatch("*").apply();
    }
}
