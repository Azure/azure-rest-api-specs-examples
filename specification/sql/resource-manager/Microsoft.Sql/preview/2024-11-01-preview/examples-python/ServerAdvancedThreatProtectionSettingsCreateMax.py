...
# USAGE
    python server_advanced_threat_protection_settings_create_max.py
...
# x-ms-original-file: specification/sql/resource-manager/Microsoft.Sql/preview/2024-11-01-preview/examples/ServerAdvancedThreatProtectionSettingsCreateMax.json
