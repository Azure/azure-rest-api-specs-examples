...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateApiDiagnostic.json
func ExampleAPIDiagnosticClient_CreateOrUpdate() {
	...
	// res = armapimanagement.APIDiagnosticClientCreateOrUpdateResponse{
