...
// Generated from example definition: 2026-07-01/VnetConnections_CreateOrUpdate.json
func ExampleVnetConnectionsClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewVnetConnectionsClient().CreateOrUpdate(ctx, "myRg", "testgroup", "myVnetConnection", armappcontainers.VnetConnection{
	...
	// res = armappcontainers.VnetConnectionsClientCreateOrUpdateResponse{
