...
// get the collection of this BillingDepartmentResource
BillingDepartmentCollection collection = billingAccount.GetBillingDepartments();

// invoke the operation
string departmentName = "164821";
NullableResponse<BillingDepartmentResource> response = await collection.GetIfExistsAsync(departmentName);
BillingDepartmentResource result = response.HasValue ? response.Value : null;
