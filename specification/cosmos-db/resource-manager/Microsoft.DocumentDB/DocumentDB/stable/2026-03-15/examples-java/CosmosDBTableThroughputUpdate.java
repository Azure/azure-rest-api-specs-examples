...
public final class Main {
     ...
     */
    public static void cosmosDBTableThroughputUpdate(com.azure.resourcemanager.cosmos.CosmosManager manager) {
        manager.serviceClient().getTableResources().updateTableThroughput(
