...
public final class Main {
     ...
     */
    public static void updateSiteConfig(com.azure.resourcemanager.appservice.AppServiceManager manager) {
        manager.serviceClient().getWebApps().createOrUpdateConfiguration("testrg123", "sitef6141",
