...
func ExampleWhatIfResultsAtSubscriptionClient_BeginWhatIf() {
	...
	poller, err := clientFactory.NewWhatIfResultsAtSubscriptionClient().BeginWhatIf(ctx, "changedDeploymentStackWhatIfResult", nil)
	if err != nil {
	...
	// 					{
	// 						ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Authorization/policyAssignments/anotherPolicyAssignment"),
	...
	// 					},
	// 					{
	// 						ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Authorization/policyAssignments/updatedPolicyAssignment"),
	// 						ManagementStatusChange: &armdeploymentstacks.ChangeBaseDeploymentStacksManagementStatus{
	...
	// 								"id": "/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Authorization/policyAssignments/updatedPolicyAssignment",
	// 								"type": "Microsoft.Authorization/policyAssignments",
	// 								"name": "updatedPolicyAssignment",
	// 								"location": "westus2",
	// 								"properties": map[string]any{
	// 									"policyDefinitionId": "/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Authorization/policyDefinitions/updatedPolicyDefinition",
	// 									"scope": "/subscriptions/00000000-0000-0000-0000-000000000000",
	// 									"enforcementMode": "Default",
	// 								},
	// 							},
