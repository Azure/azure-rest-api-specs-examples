...
public final class Main {
    ...
    public static void
        ...
        manager.serviceClient().getImportPipelines().create("myResourceGroup", "myRegistry", "myImportPipeline",
            new ImportPipelineInner().withLocation("westus").withIdentity(new IdentityProperties()
                ...
                .withSource(
                    new ImportPipelineSourceProperties().withType(PipelineSourceType.AZURE_STORAGE_BLOB_CONTAINER)
                        ...
                        .withKeyVaultUri("fakeTokenPlaceholder").withStorageAccessMode(StorageAccessMode.SAS_TOKEN))
