...
func ExampleTopicEventSubscriptionsClient_NewListPager() {
	...
	pager := clientFactory.NewTopicEventSubscriptionsClient().NewListPager("examplerg", "exampleTopic1", nil)
	for pager.More() {
		...
		// page = armeventgrid.TopicEventSubscriptionsClientListResponse{
