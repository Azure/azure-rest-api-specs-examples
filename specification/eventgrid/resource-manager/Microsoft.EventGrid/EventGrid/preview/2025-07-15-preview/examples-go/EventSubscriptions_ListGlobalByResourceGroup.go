...
func ExampleEventSubscriptionsClient_NewListGlobalByResourceGroupPager() {
	...
	pager := clientFactory.NewEventSubscriptionsClient().NewListGlobalByResourceGroupPager("examplerg", nil)
	for pager.More() {
		...
		// page = armeventgrid.EventSubscriptionsClientListGlobalByResourceGroupResponse{
