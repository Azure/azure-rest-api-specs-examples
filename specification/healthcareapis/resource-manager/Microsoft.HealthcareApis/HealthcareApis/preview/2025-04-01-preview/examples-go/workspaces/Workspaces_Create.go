...
// Generated from example definition: 2025-04-01-preview/workspaces/Workspaces_Create.json
func ExampleWorkspacesClient_BeginCreateOrUpdate() {
	...
	// res = armhealthcareapis.WorkspacesClientCreateOrUpdateResponse{
	// 	Workspace: armhealthcareapis.Workspace{
