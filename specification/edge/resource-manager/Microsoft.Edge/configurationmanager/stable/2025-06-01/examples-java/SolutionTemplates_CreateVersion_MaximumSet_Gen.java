...
public final class Main {
    ...
    public static void solutionTemplatesCreateVersionMaximumSet(
        ...
        manager.solutionTemplates().createVersion("rgconfigurationmanager", "testname",
            new SolutionTemplateVersionWithUpdateTypeInner().withUpdateType(UpdateType.MAJOR).withVersion("1.0.0")
                .withSolutionTemplateVersion(new SolutionTemplateVersionInner().withProperties(
                    new SolutionTemplateVersionProperties().withConfigurations("ofqcsavwmeuwmvtjnqpoybtjvkmrlh")
                        .withSpecification(mapOf()).withOrchestratorType(OrchestratorType.TO))),
