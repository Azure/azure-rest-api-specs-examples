...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/CreateOrUpdateAzureDevOpsProjects_example.json
func ExampleAzureDevOpsProjectsClient_BeginCreateOrUpdate() {
	...
	// res = armsecurity.AzureDevOpsProjectsClientCreateOrUpdateResponse{
	// 	AzureDevOpsProject: armsecurity.AzureDevOpsProject{
