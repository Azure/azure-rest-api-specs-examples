...
public final class Main {
    ...
    public static void patchAnIntegrationServiceEnvironment(com.azure.resourcemanager.logic.LogicManager manager) {
        IntegrationServiceEnvironment resource
            = manager.integrationServiceEnvironments().getByResourceGroupWithResponse("testResourceGroup",
                "testIntegrationServiceEnvironment", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("tag1", "value1")).withSku(new IntegrationServiceEnvironmentSku()
            .withName(IntegrationServiceEnvironmentSkuName.DEVELOPER).withCapacity(0)).apply();
    }
