...
public final class Main {
    ...
    public static void
        ...
        manager.schedulers().definePrivateEndpointConnection("spzckqrbhfnabu")
            ...
            .withProperties(
                new PrivateEndpointConnectionProperties().withPrivateEndpoint(new PrivateEndpoint())
                    .withPrivateLinkServiceConnectionState(new PrivateLinkServiceConnectionState()
                        ...
                        .withDescription("ujdcsoyxljivwsgfkexhotaxcmzq").withActionsRequired("mxymqfbbmpwjxsroldlsd")))
            .create();
    }
}
