...
public final class Main {
    ...
    public static void organizationsCreateOrUpdate(com.azure.resourcemanager.neonpostgres.NeonPostgresManager manager) {
        manager.organizations().define("XB-.:").withRegion("upxxgikyqrbnv").withExistingResourceGroup("rgneon")
                ...
                new OrganizationProperties()
                    .withMarketplaceDetails(new MarketplaceDetails().withSubscriptionId("yxmkfivp")
                        ...
                        .withOfferDetails(new OfferDetails().withPublisherId("hporaxnopmolttlnkbarw")
                            ...
                            .withPlanName("ljbmgpkfqklaufacbpml").withTermUnit("qbcq")
                            .withTermId("aedlchikwqckuploswthvshe")))
                    .withUserDetails(new UserDetails()
                        .withFirstName("buwwe").withLastName("escynjpynkoox").withEmailAddress("3i_%@w8-y.H-p.tvj.dG")
                        .withUpn("fwedjamgwwrotcjaucuzdwycfjdqn").withPhoneNumber("dlrqoowumy"))
                    .withCompanyDetails(new CompanyDetails()
                        .withCompanyName("uxn").withCountry("lpajqzptqchuko")
                    ...
                    .withPartnerOrganizationProperties(
                        new PartnerOrganizationProperties().withOrganizationId("nrhvoqzulowcunhmvwfgjcaibvwcl")
                            .withOrganizationName("2__.-").withSingleSignOnProperties(
                                new SingleSignOnProperties().withSingleSignOnState(SingleSignOnStates.INITIAL)
                                    .withEnterpriseAppId("fpibacregjfncfdsojs").withSingleSignOnUrl("tmojh")
