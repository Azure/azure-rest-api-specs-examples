...
public final class Main {
    /*
     * x-ms-original-file:
     * 2026-03-01/virtualMachineScaleSetExamples/VirtualMachineScaleSet_Create_WithAutomaticZoneRebalancingPolicy.json
     */
    /**
     ...
     */
    public static void
        createAScaleSetWithAutomaticZoneRebalancingEnabled(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getVirtualMachineScaleSets().createOrUpdate("myResourceGroup", "{vmss-name}",
            new VirtualMachineScaleSetInner().withLocation("westus")
                ...
                .withOverprovision(false).withResiliencyPolicy(
                    new ResiliencyPolicy().withAutomaticZoneRebalancingPolicy(new AutomaticZoneRebalancingPolicy()
                        .withEnabled(true).withRebalanceStrategy(RebalanceStrategy.RECREATE)
