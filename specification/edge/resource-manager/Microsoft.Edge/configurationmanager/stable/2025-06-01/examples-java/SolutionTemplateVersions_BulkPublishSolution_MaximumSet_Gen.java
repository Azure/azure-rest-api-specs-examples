...
public final class Main {
    ...
    public static void solutionTemplateVersionsBulkPublishSolutionMaximumSet(
        ...
        manager.solutionTemplateVersions().bulkPublishSolution("rgconfigurationmanager", "testname", "1.0.0",
            new BulkPublishSolutionParameter().withTargets(Arrays.asList(new BulkPublishTargetDetails().withTargetId(
                "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Edge/Targets/target")
                .withSolutionInstanceName("test-instance"))).withSolutionInstanceName("test-instance")
                .withSolutionDependencies(Arrays.asList(new SolutionDependencyParameter().withSolutionVersionId(
                    ...
                    .withSolutionTemplateVersion("1.0.0").withSolutionInstanceName("test-instance")
                    .withTargetId(
                        "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Edge/Targets/target")
