...
// Generated from example definition: 2026-08-01-preview/DatabaseEncryptionProtectorRevalidate.json
func ExampleDatabaseEncryptionProtectorsClient_BeginRevalidate() {
	...
	// res = armsql.DatabaseEncryptionProtectorsClientRevalidateResponse{
	// }
}
