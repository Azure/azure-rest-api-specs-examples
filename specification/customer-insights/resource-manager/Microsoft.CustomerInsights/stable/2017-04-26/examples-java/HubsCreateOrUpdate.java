...
public final class Main {
    ...
    public static void hubsCreateOrUpdate(com.azure.resourcemanager.customerinsights.CustomerInsightsManager manager) {
        manager.hubs().define("sdkTestHub").withRegion("West US").withExistingResourceGroup("TestHubRG")
            .withHubBillingInfo(new HubBillingInfoFormat().withSkuName("B0").withMinUnits(1).withMaxUnits(5)).create();
    }
}
