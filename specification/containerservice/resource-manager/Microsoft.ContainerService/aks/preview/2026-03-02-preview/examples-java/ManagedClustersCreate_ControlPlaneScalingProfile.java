...
public final class Main {
    ...
    public static void createManagedClusterWithControlPlaneScalingProfile(
        ...
        manager.serviceClient().getManagedClusters().createOrUpdate("rg1", "clustername1", new ManagedClusterInner()
            ...
            .withSku(
                new ManagedClusterSku().withName(ManagedClusterSkuName.BASE).withTier(ManagedClusterSkuTier.STANDARD))
            .withKubernetesVersion("1.33.0").withDnsPrefix("dnsprefix1")
            ...
            .withNetworkProfile(new ContainerServiceNetworkProfile().withNetworkPlugin(NetworkPlugin.AZURE)
                .withNetworkPluginMode(NetworkPluginMode.OVERLAY).withOutboundType(OutboundType.LOAD_BALANCER)
