...
public final class Main {
    ...
    public static void organizationsCreateOrUpdate(
        ...
        manager.organizations().define("C").withRegion("pamjoudtssthlbhrnfjidr").withExistingResourceGroup("rgopenapi")
            .withTags(mapOf("key8430", "fakeTokenPlaceholder"))
            .withProperties(new OrganizationProperties()
                .withInformaticaProperties(new InformaticaProperties()
                    .withOrganizationId("wtdmhlwhkvgqdumaehgfgiqcxgnqpx").withOrganizationName("nomzbvwe")
                    .withInformaticaRegion("zfqodqpbeflhedypiijdkc").withSingleSignOnUrl("espcbzjhtmgwfdkckhqk"))
                .withMarketplaceDetails(new MarketplaceDetails().withMarketplaceSubscriptionId("ovenlecocg")
                    .withOfferDetails(new OfferDetails()
                        ...
                        .withTermUnit("gjwmgevrblbosuogsvfspsgspetbnxaygkbelvadpgwiywl").withTermId(
                ...
                .withUserDetails(new UserDetails().withFirstName("appvdclawzfjntdfdftjevlhvzropnxqtnypid")
                    ...
                    .withEmailAddress("7_-46@13D--3.m-4x-.11.c-9-.DHLYFc").withUpn("undljch")
                    .withPhoneNumber("fvcjylxlmhdnshsgywnzlyvshu"))
                .withCompanyDetails(new CompanyDetails().withCompanyName("xszcggknokhw")
                    .withOfficeAddress("sbttzwyajgdbsvipuiclbzvkcvwyil").withCountry("gwkcpnwyaqc")
                    .withDomain("utcxetzzpmbvwmjrvphqngvp").withBusiness("pucosrtjv").withNumberOfEmployees(25))
