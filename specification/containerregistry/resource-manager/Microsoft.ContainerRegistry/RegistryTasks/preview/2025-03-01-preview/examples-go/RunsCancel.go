...
func ExampleRunsClient_Cancel() {
	...
	res, err := clientFactory.NewRunsClient().Cancel(ctx, "myResourceGroup", "myRegistry", "0accec26-d6de-4757-8e74-d080f38eaaab", nil)
	if err != nil {
	...
	// res = armcontainerregistrytasks.RunsClientCancelResponse{
	// }
}
