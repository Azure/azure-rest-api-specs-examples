...
public final class Main {
    ...
    public static void createOrUpdateATenantActivityLogAlertRuleForTenantLevelEvents(
        ...
        manager.tenantActivityLogAlerts().createOrUpdateWithResponse("72f988bf-86f1-41af-91ab-2d7cd011db47",
            "SampleActivityLogAlertSHRuleOnTenantLevel",
            new TenantActivityLogAlertResourceInner().withLocation("Global").withTags(mapOf())
