...
public final class Main {
    ...
    public static void
        ...
        manager.credentials().createOrUpdate(
            "rgdeviceregistry", "mynamespace", new CredentialInner().withLocation("East US 2")
                .withTags(mapOf("key7121", "fakeTokenPlaceholder")).withProperties(new CredentialProperties()),
