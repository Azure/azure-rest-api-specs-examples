...
public final class Main {
    ...
    public static void
        ...
        VirtualNetworkRule resource = manager.virtualNetworkRules().getWithResponse("contosorg", "contosoadla",
            "test_virtual_network_rules_name", com.azure.core.util.Context.NONE).getValue();
