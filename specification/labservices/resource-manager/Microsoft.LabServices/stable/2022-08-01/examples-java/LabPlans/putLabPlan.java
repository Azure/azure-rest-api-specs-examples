...
public final class Main {
    ...
    public static void putLabPlan(com.azure.resourcemanager.labservices.LabServicesManager manager) {
        manager.labPlans().define("testlabplan").withRegion("westus").withExistingResourceGroup("testrg123")
            ...
            .withSupportInfo(new SupportInfo().withUrl("help.contoso.com").withEmail("help@contoso.com")
                .withPhone("+1-202-555-0123").withInstructions("Contact support for help."))
            .create();
    }
}
