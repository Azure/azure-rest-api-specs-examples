...
public final class Main {
    ...
    public static void patchExadataInfrastructureGeneratedByMaximumSetRule(
        ...
        CloudExadataInfrastructure resource = manager.cloudExadataInfrastructures()
            .getByResourceGroupWithResponse("rgopenapi", "cloudexaInfra1", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("key831", "fakeTokenPlaceholder")).withZones(Arrays.asList("wl"))
            .withProperties(new CloudExadataInfrastructureUpdateProperties().withComputeCount(9).withStorageCount(4)
                .withMaintenanceWindow(new MaintenanceWindow().withPreference(Preference.NO_PREFERENCE)
                    ...
                    .withHoursOfDay(Arrays.asList(0)).withLeadTimeInWeeks(10).withPatchingMode(PatchingMode.ROLLING)
                    .withCustomActionTimeoutInMins(120).withIsCustomActionTimeoutEnabled(true)
