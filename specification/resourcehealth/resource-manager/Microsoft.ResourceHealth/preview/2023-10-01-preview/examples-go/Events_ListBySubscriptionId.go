...
func ExampleEventsClient_NewListBySubscriptionIDPager() {
	...
	for pager.More() {
		...
		// 										ImpactedTenants: []*string{
		// 										},
		// 										LastUpdateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-14T20:10:00Z"); return t}()),
		// 										Status: to.Ptr(armresourcehealth.EventStatusValuesActive),
		// 								}},
		// 								ImpactedService: to.Ptr("Virtual Machines"),
		// 						}},
		// 						ImpactMitigationTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-14T20:10:00Z"); return t}()),
		// 						ImpactStartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-14T19:10:00Z"); return t}()),
		// 						IsHIR: to.Ptr(false),
		// 						LastUpdateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-14T20:10:00Z"); return t}()),
		// 						Level: to.Ptr(armresourcehealth.LevelValuesWarning),
