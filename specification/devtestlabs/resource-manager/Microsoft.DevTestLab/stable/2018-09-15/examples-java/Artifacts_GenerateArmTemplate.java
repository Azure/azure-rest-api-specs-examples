...
public final class Main {
    ...
    public static void artifactsGenerateArmTemplate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        manager.artifacts().generateArmTemplateWithResponse("resourceGroupName", "{labName}", "{artifactSourceName}",
            "{artifactName}", new GenerateArmTemplateRequest().withVirtualMachineName("{vmName}")
                .withLocation("{location}").withFileUploadOptions(FileUploadOptions.NONE),
