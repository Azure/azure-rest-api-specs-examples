...
public final class Main {
    ...
    public static void
        ...
        manager.prefixes().define("peeringServicePrefixName").withExistingPeeringService("rgName", "peeringServiceName")
            .withPrefix("192.168.1.0/24").withPeeringServicePrefixKey("00000000-0000-0000-0000-000000000000").create();
    }
}
