...
// Generated from example definition: 2024-04-05/getVMSSGuestConfigurationAssignmentReportById.json
func ExampleAssignmentReportsVMSSClient_Get() {
	...
	// res = armguestconfiguration.AssignmentReportsVMSSClientGetResponse{
