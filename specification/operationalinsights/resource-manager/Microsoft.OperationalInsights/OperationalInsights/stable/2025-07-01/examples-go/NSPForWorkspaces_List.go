...
func ExampleWorkspacesClient_NewListNSPPager() {
	...
	for pager.More() {
		...
		// page = armoperationalinsights.WorkspacesClientListNSPResponse{
		// 	NetworkSecurityPerimeterConfigurationListResult: armoperationalinsights.NetworkSecurityPerimeterConfigurationListResult{
