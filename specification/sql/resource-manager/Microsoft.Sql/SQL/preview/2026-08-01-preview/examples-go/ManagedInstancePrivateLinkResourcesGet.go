...
// Generated from example definition: 2026-08-01-preview/ManagedInstancePrivateLinkResourcesGet.json
func ExampleManagedInstancePrivateLinkResourcesClient_Get() {
	...
	// res = armsql.ManagedInstancePrivateLinkResourcesClientGetResponse{
	// 	ManagedInstancePrivateLink: armsql.ManagedInstancePrivateLink{
	// 		Name: to.Ptr("plr"),
