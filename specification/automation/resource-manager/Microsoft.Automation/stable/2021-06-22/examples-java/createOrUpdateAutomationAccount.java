...
public final class Main {
    ...
    public static void createOrUpdateAutomationAccount(com.azure.resourcemanager.automation.AutomationManager manager) {
        manager.automationAccounts().define("myAutomationAccount9").withExistingResourceGroup("rg")
            .withRegion("East US 2").withName("myAutomationAccount9").withSku(new Sku().withName(SkuNameEnum.FREE))
            .create();
    }
}
