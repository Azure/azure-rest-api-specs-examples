...
// Generated from example definition: 2026-06-01/listBuiltInPolicySetDefinitions.json
func ExampleSetDefinitionsClient_NewListBuiltInPager() {
	...
	pager := clientFactory.NewSetDefinitionsClient().NewListBuiltInPager(nil)
	for pager.More() {
		...
		// page = armpolicy.SetDefinitionsClientListBuiltInResponse{
