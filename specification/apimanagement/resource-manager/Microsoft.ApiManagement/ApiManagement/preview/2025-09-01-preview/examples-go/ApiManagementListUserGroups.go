...
// Generated from example definition: 2025-09-01-preview/ApiManagementListUserGroups.json
func ExampleUserGroupClient_NewListPager() {
	...
	pager := clientFactory.NewUserGroupClient().NewListPager("rg1", "apimService1", "57681833a40f7eb6c49f6acf", nil)
	for pager.More() {
		...
		// page = armapimanagement.UserGroupClientListResponse{
