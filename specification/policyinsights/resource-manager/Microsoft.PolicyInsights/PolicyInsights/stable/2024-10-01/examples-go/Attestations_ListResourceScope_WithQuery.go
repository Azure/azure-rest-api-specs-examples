...
// Generated from example definition: 2024-10-01/Attestations_ListResourceScope_WithQuery.json
func ExampleAttestationsClient_NewListForResourcePager_listAttestationsAtIndividualResourceScopeWithQueryParameters() {
	...
	pager := clientFactory.NewAttestationsClient().NewListForResourcePager("subscriptions/35ee058e-5fa0-414c-8145-3ebb8d09b6e2/resourcegroups/myrg/providers/microsoft.compute/virtualMachines/devVM", &armpolicyinsights.AttestationsClientListForResourceOptions{
	...
	for pager.More() {
		...
		// page = armpolicyinsights.AttestationsClientListForResourceResponse{
		// 	AttestationListResult: armpolicyinsights.AttestationListResult{
