...
public final class Main {
    ...
    public static void updateAHorizonDBParameterGroup(com.azure.resourcemanager.horizondb.HorizonDbManager manager) {
        HorizonDbParameterGroup resource
            = manager.horizonDbParameterGroups().getByResourceGroupWithResponse("exampleresourcegroup",
                "exampleparametergroup", com.azure.core.util.Context.NONE).getValue();
        resource.update().withTags(mapOf("team", "updated-data-platform"))
            .withProperties(new HorizonDbParameterGroupPropertiesForPatchUpdate()
                ...
                .withDescription("Updated parameter group for high-throughput workloads").withApplyImmediately(true))
            .apply();
    }
