...
public final class Main {
    ...
    public static void serviceFabricsUpdate(com.azure.resourcemanager.devtestlabs.DevTestLabsManager manager) {
        ServiceFabric resource = manager.serviceFabrics().getWithResponse("resourceGroupName", "{labName}",
            "{userName}", "{serviceFabricName}", null, com.azure.core.util.Context.NONE).getValue();
