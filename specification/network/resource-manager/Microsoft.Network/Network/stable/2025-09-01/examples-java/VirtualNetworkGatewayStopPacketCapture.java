...
public final class Main {
    /*
     * x-ms-original-file: 2025-09-01/VirtualNetworkGatewayStopPacketCapture.json
     */
    /**
     ...
     */
    public static void
        stopPacketCaptureOnVirtualNetworkGateway(com.azure.resourcemanager.network.NetworkManager manager) {
        manager.serviceClient().getVirtualNetworkGateways().stopPacketCapture("rg1", "vpngw",
