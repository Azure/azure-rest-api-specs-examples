...
public final class Main {
    ...
    public static void
        ...
        Target resource = manager.targets()
            ...
            .getValue();
        resource.update().withTags(mapOf("key8026", "fakeTokenPlaceholder")).withProperties(new TargetProperties()
            .withDescription("yhnhdpznncdvncmnvoeohqjx").withDisplayName("pguujtzjjvixgjitugybrefp")
            .withContextId(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}")
            .withTargetSpecification(mapOf()).withCapabilities(Arrays.asList("dasqhyxfakivfzqb"))
            .withHierarchyLevel("hfyntwxetgsmnucbjvvphtyxu").withSolutionScope("testname")
            .withState(ResourceState.ACTIVE)).apply();
    }
