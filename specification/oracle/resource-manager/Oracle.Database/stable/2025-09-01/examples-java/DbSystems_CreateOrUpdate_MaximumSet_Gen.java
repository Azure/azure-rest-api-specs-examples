...
public final class Main {
    ...
    public static void
        ...
        manager.dbSystems().define("dbsystem1").withRegion("uuh").withExistingResourceGroup("rgopenapi")
            ...
            .withProperties(new DbSystemProperties().withResourceAnchorId(
                ...
                .withDiskRedundancy(DiskRedundancyType.HIGH).withHostname("krixp").withNodeCount(24)
                .withShape(
                ...
                .withComputeModel(ComputeModel.ECPU).withComputeCount(28)
                .withDatabaseEdition(DbSystemDatabaseEditionType.STANDARD_EDITION)
                .withAdminPassword("fakeTokenPlaceholder").withDbVersion("nuzcyzulicdscaxxleansibdtqxhf"))
            .withZones(Arrays.asList("pstozrrpkhlaffxt")).create();
    }
