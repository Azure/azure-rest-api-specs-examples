...
# USAGE
    python storage_assets_delete_maximum_set_gen.py
...
def main():
    ...
    client.storage_assets.begin_delete(
        resource_group_name="rgdiscovery",
        storage_container_name="f7e7a03c675ccffe1a",
        storage_asset_name="8f741ee4588dc823fc",
    ).result()
