    ...
    public static void putAClusterWithMaximumParameters(
        ...
        manager.managedClusters().define("mycluster").withRegion("eastus").withExistingResourceGroup("resRg")
            ...
            .withServiceEndpoints(Arrays.asList(new ServiceEndpoint().withService("Microsoft.Storage")
                .withLocations(Arrays.asList("eastus2", "usnorth")).withNetworkIdentifier(
            ...
            .withHttpGatewayTokenAuthConnectionPort(19081).withEnableHttpGatewayExclusiveAuthMode(true)
            .withAutoGeneratedDomainNameLabelScope(AutoGeneratedDomainNameLabelScope.SUBSCRIPTION_REUSE)
            .withAllocatedOutboundPorts(0).withEnableOutboundOnlyNodeTypes(true).withSkipManagedNsgAssignment(true)
            .create();
    }
