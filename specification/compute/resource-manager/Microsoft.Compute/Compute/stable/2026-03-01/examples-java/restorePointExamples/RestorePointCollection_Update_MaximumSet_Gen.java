...
public final class Main {
     ...
     */
    public static void
        restorePointCollectionUpdateMaximumSetGen(com.azure.resourcemanager.compute.ComputeManager manager) {
        manager.serviceClient().getRestorePointCollections().updateWithResponse("rgcompute", "aaaaaaaaaaaaaaaaaaaa",
