...
// Generated from example definition: 2023-02-15-preview/SensitivitySettings/PutSensitivitySettings_example.json
func ExampleSensitivitySettingsClient_CreateOrUpdate() {
	...
	// res = armsecurity.SensitivitySettingsClientCreateOrUpdateResponse{
	// 	GetSensitivitySettingsResponse: armsecurity.GetSensitivitySettingsResponse{
	// 		Name: to.Ptr("current"),
