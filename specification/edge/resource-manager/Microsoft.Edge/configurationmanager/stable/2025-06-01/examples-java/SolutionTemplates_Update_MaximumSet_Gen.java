...
public final class Main {
    ...
    public static void solutionTemplatesUpdateMaximumSet(
        ...
        SolutionTemplate resource = manager.solutionTemplates()
            ...
            .getValue();
        resource.update().withTags(mapOf("key8772", "fakeTokenPlaceholder"))
            .withProperties(
                new SolutionTemplateProperties().withDescription("onqlteg").withCapabilities(Arrays.asList("relsv"))
                    .withState(ResourceState.ACTIVE).withEnableExternalValidation(true))
            .apply();
    }
