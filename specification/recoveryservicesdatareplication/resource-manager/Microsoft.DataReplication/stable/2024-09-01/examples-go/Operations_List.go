...
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armrecoveryservicesdatareplication.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armrecoveryservicesdatareplication.OperationsClientListResponse{
		// 	OperationListResult: armrecoveryservicesdatareplication.OperationListResult{
