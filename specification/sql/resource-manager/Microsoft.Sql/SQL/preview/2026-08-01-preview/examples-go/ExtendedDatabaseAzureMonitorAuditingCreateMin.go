...
// Generated from example definition: 2026-08-01-preview/ExtendedDatabaseAzureMonitorAuditingCreateMin.json
func ExampleExtendedDatabaseBlobAuditingPoliciesClient_CreateOrUpdate_createOrUpdateAnExtendedDatabaseSAzureMonitorAuditingPolicyWithMinimalParameters() {
	...
	// res = armsql.ExtendedDatabaseBlobAuditingPoliciesClientCreateOrUpdateResponse{
	// 	ExtendedDatabaseBlobAuditingPolicy: armsql.ExtendedDatabaseBlobAuditingPolicy{
	// 		Name: to.Ptr("default"),
