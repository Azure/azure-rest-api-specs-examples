...
public final class Main {
    ...
    public static void enterpriseCustomerOperationsCreateOrUpdate(
        ...
        manager.enterpriseCustomerOperations().define("l").withRegion("zdzhhkjyogrqxwihkifnmeyhwpujbr")
            .withExistingResourceGroup("rgConnectedCache").withTags(mapOf("key4215", "fakeTokenPlaceholder"))
            .withProperties(new CacheNodeOldResponse().withStatusCode("fakeTokenPlaceholder").withStatusText("bs")
                .withStatusDetails("lhwvcz").withError(new ManagementError()))
            .create();
    }
