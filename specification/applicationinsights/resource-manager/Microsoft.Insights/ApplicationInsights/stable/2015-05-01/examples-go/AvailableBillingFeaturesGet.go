...
// Generated from example definition: 2015-05-01/AvailableBillingFeaturesGet.json
func ExampleComponentAvailableFeaturesClient_Get() {
	...
	// res = armapplicationinsights.ComponentAvailableFeaturesClientGetResponse{
	// 	ComponentAvailableFeatures: armapplicationinsights.ComponentAvailableFeatures{
