...
func ExampleApplicationGatewaysClient_GetSSLPredefinedPolicy() {
	...
	// res = armnetwork.ApplicationGatewaysClientGetSSLPredefinedPolicyResponse{
	// 	ApplicationGatewaySSLPredefinedPolicy: armnetwork.ApplicationGatewaySSLPredefinedPolicy{
